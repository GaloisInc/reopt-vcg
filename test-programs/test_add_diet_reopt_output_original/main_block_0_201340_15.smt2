; main.block_0_201340.1 (0x201354). jump precondition: (= r15 (fnstart r15))
...
(define-fun a201359_rbx () (_ BitVec 64) a201340_rbx)
(define-fun a201359_rsp () (_ BitVec 64) (bvadd x86local_9 (_ bv8 64)))
(define-fun a201359_rbp () (_ BitVec 64) x86local_0)
...
(define-fun a201359_r12 () (_ BitVec 64) a201340_r12)
(define-fun a201359_r13 () (_ BitVec 64) a201340_r13)
(define-fun a201359_r14 () (_ BitVec 64) a201340_r14)
(define-fun a201359_r15 () (_ BitVec 64) a201340_r15)
...
(define-fun llvm_t0 () (_ BitVec 64) a201359_rax)
; LLVM: br label %block_0_201359
(assert (= #x0000000000201359 a201359_rip))
(assert (= (_ bv7 3) a201359_x87top))
(assert (= false a201359_df))
...
(check-sat-assuming ((not (= a201359_r15 fnstart_r15))))
(exit)
