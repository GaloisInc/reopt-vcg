; main.block_0_201340.0 (0x201354). Machine code write at 0x201354 is in unreserved stack space.
...
(check-sat-assuming ((not (mc_only_stack_range x86local_9 (_ bv8 64)))))
(exit)
