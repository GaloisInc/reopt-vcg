; main.block_0_201070.0 (0x201084). Check return address matches next instruction.
...
(check-sat-assuming ((distinct (mem_readbv64 x86mem_3 x86local_9) #x0000000000201089)))
(exit)
