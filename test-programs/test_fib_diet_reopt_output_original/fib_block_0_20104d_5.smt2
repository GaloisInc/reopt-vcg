; fib.block_0_20104d.1 (0x201054). jump precondition: (= (llvm t15) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 64)))
...
(assert (= false false))
(check-sat-assuming ((not (= llvm_t14 (mem_readbv64 x86mem_1 (bvsub fnstart_rsp (_ bv16 64)))))))
(exit)
