; main.block_0_201089.1 (0x201098). jump precondition: (= r15 (fnstart r15))
...
(assert (= #x000000000020109d a20109d_rip))
(assert (= (_ bv7 3) a20109d_x87top))
(assert (= false a20109d_df))
...
(check-sat-assuming ((not (= a20109d_r15 fnstart_r15))))
(exit)
