  ...
  definst "rcll" $ do
    instr_pat $ fun (_ : clReg) (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_7 <- eval (concat (expression.bv_nat 25 0) (bv_and v_6 (expression.bv_nat 8 31)));
      let v_8 <- eval (urem v_7 (expression.bv_nat 33 33));
    ...
    instr_pat $ fun (_ : clReg) (r32_0 : reg (bv 32)) =>
     let action : semantics Unit := do
      ...
      let v_3 <- eval (concat (expression.bv_nat 25 0) (bv_and v_2 (expression.bv_nat 8 31)));
      let v_4 <- eval (urem v_3 (expression.bv_nat 33 33));
      let (v_5 : expression (bv 8)) <- eval (extract v_4 25 33);
      let v_6 <- getRegister cf;
      let v_7 <- getRegister (lhs.of_reg r32_0);
      ...
      let (v_12 : expression (bv 32)) <- eval (extract v_9 1 33);
      setRegister (lhs.of_reg r32_0) v_12;
      setRegister cf v_10;
    ...
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_6 <- eval (concat (expression.bv_nat 25 0) (bv_and (handleImmediateWithSignExtend imm_0 8 8) (expression.bv_nat 8 31)));
      let v_7 <- eval (urem v_6 (expression.bv_nat 33 33));
      let v_8 <- eval (rol v_5 v_7);
      let (v_9 : expression (bv 32)) <- eval (extract v_8 1 33);
      store v_2 v_9 4;
      let (v_11 : expression (bv 8)) <- eval (extract v_7 25 33);
    ...
    instr_pat $ fun (imm_0 : imm int) (r32_1 : reg (bv 32)) =>
     let action : semantics Unit := do
      let v_2 <- eval (concat (expression.bv_nat 25 0) (bv_and (handleImmediateWithSignExtend imm_0 8 8) (expression.bv_nat 8 31)));
      let v_3 <- eval (urem v_2 (expression.bv_nat 33 33));
      let (v_4 : expression (bv 8)) <- eval (extract v_3 25 33);
      ...
      let (v_11 : expression (bv 32)) <- eval (extract v_8 1 33);
      setRegister (lhs.of_reg r32_1) v_11;
      setRegister cf v_9;
