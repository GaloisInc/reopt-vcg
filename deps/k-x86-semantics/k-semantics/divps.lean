  ...
  definst "divps" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_23 <- eval (concat (fp_bitcast_to_bv (fp_div v_4 v_8) 32) v_22);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let (v_12 : expression (bv 32)) <- eval (extract v_2 64 96);
      ...
      let (v_16 : expression (bv 32)) <- eval (extract v_2 96 128);
      let v_17 <- eval (bv_bitcast_to_fp float_class.fp32 v_16);
      let (v_18 : expression (bv 32)) <- eval (extract v_5 96 128);
      let v_19 <- eval (bv_bitcast_to_fp float_class.fp32 v_18);
      let v_20 <- eval (concat (fp_bitcast_to_bv (fp_div v_13 v_15) 32) (fp_bitcast_to_bv (fp_div v_17 v_19) 32));
      let v_21 <- eval (concat (fp_bitcast_to_bv (fp_div v_9 v_11) 32) v_20);
      let v_22 <- eval (concat (fp_bitcast_to_bv (fp_div v_4 v_7) 32) v_21);
