def pcmpeqb : instruction :=
  definst "pcmpeqb" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (eq v_3 v_6) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_7 v_8) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_9 v_10) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_11 v_12) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_13 v_14) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_15 v_16) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_17 v_18) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_19 v_20) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_21 v_22) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_23 v_24) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_25 v_26) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_27 v_28) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_29 v_30) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_31 v_32) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_33 v_34) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (mux (eq v_35 v_36) (expression.bv_nat 8 255) (expression.bv_nat 8 0)))))))))))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (eq v_3 v_5) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_6 v_7) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_8 v_9) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_10 v_11) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_12 v_13) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_14 v_15) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_16 v_17) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_18 v_19) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_20 v_21) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_22 v_23) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_24 v_25) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_26 v_27) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_28 v_29) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_30 v_31) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (concat (mux (eq v_32 v_33) (expression.bv_nat 8 255) (expression.bv_nat 8 0)) (mux (eq v_34 v_35) (expression.bv_nat 8 255) (expression.bv_nat 8 0)))))))))))))))));
      pure ()
    pat_end
