  ...
  definst "vfnmadd132ps" $ do
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_17 : expression (bv 32)) <- eval (extract v_5 96 128);
      let (v_18 : expression (bv 32)) <- eval (extract v_8 96 128);
      let (v_19 : expression (bv 32)) <- eval (extract v_3 128 160);
      let (v_20 : expression (bv 32)) <- eval (extract v_5 128 160);
      let (v_21 : expression (bv 32)) <- eval (extract v_8 128 160);
      let (v_22 : expression (bv 32)) <- eval (extract v_3 160 192);
      let (v_23 : expression (bv 32)) <- eval (extract v_5 160 192);
      let (v_24 : expression (bv 32)) <- eval (extract v_8 160 192);
      let (v_25 : expression (bv 32)) <- eval (extract v_3 192 224);
      let (v_26 : expression (bv 32)) <- eval (extract v_5 192 224);
      let (v_27 : expression (bv 32)) <- eval (extract v_8 192 224);
      let (v_28 : expression (bv 32)) <- eval (extract v_3 224 256);
      let (v_29 : expression (bv 32)) <- eval (extract v_5 224 256);
      let (v_30 : expression (bv 32)) <- eval (extract v_8 224 256);
      let v_31 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_25 v_26 v_27) (/- (_,_,_) -/ vfnmadd132_single v_28 v_29 v_30));
      let v_32 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_22 v_23 v_24) v_31);
      let v_33 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_19 v_20 v_21) v_32);
      let v_34 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_16 v_17 v_18) v_33);
      let v_35 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_13 v_14 v_15) v_34);
      let v_36 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_10 v_11 v_12) v_35);
      let v_37 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_4 v_6 v_9) v_36);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_19 : expression (bv 32)) <- eval (extract v_5 128 160);
      let (v_20 : expression (bv 32)) <- eval (extract v_7 128 160);
      let (v_21 : expression (bv 32)) <- eval (extract v_3 160 192);
      let (v_22 : expression (bv 32)) <- eval (extract v_5 160 192);
      let (v_23 : expression (bv 32)) <- eval (extract v_7 160 192);
      let (v_24 : expression (bv 32)) <- eval (extract v_3 192 224);
      let (v_25 : expression (bv 32)) <- eval (extract v_5 192 224);
      let (v_26 : expression (bv 32)) <- eval (extract v_7 192 224);
      let (v_27 : expression (bv 32)) <- eval (extract v_3 224 256);
      let (v_28 : expression (bv 32)) <- eval (extract v_5 224 256);
      let (v_29 : expression (bv 32)) <- eval (extract v_7 224 256);
      let v_30 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_24 v_25 v_26) (/- (_,_,_) -/ vfnmadd132_single v_27 v_28 v_29));
      let v_31 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_21 v_22 v_23) v_30);
      let v_32 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_18 v_19 v_20) v_31);
      let v_33 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_15 v_16 v_17) v_32);
      let v_34 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_12 v_13 v_14) v_33);
      let v_35 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_9 v_10 v_11) v_34);
      let v_36 <- eval (concat (/- (_,_,_) -/ vfnmadd132_single v_4 v_6 v_8) v_35);
