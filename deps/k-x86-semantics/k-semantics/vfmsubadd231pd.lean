  ...
  definst "vfmsubadd231pd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_19 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_9) v_12) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_14 v_16) v_18) 64));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_22 : expression (bv 64)) <- eval (extract v_7 128 192);
      ...
      let (v_28 : expression (bv 64)) <- eval (extract v_7 192 256);
      ...
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_21 v_23) v_25) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_27 v_29) v_31) 64));
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_18 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_11) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_13 v_15) v_17) 64));
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_20 v_22) v_24) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_26 v_28) v_30) 64));
