  ...
  definst "blsil" $ do
    instr_pat $ fun (mem_0 : Mem) (r32_1 : reg (bv 32)) =>
     let action : semantics Unit := do
      ...
      let v_3 <- load v_2 4;
      let v_4 <- eval (bv_and (add (expression.bv_nat 32 1) (bv_xor v_3 (expression.bv_nat 32 4294967295))) v_3);
    ...
    instr_pat $ fun (r32_0 : reg (bv 32)) (r32_1 : reg (bv 32)) =>
     let action : semantics Unit := do
      ...
      let v_3 <- eval (bv_and (add (expression.bv_nat 32 1) (bv_xor v_2 (expression.bv_nat 32 4294967295))) v_2);
