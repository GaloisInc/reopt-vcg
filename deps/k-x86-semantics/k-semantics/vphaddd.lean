  ...
  definst "vphaddd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let (v_6 : expression (bv 32)) <- eval (extract v_4 32 64);
      let (v_7 : expression (bv 32)) <- eval (extract v_4 64 96);
      let (v_8 : expression (bv 32)) <- eval (extract v_4 96 128);
      let v_9 <- eval (concat (add v_5 v_6) (add v_7 v_8));
      let v_10 <- getRegister (lhs.of_reg xmm_1);
      let (v_11 : expression (bv 32)) <- eval (extract v_10 0 32);
      let (v_12 : expression (bv 32)) <- eval (extract v_10 32 64);
      let v_13 <- eval (concat v_9 (add v_11 v_12));
      let (v_14 : expression (bv 32)) <- eval (extract v_10 64 96);
      let (v_15 : expression (bv 32)) <- eval (extract v_10 96 128);
      let v_16 <- eval (concat v_13 (add v_14 v_15));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_15 : expression (bv 32)) <- eval (extract v_10 96 128);
      let v_16 <- eval (concat v_13 (add v_14 v_15));
      let (v_17 : expression (bv 32)) <- eval (extract v_4 128 160);
      ...
      let (v_22 : expression (bv 32)) <- eval (extract v_10 128 160);
      let (v_23 : expression (bv 32)) <- eval (extract v_10 160 192);
      let v_24 <- eval (concat v_21 (add v_22 v_23));
      let (v_25 : expression (bv 32)) <- eval (extract v_10 192 224);
      let (v_26 : expression (bv 32)) <- eval (extract v_10 224 256);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_14 : expression (bv 32)) <- eval (extract v_9 96 128);
      let v_15 <- eval (concat v_12 (add v_13 v_14));
      let (v_16 : expression (bv 32)) <- eval (extract v_3 128 160);
      let (v_17 : expression (bv 32)) <- eval (extract v_3 160 192);
      ...
      let (v_21 : expression (bv 32)) <- eval (extract v_9 128 160);
      let (v_22 : expression (bv 32)) <- eval (extract v_9 160 192);
      let v_23 <- eval (concat v_20 (add v_21 v_22));
      let (v_24 : expression (bv 32)) <- eval (extract v_9 192 224);
      let (v_25 : expression (bv 32)) <- eval (extract v_9 224 256);
