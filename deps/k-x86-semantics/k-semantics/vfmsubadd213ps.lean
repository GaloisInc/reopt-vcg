def vfmsubadd213ps : instruction :=
  definst "vfmsubadd213ps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_14 v_16) v_18) 32)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_20 v_22) v_24) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_26 v_28) v_30) 32)));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_14 v_16) v_18) 32)) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_20 v_22) v_24) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_26 v_28) v_30) 32)) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_32 v_34) v_36) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_38 v_40) v_42) 32)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_44 v_46) v_48) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_50 v_52) v_54) 32)))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_11) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_13 v_15) v_17) 32)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_19 v_21) v_23) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_25 v_27) v_29) 32)));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_11) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_13 v_15) v_17) 32)) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_19 v_21) v_23) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_25 v_27) v_29) 32)) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_31 v_33) v_35) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_37 v_39) v_41) 32)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_43 v_45) v_47) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_49 v_51) v_53) 32)))));
      pure ()
    pat_end
