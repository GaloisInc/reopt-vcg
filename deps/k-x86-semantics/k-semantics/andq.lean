  ...
  definst "andq" $ do
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister pf (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (eq (bv_and v_7 v_8) (expression.bv_nat 1 1)) (eq (bv_and v_9 v_10) (expression.bv_nat 1 1)))) (eq (bv_and v_11 v_12) (expression.bv_nat 1 1)))) (eq (bv_and v_13 v_14) (expression.bv_nat 1 1)))) (eq (bv_and v_15 v_16) (expression.bv_nat 1 1)))) (eq (bv_and v_17 v_18) (expression.bv_nat 1 1)))) (eq (bv_and v_19 v_20) (expression.bv_nat 1 1)))) (eq (bv_and v_21 v_22) (expression.bv_nat 1 1)));
