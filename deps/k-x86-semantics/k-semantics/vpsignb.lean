def vpsignb : instruction :=
  definst "vpsignb" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      (v_22 : expression (bv 8)) <- eval (extract v_4 64 72);
      (v_23 : expression (bv 8)) <- eval (extract v_6 64 72);
      (v_24 : expression (bv 8)) <- eval (extract v_4 72 80);
      (v_25 : expression (bv 8)) <- eval (extract v_6 72 80);
      (v_26 : expression (bv 8)) <- eval (extract v_4 80 88);
      (v_27 : expression (bv 8)) <- eval (extract v_6 80 88);
      (v_28 : expression (bv 8)) <- eval (extract v_4 88 96);
      (v_29 : expression (bv 8)) <- eval (extract v_6 88 96);
      (v_30 : expression (bv 8)) <- eval (extract v_4 96 104);
      (v_31 : expression (bv 8)) <- eval (extract v_6 96 104);
      (v_32 : expression (bv 8)) <- eval (extract v_4 104 112);
      (v_33 : expression (bv 8)) <- eval (extract v_6 104 112);
      (v_34 : expression (bv 8)) <- eval (extract v_4 112 120);
      (v_35 : expression (bv 8)) <- eval (extract v_6 112 120);
      (v_36 : expression (bv 8)) <- eval (extract v_4 120 128);
      (v_37 : expression (bv 8)) <- eval (extract v_6 120 128);
      setRegister (lhs.of_reg xmm_2) (concat (mux (sgt v_5 (expression.bv_nat 8 0)) v_7 (mux (eq v_5 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_7 (expression.bv_nat 8 255))))) (concat (mux (sgt v_8 (expression.bv_nat 8 0)) v_9 (mux (eq v_8 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_9 (expression.bv_nat 8 255))))) (concat (mux (sgt v_10 (expression.bv_nat 8 0)) v_11 (mux (eq v_10 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_11 (expression.bv_nat 8 255))))) (concat (mux (sgt v_12 (expression.bv_nat 8 0)) v_13 (mux (eq v_12 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_13 (expression.bv_nat 8 255))))) (concat (mux (sgt v_14 (expression.bv_nat 8 0)) v_15 (mux (eq v_14 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_15 (expression.bv_nat 8 255))))) (concat (mux (sgt v_16 (expression.bv_nat 8 0)) v_17 (mux (eq v_16 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_17 (expression.bv_nat 8 255))))) (concat (mux (sgt v_18 (expression.bv_nat 8 0)) v_19 (mux (eq v_18 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_19 (expression.bv_nat 8 255))))) (concat (mux (sgt v_20 (expression.bv_nat 8 0)) v_21 (mux (eq v_20 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_21 (expression.bv_nat 8 255))))) (concat (mux (sgt v_22 (expression.bv_nat 8 0)) v_23 (mux (eq v_22 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_23 (expression.bv_nat 8 255))))) (concat (mux (sgt v_24 (expression.bv_nat 8 0)) v_25 (mux (eq v_24 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_25 (expression.bv_nat 8 255))))) (concat (mux (sgt v_26 (expression.bv_nat 8 0)) v_27 (mux (eq v_26 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_27 (expression.bv_nat 8 255))))) (concat (mux (sgt v_28 (expression.bv_nat 8 0)) v_29 (mux (eq v_28 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_29 (expression.bv_nat 8 255))))) (concat (mux (sgt v_30 (expression.bv_nat 8 0)) v_31 (mux (eq v_30 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_31 (expression.bv_nat 8 255))))) (concat (mux (sgt v_32 (expression.bv_nat 8 0)) v_33 (mux (eq v_32 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_33 (expression.bv_nat 8 255))))) (concat (mux (sgt v_34 (expression.bv_nat 8 0)) v_35 (mux (eq v_34 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_35 (expression.bv_nat 8 255))))) (mux (sgt v_36 (expression.bv_nat 8 0)) v_37 (mux (eq v_36 (expression.bv_nat 8 0)) (expression.bv_nat 8 0) (add (expression.bv_nat 8 1) (bv_xor v_37 (expression.bv_nat 8 255))))))))))))))))))));
      pure ()
    pat_end;
