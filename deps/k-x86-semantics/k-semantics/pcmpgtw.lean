  ...
  definst "pcmpgtw" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_21 <- eval (concat (mux (sgt v_17 v_18) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (mux (sgt v_19 v_20) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)));
      let v_22 <- eval (concat (mux (sgt v_15 v_16) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_21);
      let v_23 <- eval (concat (mux (sgt v_13 v_14) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_22);
      let v_24 <- eval (concat (mux (sgt v_11 v_12) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_23);
      let v_25 <- eval (concat (mux (sgt v_9 v_10) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_24);
      let v_26 <- eval (concat (mux (sgt v_7 v_8) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_25);
      let v_27 <- eval (concat (mux (sgt v_3 v_6) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_26);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_20 <- eval (concat (mux (sgt v_16 v_17) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (mux (sgt v_18 v_19) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)));
      let v_21 <- eval (concat (mux (sgt v_14 v_15) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_20);
      let v_22 <- eval (concat (mux (sgt v_12 v_13) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_21);
      let v_23 <- eval (concat (mux (sgt v_10 v_11) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_22);
      let v_24 <- eval (concat (mux (sgt v_8 v_9) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_23);
      let v_25 <- eval (concat (mux (sgt v_6 v_7) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_24);
      let v_26 <- eval (concat (mux (sgt v_3 v_5) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) v_25);
