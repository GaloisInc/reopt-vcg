def pcmpgtw : instruction :=
  definst "pcmpgtw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_3 v_6) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_7 v_8) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_9 v_10) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_11 v_12) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_13 v_14) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_15 v_16) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_17 v_18) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (mux (sgt v_19 v_20) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_3 v_5) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_6 v_7) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_8 v_9) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_10 v_11) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_12 v_13) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_14 v_15) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (concat (mux (sgt v_16 v_17) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)) (mux (sgt v_18 v_19) (expression.bv_nat 16 65535) (expression.bv_nat 16 0)))))))));
      pure ()
    pat_end
