  ...
  definst "rcrw" $ do
    ...
    instr_pat $ fun (_ : clReg) (r16_0 : reg (bv 16)) =>
     let action : semantics Unit := do
      ...
      let (v_11 : expression (bv 16)) <- eval (extract v_9 1 17);
      setRegister (lhs.of_reg r16_0) v_11;
      setRegister cf (isBitSet v_9 0);
    ...
    instr_pat $ fun (imm_0 : imm int) (r16_1 : reg (bv 16)) =>
     let action : semantics Unit := do
      ...
      let (v_10 : expression (bv 16)) <- eval (extract v_8 1 17);
      setRegister (lhs.of_reg r16_1) v_10;
      setRegister cf (isBitSet v_8 0);
