  ...
  definst "vfnmsub231pd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let (v_15 : expression (bv 64)) <- eval (extract v_7 64 128);
      ...
      let v_19 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_9)) v_12) 64) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_14 v_16)) v_18) 64));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_8 : expression (bv 64)) <- eval (extract v_7 0 64);
      let v_9 <- eval (bv_bitcast_to_fp float_class.fp64 v_8);
      let v_10 <- getRegister (lhs.of_reg ymm_2);
      let (v_11 : expression (bv 64)) <- eval (extract v_10 0 64);
      let v_12 <- eval (bv_bitcast_to_fp float_class.fp64 v_11);
      let (v_13 : expression (bv 64)) <- eval (extract v_3 64 128);
      let v_14 <- eval (bv_bitcast_to_fp float_class.fp64 v_13);
      ...
      let (v_21 : expression (bv 64)) <- eval (extract v_7 128 192);
      ...
      let (v_27 : expression (bv 64)) <- eval (extract v_7 192 256);
      ...
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_20 v_22)) v_24) 64) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_26 v_28)) v_30) 64));
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_14 v_16)) v_18) 64) v_31);
      let v_33 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_9)) v_12) 64) v_32);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_18 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_8)) v_11) 64) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_13 v_15)) v_17) 64));
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_30 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_19 v_21)) v_23) 64) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_25 v_27)) v_29) 64));
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_13 v_15)) v_17) 64) v_30);
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_8)) v_11) 64) v_31);
