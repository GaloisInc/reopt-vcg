def paddw : instruction :=
  definst "paddw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (add v_3 v_6) (concat (add v_7 v_8) (concat (add v_9 v_10) (concat (add v_11 v_12) (concat (add v_13 v_14) (concat (add v_15 v_16) (concat (add v_17 v_18) (add v_19 v_20))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (add v_3 v_5) (concat (add v_6 v_7) (concat (add v_8 v_9) (concat (add v_10 v_11) (concat (add v_12 v_13) (concat (add v_14 v_15) (concat (add v_16 v_17) (add v_18 v_19))))))));
      pure ()
    pat_end
