  ...
  definst "rclw" $ do
    instr_pat $ fun (_ : clReg) (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_7 <- eval (concat (expression.bv_nat 9 0) (bv_and v_6 (expression.bv_nat 8 31)));
      let v_8 <- eval (urem v_7 (expression.bv_nat 17 17));
    ...
    instr_pat $ fun (_ : clReg) (r16_0 : reg (bv 16)) =>
     let action : semantics Unit := do
      ...
      let v_3 <- eval (concat (expression.bv_nat 9 0) (bv_and v_2 (expression.bv_nat 8 31)));
      let v_4 <- eval (urem v_3 (expression.bv_nat 17 17));
      let (v_5 : expression (bv 8)) <- eval (extract v_4 9 17);
      ...
      let (v_12 : expression (bv 16)) <- eval (extract v_9 1 17);
      setRegister (lhs.of_reg r16_0) v_12;
      setRegister cf v_10;
    ...
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_6 <- eval (concat (expression.bv_nat 9 0) (bv_and (handleImmediateWithSignExtend imm_0 8 8) (expression.bv_nat 8 31)));
      let v_7 <- eval (urem v_6 (expression.bv_nat 17 17));
      let v_8 <- eval (rol v_5 v_7);
      let (v_9 : expression (bv 16)) <- eval (extract v_8 1 17);
      store v_2 v_9 2;
      let (v_11 : expression (bv 8)) <- eval (extract v_7 9 17);
    ...
    instr_pat $ fun (imm_0 : imm int) (r16_1 : reg (bv 16)) =>
     let action : semantics Unit := do
      let v_2 <- eval (concat (expression.bv_nat 9 0) (bv_and (handleImmediateWithSignExtend imm_0 8 8) (expression.bv_nat 8 31)));
      let v_3 <- eval (urem v_2 (expression.bv_nat 17 17));
      let (v_4 : expression (bv 8)) <- eval (extract v_3 9 17);
      ...
      let (v_11 : expression (bv 16)) <- eval (extract v_8 1 17);
      setRegister (lhs.of_reg r16_1) v_11;
      setRegister cf v_9;
