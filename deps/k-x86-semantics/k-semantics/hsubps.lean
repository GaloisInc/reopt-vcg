  ...
  definst "hsubps" $ do
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_11 <- eval (concat (fp_bitcast_to_bv (fp_sub v_4 v_6) 32) (fp_bitcast_to_bv (fp_sub v_8 v_10) 32));
      ...
      let v_17 <- eval (concat v_11 (fp_bitcast_to_bv (fp_sub v_14 v_16) 32));
      ...
      let v_22 <- eval (concat v_17 (fp_bitcast_to_bv (fp_sub v_19 v_21) 32));
