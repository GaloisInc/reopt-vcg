  ...
  definst "salq" $ do
    instr_pat $ fun (_ : clReg) (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_6 <- eval (bv_and v_5 (expression.bv_nat 8 63));
      let v_7 <- eval (concat (expression.bv_nat 57 0) v_6);
      let (v_8 : expression (bv 65)) <- eval (extract (shl v_3 v_7) 0 65);
      ...
      let (v_16 : expression (bv 8)) <- eval (extract v_8 57 65);
      let v_17 <- getRegister cf;
      let v_18 <- eval (mux (uge v_6 (expression.bv_nat 8 64)) undef (mux v_11 v_17 (isBitSet v_8 0)));
      ...
      setRegister zf (mux v_11 v_12 (eq v_9 (expression.bv_nat 64 0)));
      pure ()
     action;
    instr_pat $ fun (_ : clReg) (r64_0 : reg (bv 64)) =>
     let action : semantics Unit := do
      ...
      let v_8 <- eval (concat (expression.bv_nat 57 0) v_3);
      let (v_9 : expression (bv 65)) <- eval (extract (shl v_7 v_8) 0 65);
      ...
      let (v_14 : expression (bv 8)) <- eval (extract v_9 57 65);
      let v_15 <- getRegister cf;
      let v_16 <- eval (mux (uge v_3 (expression.bv_nat 8 64)) undef (mux v_4 v_15 (isBitSet v_9 0)));
      let v_17 <- getRegister of;
      let v_18 <- getRegister af;
      setRegister (lhs.of_reg r64_0) v_10;
      ...
      setRegister zf (mux v_4 v_5 (eq v_10 (expression.bv_nat 64 0)));
      pure ()
     action;
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_5 <- eval (bv_and (handleImmediateWithSignExtend imm_0 8 8) (expression.bv_nat 8 63));
      let v_6 <- eval (concat (expression.bv_nat 57 0) v_5);
      let (v_7 : expression (bv 65)) <- eval (extract (shl v_4 v_6) 0 65);
      ...
      let (v_15 : expression (bv 8)) <- eval (extract v_7 57 65);
      let v_16 <- getRegister cf;
      let v_17 <- eval (mux (uge v_5 (expression.bv_nat 8 64)) undef (mux v_10 v_16 (isBitSet v_7 0)));
      ...
      setRegister zf (mux v_10 v_11 (eq v_8 (expression.bv_nat 64 0)));
      pure ()
     action;
    instr_pat $ fun (imm_0 : imm int) (r64_1 : reg (bv 64)) =>
     let action : semantics Unit := do
      ...
      let v_7 <- eval (concat (expression.bv_nat 57 0) v_2);
      let (v_8 : expression (bv 65)) <- eval (extract (shl v_6 v_7) 0 65);
      let (v_9 : expression (bv 64)) <- eval (extract v_8 1 65);
      let v_10 <- getRegister sf;
      let v_11 <- eval (isBitSet v_8 1);
      let v_12 <- getRegister pf;
      let (v_13 : expression (bv 8)) <- eval (extract v_8 57 65);
      let v_14 <- getRegister cf;
      let v_15 <- eval (mux (uge v_2 (expression.bv_nat 8 64)) undef (mux v_3 v_14 (isBitSet v_8 0)));
      ...
      setRegister zf (mux v_3 v_4 (eq v_9 (expression.bv_nat 64 0)));
      pure ()
     action;
    instr_pat $ fun (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_2 <- load v_1 8;
      let v_3 <- eval (concat (expression.bv_nat 1 0) v_2);
      let (v_4 : expression (bv 65)) <- eval (extract (shl v_3 (expression.bv_nat 65 1)) 0 65);
      let (v_5 : expression (bv 64)) <- eval (extract v_4 1 65);
      store v_1 v_5 8;
      let v_7 <- eval (isBitSet v_4 1);
      let (v_8 : expression (bv 8)) <- eval (extract v_4 57 65);
    ...
    instr_pat $ fun (r64_0 : reg (bv 64)) =>
     let action : semantics Unit := do
      ...
      let (v_3 : expression (bv 65)) <- eval (extract (shl v_2 (expression.bv_nat 65 1)) 0 65);
      let (v_4 : expression (bv 64)) <- eval (extract v_3 1 65);
      let v_5 <- eval (isBitSet v_3 1);
      let (v_6 : expression (bv 8)) <- eval (extract v_3 57 65);
