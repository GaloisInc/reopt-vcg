def salq : instruction :=
  definst "salq" $ do
    pattern fun (_ : clReg) (mem_0 : Mem) => do
      ...
      (v_6 : expression (bv 65)) <- eval (extract (shl (concat (expression.bv_nat 1 0) v_2) (concat (expression.bv_nat 57 0) v_5)) 0 65);
      ...
      v_13 <- getRegister pf;
      (v_14 : expression (bv 8)) <- eval (extract v_6 57 65);
      v_15 <- getRegister cf;
      v_16 <- eval (mux (uge v_5 (expression.bv_nat 8 64)) undef (mux v_9 v_15 (isBitSet v_6 0)));
      v_17 <- getRegister of;
      v_18 <- getRegister af;
    ...
    pattern fun (_ : clReg) (r64_0 : reg (bv 64)) => do
      ...
      (v_7 : expression (bv 65)) <- eval (extract (shl (concat (expression.bv_nat 1 0) v_6) (concat (expression.bv_nat 57 0) v_3)) 0 65);
      (v_8 : expression (bv 64)) <- eval (extract v_7 1 65);
      v_9 <- getRegister sf;
      v_10 <- eval (isBitSet v_7 1);
      v_11 <- getRegister pf;
      (v_12 : expression (bv 8)) <- eval (extract v_7 57 65);
      v_13 <- getRegister cf;
      v_14 <- eval (mux (uge v_3 (expression.bv_nat 8 64)) undef (mux v_4 v_13 (isBitSet v_7 0)));
      v_15 <- getRegister of;
      v_16 <- getRegister af;
    ...
    pattern fun (imm_0 : imm int) (mem_1 : Mem) => do
      ...
      (v_5 : expression (bv 65)) <- eval (extract (shl (concat (expression.bv_nat 1 0) v_3) (concat (expression.bv_nat 57 0) v_4)) 0 65);
      ...
      v_12 <- getRegister pf;
      (v_13 : expression (bv 8)) <- eval (extract v_5 57 65);
      v_14 <- getRegister cf;
      v_15 <- eval (mux (uge v_4 (expression.bv_nat 8 64)) undef (mux v_8 v_14 (isBitSet v_5 0)));
      v_16 <- getRegister of;
      v_17 <- getRegister af;
    ...
    pattern fun (imm_0 : imm int) (r64_1 : reg (bv 64)) => do
      ...
      (v_6 : expression (bv 65)) <- eval (extract (shl (concat (expression.bv_nat 1 0) v_5) (concat (expression.bv_nat 57 0) v_2)) 0 65);
      (v_7 : expression (bv 64)) <- eval (extract v_6 1 65);
      v_8 <- getRegister sf;
      v_9 <- eval (isBitSet v_6 1);
      v_10 <- getRegister pf;
      (v_11 : expression (bv 8)) <- eval (extract v_6 57 65);
      v_12 <- getRegister cf;
      v_13 <- eval (mux (uge v_2 (expression.bv_nat 8 64)) undef (mux v_3 v_12 (isBitSet v_6 0)));
      v_14 <- getRegister of;
      v_15 <- getRegister af;
    ...
    pattern fun (mem_0 : Mem) => do
      v_1 <- evaluateAddress mem_0;
      v_2 <- load v_1 8;
      (v_3 : expression (bv 65)) <- eval (extract (shl (concat (expression.bv_nat 1 0) v_2) (expression.bv_nat 65 1)) 0 65);
      (v_4 : expression (bv 64)) <- eval (extract v_3 1 65);
      store v_1 v_4 8;
      v_6 <- eval (isBitSet v_3 1);
      (v_7 : expression (bv 8)) <- eval (extract v_3 57 65);
    ...
    pattern fun (r64_0 : reg (bv 64)) => do
      ...
      (v_2 : expression (bv 65)) <- eval (extract (shl (concat (expression.bv_nat 1 0) v_1) (expression.bv_nat 65 1)) 0 65);
      (v_3 : expression (bv 64)) <- eval (extract v_2 1 65);
      v_4 <- eval (isBitSet v_2 1);
      (v_5 : expression (bv 8)) <- eval (extract v_2 57 65);
