  ...
  definst "testq" $ do
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_5 <- eval (bv_and v_3 (sext v_4 64));
      let (v_6 : expression (bv 1)) <- eval (extract v_3 63 64);
      let (v_7 : expression (bv 1)) <- eval (extract v_4 31 32);
      let (v_8 : expression (bv 1)) <- eval (extract v_3 62 63);
      let (v_9 : expression (bv 1)) <- eval (extract v_4 30 31);
      let (v_10 : expression (bv 1)) <- eval (extract v_3 61 62);
      let (v_11 : expression (bv 1)) <- eval (extract v_4 29 30);
      let (v_12 : expression (bv 1)) <- eval (extract v_3 60 61);
      let (v_13 : expression (bv 1)) <- eval (extract v_4 28 29);
      let (v_14 : expression (bv 1)) <- eval (extract v_3 59 60);
      let (v_15 : expression (bv 1)) <- eval (extract v_4 27 28);
      let (v_16 : expression (bv 1)) <- eval (extract v_3 58 59);
      let (v_17 : expression (bv 1)) <- eval (extract v_4 26 27);
      let (v_18 : expression (bv 1)) <- eval (extract v_3 57 58);
      let (v_19 : expression (bv 1)) <- eval (extract v_4 25 26);
      let (v_20 : expression (bv 1)) <- eval (extract v_3 56 57);
      let (v_21 : expression (bv 1)) <- eval (extract v_4 24 25);
    ...
    instr_pat $ fun (imm_0 : imm int) (r64_1 : reg (bv 64)) =>
     let action : semantics Unit := do
      ...
      let v_4 <- eval (bv_and v_2 (sext v_3 64));
