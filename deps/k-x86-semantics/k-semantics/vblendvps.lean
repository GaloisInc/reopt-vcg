  ...
  definst "vblendvps" $ do
    instr_pat $ fun (xmm_0 : reg (bv 128)) (mem_1 : Mem) (xmm_2 : reg (bv 128)) (xmm_3 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_16 <- eval (concat (mux (isBitClear v_4 64) v_12 v_13) (mux (isBitClear v_4 96) v_14 v_15));
      let v_17 <- eval (concat (mux (isBitClear v_4 32) v_10 v_11) v_16);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) (xmm_3 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_15 <- eval (concat (mux (isBitClear v_4 64) v_11 v_12) (mux (isBitClear v_4 96) v_13 v_14));
      let v_16 <- eval (concat (mux (isBitClear v_4 32) v_9 v_10) v_15);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (mem_1 : Mem) (ymm_2 : reg (bv 256)) (ymm_3 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_24 <- eval (concat (mux (isBitClear v_4 192) v_20 v_21) (mux (isBitClear v_4 224) v_22 v_23));
      let v_25 <- eval (concat (mux (isBitClear v_4 160) v_18 v_19) v_24);
      let v_26 <- eval (concat (mux (isBitClear v_4 128) v_16 v_17) v_25);
      let v_27 <- eval (concat (mux (isBitClear v_4 96) v_14 v_15) v_26);
      let v_28 <- eval (concat (mux (isBitClear v_4 64) v_12 v_13) v_27);
      let v_29 <- eval (concat (mux (isBitClear v_4 32) v_10 v_11) v_28);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) (ymm_3 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_23 <- eval (concat (mux (isBitClear v_4 192) v_19 v_20) (mux (isBitClear v_4 224) v_21 v_22));
      let v_24 <- eval (concat (mux (isBitClear v_4 160) v_17 v_18) v_23);
      let v_25 <- eval (concat (mux (isBitClear v_4 128) v_15 v_16) v_24);
      let v_26 <- eval (concat (mux (isBitClear v_4 96) v_13 v_14) v_25);
      let v_27 <- eval (concat (mux (isBitClear v_4 64) v_11 v_12) v_26);
      let v_28 <- eval (concat (mux (isBitClear v_4 32) v_9 v_10) v_27);
