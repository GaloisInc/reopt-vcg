  ...
  definst "vaddps" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_22 <- eval (concat (fp_bitcast_to_bv (fp_add v_15 v_17) 32) (fp_bitcast_to_bv (fp_add v_19 v_21) 32));
      let v_23 <- eval (concat (fp_bitcast_to_bv (fp_add v_11 v_13) 32) v_22);
      let v_24 <- eval (concat (fp_bitcast_to_bv (fp_add v_5 v_9) 32) v_23);
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_38 <- eval (concat (fp_bitcast_to_bv (fp_add v_31 v_33) 32) (fp_bitcast_to_bv (fp_add v_35 v_37) 32));
      let v_39 <- eval (concat (fp_bitcast_to_bv (fp_add v_27 v_29) 32) v_38);
      let v_40 <- eval (concat (fp_bitcast_to_bv (fp_add v_23 v_25) 32) v_39);
      let v_41 <- eval (concat (fp_bitcast_to_bv (fp_add v_19 v_21) 32) v_40);
      let v_42 <- eval (concat (fp_bitcast_to_bv (fp_add v_15 v_17) 32) v_41);
      let v_43 <- eval (concat (fp_bitcast_to_bv (fp_add v_11 v_13) 32) v_42);
      let v_44 <- eval (concat (fp_bitcast_to_bv (fp_add v_5 v_9) 32) v_43);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_21 <- eval (concat (fp_bitcast_to_bv (fp_add v_14 v_16) 32) (fp_bitcast_to_bv (fp_add v_18 v_20) 32));
      let v_22 <- eval (concat (fp_bitcast_to_bv (fp_add v_10 v_12) 32) v_21);
      let v_23 <- eval (concat (fp_bitcast_to_bv (fp_add v_5 v_8) 32) v_22);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_37 <- eval (concat (fp_bitcast_to_bv (fp_add v_30 v_32) 32) (fp_bitcast_to_bv (fp_add v_34 v_36) 32));
      let v_38 <- eval (concat (fp_bitcast_to_bv (fp_add v_26 v_28) 32) v_37);
      let v_39 <- eval (concat (fp_bitcast_to_bv (fp_add v_22 v_24) 32) v_38);
      let v_40 <- eval (concat (fp_bitcast_to_bv (fp_add v_18 v_20) 32) v_39);
      let v_41 <- eval (concat (fp_bitcast_to_bv (fp_add v_14 v_16) 32) v_40);
      let v_42 <- eval (concat (fp_bitcast_to_bv (fp_add v_10 v_12) 32) v_41);
      let v_43 <- eval (concat (fp_bitcast_to_bv (fp_add v_5 v_8) 32) v_42);
