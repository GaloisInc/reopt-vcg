def vaddps : instruction :=
  definst "vaddps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_add v_5 v_9) 32) (concat (fp_bitcast_to_bv (fp_add v_11 v_13) 32) (concat (fp_bitcast_to_bv (fp_add v_15 v_17) 32) (fp_bitcast_to_bv (fp_add v_19 v_21) 32))));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_add v_5 v_9) 32) (concat (fp_bitcast_to_bv (fp_add v_11 v_13) 32) (concat (fp_bitcast_to_bv (fp_add v_15 v_17) 32) (concat (fp_bitcast_to_bv (fp_add v_19 v_21) 32) (concat (fp_bitcast_to_bv (fp_add v_23 v_25) 32) (concat (fp_bitcast_to_bv (fp_add v_27 v_29) 32) (concat (fp_bitcast_to_bv (fp_add v_31 v_33) 32) (fp_bitcast_to_bv (fp_add v_35 v_37) 32))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_add v_5 v_8) 32) (concat (fp_bitcast_to_bv (fp_add v_10 v_12) 32) (concat (fp_bitcast_to_bv (fp_add v_14 v_16) 32) (fp_bitcast_to_bv (fp_add v_18 v_20) 32))));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_add v_5 v_8) 32) (concat (fp_bitcast_to_bv (fp_add v_10 v_12) 32) (concat (fp_bitcast_to_bv (fp_add v_14 v_16) 32) (concat (fp_bitcast_to_bv (fp_add v_18 v_20) 32) (concat (fp_bitcast_to_bv (fp_add v_22 v_24) 32) (concat (fp_bitcast_to_bv (fp_add v_26 v_28) 32) (concat (fp_bitcast_to_bv (fp_add v_30 v_32) 32) (fp_bitcast_to_bv (fp_add v_34 v_36) 32))))))));
      pure ()
    pat_end
