def vfmadd213ps : instruction :=
  definst "vfmadd213ps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      (v_14 : expression (bv 32)) <- eval (extract v_3 32 64);
      v_15 <- eval (bv_bitcast_to_fp float_class.fp32 v_14);
      (v_16 : expression (bv 32)) <- eval (extract v_6 32 64);
      v_17 <- eval (bv_bitcast_to_fp float_class.fp32 v_16);
      (v_18 : expression (bv 32)) <- eval (extract v_10 32 64);
      v_19 <- eval (bv_bitcast_to_fp float_class.fp32 v_18);
      v_20 <- eval (bv_bitcast_to_fp float_class.fp32 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul (MInt2Float (expression.bv_nat 32 0) 24 8) v_19)) v_19) 32));
      (v_21 : expression (bv 32)) <- eval (extract v_3 64 96);
      v_22 <- eval (bv_bitcast_to_fp float_class.fp32 v_21);
      (v_23 : expression (bv 32)) <- eval (extract v_6 64 96);
      v_24 <- eval (bv_bitcast_to_fp float_class.fp32 v_23);
      (v_25 : expression (bv 32)) <- eval (extract v_10 64 96);
      v_26 <- eval (bv_bitcast_to_fp float_class.fp32 v_25);
      v_27 <- eval (bv_bitcast_to_fp float_class.fp32 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul (MInt2Float (expression.bv_nat 32 0) 24 8) v_26)) v_26) 32));
      (v_28 : expression (bv 32)) <- eval (extract v_3 96 128);
      v_29 <- eval (bv_bitcast_to_fp float_class.fp32 v_28);
      (v_30 : expression (bv 32)) <- eval (extract v_6 96 128);
      v_31 <- eval (bv_bitcast_to_fp float_class.fp32 v_30);
      (v_32 : expression (bv 32)) <- eval (extract v_10 96 128);
      v_33 <- eval (bv_bitcast_to_fp float_class.fp32 v_32);
      v_34 <- eval (bv_bitcast_to_fp float_class.fp32 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul (MInt2Float (expression.bv_nat 32 0) 24 8) v_33)) v_33) 32));
      setRegister (lhs.of_reg xmm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_13) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_15 v_17) v_20) 32)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_22 v_24) v_27) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_29 v_31) v_34) 32)));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      (v_15 : expression (bv 32)) <- eval (extract v_6 32 64);
      ...
      (v_33 : expression (bv 32)) <- eval (extract v_6 128 160);
      ...
      (v_39 : expression (bv 32)) <- eval (extract v_6 160 192);
      ...
      (v_45 : expression (bv 32)) <- eval (extract v_6 192 224);
      ...
      (v_51 : expression (bv 32)) <- eval (extract v_6 224 256);
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_add (fp_mul v_5 v_8) v_12) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_14 v_16) v_18) 32)) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_20 v_22) v_24) 32) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_26 v_28) v_30) 32) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_32 v_34) v_36) 32) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_38 v_40) v_42) 32) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_44 v_46) v_48) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_50 v_52) v_54) 32)))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      v_12 <- eval (bv_bitcast_to_fp float_class.fp32 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul (MInt2Float (expression.bv_nat 32 0) 24 8) v_11)) v_11) 32));
      (v_13 : expression (bv 32)) <- eval (extract v_3 32 64);
      v_14 <- eval (bv_bitcast_to_fp float_class.fp32 v_13);
      (v_15 : expression (bv 32)) <- eval (extract v_6 32 64);
      v_16 <- eval (bv_bitcast_to_fp float_class.fp32 v_15);
      (v_17 : expression (bv 32)) <- eval (extract v_9 32 64);
      v_18 <- eval (bv_bitcast_to_fp float_class.fp32 v_17);
      v_19 <- eval (bv_bitcast_to_fp float_class.fp32 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul (MInt2Float (expression.bv_nat 32 0) 24 8) v_18)) v_18) 32));
      (v_20 : expression (bv 32)) <- eval (extract v_3 64 96);
      v_21 <- eval (bv_bitcast_to_fp float_class.fp32 v_20);
      (v_22 : expression (bv 32)) <- eval (extract v_6 64 96);
      v_23 <- eval (bv_bitcast_to_fp float_class.fp32 v_22);
      (v_24 : expression (bv 32)) <- eval (extract v_9 64 96);
      v_25 <- eval (bv_bitcast_to_fp float_class.fp32 v_24);
      v_26 <- eval (bv_bitcast_to_fp float_class.fp32 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul (MInt2Float (expression.bv_nat 32 0) 24 8) v_25)) v_25) 32));
      (v_27 : expression (bv 32)) <- eval (extract v_3 96 128);
      v_28 <- eval (bv_bitcast_to_fp float_class.fp32 v_27);
      (v_29 : expression (bv 32)) <- eval (extract v_6 96 128);
      v_30 <- eval (bv_bitcast_to_fp float_class.fp32 v_29);
      (v_31 : expression (bv 32)) <- eval (extract v_9 96 128);
      v_32 <- eval (bv_bitcast_to_fp float_class.fp32 v_31);
      v_33 <- eval (bv_bitcast_to_fp float_class.fp32 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul (MInt2Float (expression.bv_nat 32 0) 24 8) v_32)) v_32) 32));
      setRegister (lhs.of_reg xmm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_14 v_16) v_19) 32)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_21 v_23) v_26) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_28 v_30) v_33) 32)));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_add (fp_mul v_5 v_8) v_11) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_13 v_15) v_17) 32)) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_19 v_21) v_23) 32) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_25 v_27) v_29) 32) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_31 v_33) v_35) 32) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_37 v_39) v_41) 32) (concat (fp_bitcast_to_bv (fp_add (fp_mul v_43 v_45) v_47) 32) (fp_bitcast_to_bv (fp_add (fp_mul v_49 v_51) v_53) 32)))))));
      pure ()
    pat_end
