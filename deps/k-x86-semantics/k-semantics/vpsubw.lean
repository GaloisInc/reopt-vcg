def vpsubw : instruction :=
  definst "vpsubw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (sub v_4 v_7) (concat (sub v_8 v_9) (concat (sub v_10 v_11) (concat (sub v_12 v_13) (concat (sub v_14 v_15) (concat (sub v_16 v_17) (concat (sub v_18 v_19) (sub v_20 v_21))))))));
      pure ()
    pat_end;
    ...
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (sub v_4 v_6) (concat (sub v_7 v_8) (concat (sub v_9 v_10) (concat (sub v_11 v_12) (concat (sub v_13 v_14) (concat (sub v_15 v_16) (concat (sub v_17 v_18) (sub v_19 v_20))))))));
      pure ()
    pat_end;
