def vpsubq : instruction :=
  definst "vpsubq" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (sub v_4 v_7) (sub v_8 v_9));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (sub v_4 v_7) (concat (sub v_8 v_9) (concat (sub v_10 v_11) (sub v_12 v_13))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (sub v_4 v_6) (sub v_7 v_8));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (sub v_4 v_6) (concat (sub v_7 v_8) (concat (sub v_9 v_10) (sub v_11 v_12))));
      pure ()
    pat_end
