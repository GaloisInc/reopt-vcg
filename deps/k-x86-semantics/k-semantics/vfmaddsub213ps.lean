  ...
  definst "vfmaddsub213ps" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_19 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_5 v_8) v_12) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_14 v_16) v_18) 32));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_48 : expression (bv 32)) <- eval (extract v_6 192 224);
      ...
      let (v_54 : expression (bv 32)) <- eval (extract v_6 224 256);
