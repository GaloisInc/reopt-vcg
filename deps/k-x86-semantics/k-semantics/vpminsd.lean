  ...
  definst "vpminsd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_14 <- eval (concat (mux (slt v_10 v_11) v_10 v_11) (mux (slt v_12 v_13) v_12 v_13));
      let v_15 <- eval (concat (mux (slt v_8 v_9) v_8 v_9) v_14);
      let v_16 <- eval (concat (mux (slt v_4 v_7) v_4 v_7) v_15);
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_22 <- eval (concat (mux (slt v_18 v_19) v_18 v_19) (mux (slt v_20 v_21) v_20 v_21));
      let v_23 <- eval (concat (mux (slt v_16 v_17) v_16 v_17) v_22);
      let v_24 <- eval (concat (mux (slt v_14 v_15) v_14 v_15) v_23);
      let v_25 <- eval (concat (mux (slt v_12 v_13) v_12 v_13) v_24);
      let v_26 <- eval (concat (mux (slt v_10 v_11) v_10 v_11) v_25);
      let v_27 <- eval (concat (mux (slt v_8 v_9) v_8 v_9) v_26);
      let v_28 <- eval (concat (mux (slt v_4 v_7) v_4 v_7) v_27);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (concat (mux (slt v_9 v_10) v_9 v_10) (mux (slt v_11 v_12) v_11 v_12));
      let v_14 <- eval (concat (mux (slt v_7 v_8) v_7 v_8) v_13);
      let v_15 <- eval (concat (mux (slt v_4 v_6) v_4 v_6) v_14);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_21 <- eval (concat (mux (slt v_17 v_18) v_17 v_18) (mux (slt v_19 v_20) v_19 v_20));
      let v_22 <- eval (concat (mux (slt v_15 v_16) v_15 v_16) v_21);
      let v_23 <- eval (concat (mux (slt v_13 v_14) v_13 v_14) v_22);
      let v_24 <- eval (concat (mux (slt v_11 v_12) v_11 v_12) v_23);
      let v_25 <- eval (concat (mux (slt v_9 v_10) v_9 v_10) v_24);
      let v_26 <- eval (concat (mux (slt v_7 v_8) v_7 v_8) v_25);
      let v_27 <- eval (concat (mux (slt v_4 v_6) v_4 v_6) v_26);
