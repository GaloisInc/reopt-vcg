  ...
  definst "vsqrtps" $ do
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_12 <- eval (concat (/- (_) -/ sqrt_single v_10) (/- (_) -/ sqrt_single v_11));
      let v_13 <- eval (concat (/- (_) -/ sqrt_single v_9) v_12);
      let v_14 <- eval (concat (/- (_) -/ sqrt_single v_8) v_13);
      let v_15 <- eval (concat (/- (_) -/ sqrt_single v_7) v_14);
      let v_16 <- eval (concat (/- (_) -/ sqrt_single v_6) v_15);
      let v_17 <- eval (concat (/- (_) -/ sqrt_single v_5) v_16);
      let v_18 <- eval (concat (/- (_) -/ sqrt_single v_4) v_17);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_11 <- eval (concat (/- (_) -/ sqrt_single v_9) (/- (_) -/ sqrt_single v_10));
      let v_12 <- eval (concat (/- (_) -/ sqrt_single v_8) v_11);
      let v_13 <- eval (concat (/- (_) -/ sqrt_single v_7) v_12);
      let v_14 <- eval (concat (/- (_) -/ sqrt_single v_6) v_13);
      let v_15 <- eval (concat (/- (_) -/ sqrt_single v_5) v_14);
      let v_16 <- eval (concat (/- (_) -/ sqrt_single v_4) v_15);
      let v_17 <- eval (concat (/- (_) -/ sqrt_single v_3) v_16);
