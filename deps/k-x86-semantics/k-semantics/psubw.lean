  ...
  definst "psubw" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_27 <- eval (concat (sub v_3 v_6) v_26);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_21 <- eval (concat (sub v_14 v_15) v_20);
      let v_22 <- eval (concat (sub v_12 v_13) v_21);
      let v_23 <- eval (concat (sub v_10 v_11) v_22);
      let v_24 <- eval (concat (sub v_8 v_9) v_23);
      let v_25 <- eval (concat (sub v_6 v_7) v_24);
      let v_26 <- eval (concat (sub v_3 v_5) v_25);
