  ...
  definst "pmaxsw" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_27 <- eval (concat (mux (sgt v_3 v_6) v_3 v_6) v_26);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_20 <- eval (concat (mux (sgt v_16 v_17) v_16 v_17) (mux (sgt v_18 v_19) v_18 v_19));
      let v_21 <- eval (concat (mux (sgt v_14 v_15) v_14 v_15) v_20);
      let v_22 <- eval (concat (mux (sgt v_12 v_13) v_12 v_13) v_21);
      let v_23 <- eval (concat (mux (sgt v_10 v_11) v_10 v_11) v_22);
      let v_24 <- eval (concat (mux (sgt v_8 v_9) v_8 v_9) v_23);
      let v_25 <- eval (concat (mux (sgt v_6 v_7) v_6 v_7) v_24);
      let v_26 <- eval (concat (mux (sgt v_3 v_5) v_3 v_5) v_25);
