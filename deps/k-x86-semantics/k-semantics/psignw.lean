  ...
  definst "psignw" $ do
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_21 <- eval (concat (mux (sgt v_14 (expression.bv_nat 16 0)) v_15 (mux (eq v_14 (expression.bv_nat 16 0)) (expression.bv_nat 16 0) (add (expression.bv_nat 16 1) (bv_xor v_15 (expression.bv_nat 16 65535))))) v_20);
      let v_22 <- eval (concat (mux (sgt v_12 (expression.bv_nat 16 0)) v_13 (mux (eq v_12 (expression.bv_nat 16 0)) (expression.bv_nat 16 0) (add (expression.bv_nat 16 1) (bv_xor v_13 (expression.bv_nat 16 65535))))) v_21);
      let v_23 <- eval (concat (mux (sgt v_10 (expression.bv_nat 16 0)) v_11 (mux (eq v_10 (expression.bv_nat 16 0)) (expression.bv_nat 16 0) (add (expression.bv_nat 16 1) (bv_xor v_11 (expression.bv_nat 16 65535))))) v_22);
      let v_24 <- eval (concat (mux (sgt v_8 (expression.bv_nat 16 0)) v_9 (mux (eq v_8 (expression.bv_nat 16 0)) (expression.bv_nat 16 0) (add (expression.bv_nat 16 1) (bv_xor v_9 (expression.bv_nat 16 65535))))) v_23);
      let v_25 <- eval (concat (mux (sgt v_6 (expression.bv_nat 16 0)) v_7 (mux (eq v_6 (expression.bv_nat 16 0)) (expression.bv_nat 16 0) (add (expression.bv_nat 16 1) (bv_xor v_7 (expression.bv_nat 16 65535))))) v_24);
      let v_26 <- eval (concat (mux (sgt v_3 (expression.bv_nat 16 0)) v_5 (mux (eq v_3 (expression.bv_nat 16 0)) (expression.bv_nat 16 0) (add (expression.bv_nat 16 1) (bv_xor v_5 (expression.bv_nat 16 65535))))) v_25);
