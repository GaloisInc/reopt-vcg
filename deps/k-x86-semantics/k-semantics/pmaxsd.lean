  ...
  definst "pmaxsd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_15 <- eval (concat (mux (sgt v_3 v_6) v_3 v_6) v_14);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_12 <- eval (concat (mux (sgt v_8 v_9) v_8 v_9) (mux (sgt v_10 v_11) v_10 v_11));
      let v_13 <- eval (concat (mux (sgt v_6 v_7) v_6 v_7) v_12);
      let v_14 <- eval (concat (mux (sgt v_3 v_5) v_3 v_5) v_13);
