  ...
  definst "vtestpd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let (v_6 : expression (bv 1)) <- eval (extract v_2 64 65);
      let (v_7 : expression (bv 1)) <- eval (extract v_4 64 65);
      let (v_8 : expression (bv 1)) <- eval (extract v_2 0 1);
      let (v_9 : expression (bv 1)) <- eval (extract v_4 0 1);
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_4 <- load v_3 32;
      let v_5 <- eval (bv_and v_2 v_4);
      let (v_6 : expression (bv 1)) <- eval (extract v_2 192 193);
      let (v_7 : expression (bv 1)) <- eval (extract v_4 192 193);
      let (v_8 : expression (bv 1)) <- eval (extract v_2 128 129);
      let (v_9 : expression (bv 1)) <- eval (extract v_4 128 129);
      let (v_10 : expression (bv 1)) <- eval (extract v_2 64 65);
      let (v_11 : expression (bv 1)) <- eval (extract v_4 64 65);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let (v_6 : expression (bv 1)) <- eval (extract v_3 64 65);
      let (v_7 : expression (bv 1)) <- eval (extract v_2 0 1);
      let (v_8 : expression (bv 1)) <- eval (extract v_3 0 1);
      setRegister af bit_zero;
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_4 <- eval (bv_and v_2 v_3);
      let (v_5 : expression (bv 1)) <- eval (extract v_2 192 193);
      let (v_6 : expression (bv 1)) <- eval (extract v_3 192 193);
      let (v_7 : expression (bv 1)) <- eval (extract v_2 128 129);
      let (v_8 : expression (bv 1)) <- eval (extract v_3 128 129);
      let (v_9 : expression (bv 1)) <- eval (extract v_2 64 65);
      let (v_10 : expression (bv 1)) <- eval (extract v_3 64 65);
