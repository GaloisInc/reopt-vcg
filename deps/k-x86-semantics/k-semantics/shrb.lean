  ...
  definst "shrb" $ do
    instr_pat $ fun (_ : clReg) (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister af (mux v_11 v_17 undef);
      setRegister cf (mux (uge v_6 (expression.bv_nat 8 8)) undef (mux v_11 v_16 (isBitSet v_8 8)));
      setRegister of (mux (eq v_6 (expression.bv_nat 8 1)) (isBitSet v_2 0) (mux v_11 v_15 undef));
      setRegister pf (mux v_11 v_14 (parityFlag v_9));
    ...
    instr_pat $ fun (_ : clReg) (rh_0 : reg (bv 8)) =>
     let action : semantics Unit := do
      ...
      let (v_10 : expression (bv 8)) <- eval (extract v_9 0 8);
      ...
      setRegister cf (mux (uge v_3 (expression.bv_nat 8 8)) undef (mux v_4 v_14 (isBitSet v_9 8)));
      setRegister of (mux (eq v_3 (expression.bv_nat 8 1)) (isBitSet v_6 0) (mux v_4 v_13 undef));
      setRegister pf (mux v_4 v_12 (parityFlag v_10));
    ...
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister af (mux v_10 v_16 undef);
      setRegister cf (mux (uge v_5 (expression.bv_nat 8 8)) undef (mux v_10 v_15 (isBitSet v_7 8)));
      setRegister of (mux (eq v_5 (expression.bv_nat 8 1)) (isBitSet v_3 0) (mux v_10 v_14 undef));
      setRegister pf (mux v_10 v_13 (parityFlag v_8));
    ...
    instr_pat $ fun (imm_0 : imm int) (rh_1 : reg (bv 8)) =>
     let action : semantics Unit := do
      ...
      let v_14 <- getRegister af;
      setRegister (lhs.of_reg rh_1) v_9;
      setRegister af (mux v_3 v_14 undef);
      setRegister cf (mux (uge v_2 (expression.bv_nat 8 8)) undef (mux v_3 v_13 (isBitSet v_8 8)));
      setRegister of (mux (eq v_2 (expression.bv_nat 8 1)) (isBitSet v_5 0) (mux v_3 v_12 undef));
      setRegister pf (mux v_3 v_11 (parityFlag v_9));
    ...
    instr_pat $ fun (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_2 <- load v_1 1;
      let v_3 <- eval (concat v_2 (expression.bv_nat 1 0));
      let v_4 <- eval (lshr v_3 (expression.bv_nat 9 1));
      let (v_5 : expression (bv 8)) <- eval (extract v_4 0 8);
      store v_1 v_5 1;
      setRegister af undef;
      setRegister cf (isBitSet v_4 8);
    ...
    instr_pat $ fun (rh_0 : reg (bv 8)) =>
     let action : semantics Unit := do
      ...
      let v_3 <- eval (lshr v_2 (expression.bv_nat 9 1));
