  ...
  definst "vpmaxsb" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_38 <- eval (concat (mux (sgt v_34 v_35) v_34 v_35) (mux (sgt v_36 v_37) v_36 v_37));
      let v_39 <- eval (concat (mux (sgt v_32 v_33) v_32 v_33) v_38);
      let v_40 <- eval (concat (mux (sgt v_30 v_31) v_30 v_31) v_39);
      let v_41 <- eval (concat (mux (sgt v_28 v_29) v_28 v_29) v_40);
      let v_42 <- eval (concat (mux (sgt v_26 v_27) v_26 v_27) v_41);
      let v_43 <- eval (concat (mux (sgt v_24 v_25) v_24 v_25) v_42);
      let v_44 <- eval (concat (mux (sgt v_22 v_23) v_22 v_23) v_43);
      let v_45 <- eval (concat (mux (sgt v_20 v_21) v_20 v_21) v_44);
      let v_46 <- eval (concat (mux (sgt v_18 v_19) v_18 v_19) v_45);
      let v_47 <- eval (concat (mux (sgt v_16 v_17) v_16 v_17) v_46);
      let v_48 <- eval (concat (mux (sgt v_14 v_15) v_14 v_15) v_47);
      let v_49 <- eval (concat (mux (sgt v_12 v_13) v_12 v_13) v_48);
      let v_50 <- eval (concat (mux (sgt v_10 v_11) v_10 v_11) v_49);
      let v_51 <- eval (concat (mux (sgt v_8 v_9) v_8 v_9) v_50);
      let v_52 <- eval (concat (mux (sgt v_4 v_7) v_4 v_7) v_51);
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_70 <- eval (concat (mux (sgt v_66 v_67) v_66 v_67) (mux (sgt v_68 v_69) v_68 v_69));
      let v_71 <- eval (concat (mux (sgt v_64 v_65) v_64 v_65) v_70);
      let v_72 <- eval (concat (mux (sgt v_62 v_63) v_62 v_63) v_71);
      let v_73 <- eval (concat (mux (sgt v_60 v_61) v_60 v_61) v_72);
      let v_74 <- eval (concat (mux (sgt v_58 v_59) v_58 v_59) v_73);
      let v_75 <- eval (concat (mux (sgt v_56 v_57) v_56 v_57) v_74);
      let v_76 <- eval (concat (mux (sgt v_54 v_55) v_54 v_55) v_75);
      let v_77 <- eval (concat (mux (sgt v_52 v_53) v_52 v_53) v_76);
      let v_78 <- eval (concat (mux (sgt v_50 v_51) v_50 v_51) v_77);
      let v_79 <- eval (concat (mux (sgt v_48 v_49) v_48 v_49) v_78);
      let v_80 <- eval (concat (mux (sgt v_46 v_47) v_46 v_47) v_79);
      let v_81 <- eval (concat (mux (sgt v_44 v_45) v_44 v_45) v_80);
      let v_82 <- eval (concat (mux (sgt v_42 v_43) v_42 v_43) v_81);
      let v_83 <- eval (concat (mux (sgt v_40 v_41) v_40 v_41) v_82);
      let v_84 <- eval (concat (mux (sgt v_38 v_39) v_38 v_39) v_83);
      let v_85 <- eval (concat (mux (sgt v_36 v_37) v_36 v_37) v_84);
      let v_86 <- eval (concat (mux (sgt v_34 v_35) v_34 v_35) v_85);
      let v_87 <- eval (concat (mux (sgt v_32 v_33) v_32 v_33) v_86);
      let v_88 <- eval (concat (mux (sgt v_30 v_31) v_30 v_31) v_87);
      let v_89 <- eval (concat (mux (sgt v_28 v_29) v_28 v_29) v_88);
      let v_90 <- eval (concat (mux (sgt v_26 v_27) v_26 v_27) v_89);
      let v_91 <- eval (concat (mux (sgt v_24 v_25) v_24 v_25) v_90);
      let v_92 <- eval (concat (mux (sgt v_22 v_23) v_22 v_23) v_91);
      let v_93 <- eval (concat (mux (sgt v_20 v_21) v_20 v_21) v_92);
      let v_94 <- eval (concat (mux (sgt v_18 v_19) v_18 v_19) v_93);
      let v_95 <- eval (concat (mux (sgt v_16 v_17) v_16 v_17) v_94);
      let v_96 <- eval (concat (mux (sgt v_14 v_15) v_14 v_15) v_95);
      let v_97 <- eval (concat (mux (sgt v_12 v_13) v_12 v_13) v_96);
      let v_98 <- eval (concat (mux (sgt v_10 v_11) v_10 v_11) v_97);
      let v_99 <- eval (concat (mux (sgt v_8 v_9) v_8 v_9) v_98);
      let v_100 <- eval (concat (mux (sgt v_4 v_7) v_4 v_7) v_99);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_51 <- eval (concat (mux (sgt v_4 v_6) v_4 v_6) v_50);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_69 <- eval (concat (mux (sgt v_65 v_66) v_65 v_66) (mux (sgt v_67 v_68) v_67 v_68));
      let v_70 <- eval (concat (mux (sgt v_63 v_64) v_63 v_64) v_69);
      let v_71 <- eval (concat (mux (sgt v_61 v_62) v_61 v_62) v_70);
      let v_72 <- eval (concat (mux (sgt v_59 v_60) v_59 v_60) v_71);
      let v_73 <- eval (concat (mux (sgt v_57 v_58) v_57 v_58) v_72);
      let v_74 <- eval (concat (mux (sgt v_55 v_56) v_55 v_56) v_73);
      let v_75 <- eval (concat (mux (sgt v_53 v_54) v_53 v_54) v_74);
      let v_76 <- eval (concat (mux (sgt v_51 v_52) v_51 v_52) v_75);
      let v_77 <- eval (concat (mux (sgt v_49 v_50) v_49 v_50) v_76);
      let v_78 <- eval (concat (mux (sgt v_47 v_48) v_47 v_48) v_77);
      let v_79 <- eval (concat (mux (sgt v_45 v_46) v_45 v_46) v_78);
      let v_80 <- eval (concat (mux (sgt v_43 v_44) v_43 v_44) v_79);
      let v_81 <- eval (concat (mux (sgt v_41 v_42) v_41 v_42) v_80);
      let v_82 <- eval (concat (mux (sgt v_39 v_40) v_39 v_40) v_81);
      let v_83 <- eval (concat (mux (sgt v_37 v_38) v_37 v_38) v_82);
      let v_84 <- eval (concat (mux (sgt v_35 v_36) v_35 v_36) v_83);
      let v_85 <- eval (concat (mux (sgt v_33 v_34) v_33 v_34) v_84);
      let v_86 <- eval (concat (mux (sgt v_31 v_32) v_31 v_32) v_85);
      let v_87 <- eval (concat (mux (sgt v_29 v_30) v_29 v_30) v_86);
      let v_88 <- eval (concat (mux (sgt v_27 v_28) v_27 v_28) v_87);
      let v_89 <- eval (concat (mux (sgt v_25 v_26) v_25 v_26) v_88);
      let v_90 <- eval (concat (mux (sgt v_23 v_24) v_23 v_24) v_89);
      let v_91 <- eval (concat (mux (sgt v_21 v_22) v_21 v_22) v_90);
      let v_92 <- eval (concat (mux (sgt v_19 v_20) v_19 v_20) v_91);
      let v_93 <- eval (concat (mux (sgt v_17 v_18) v_17 v_18) v_92);
      let v_94 <- eval (concat (mux (sgt v_15 v_16) v_15 v_16) v_93);
      let v_95 <- eval (concat (mux (sgt v_13 v_14) v_13 v_14) v_94);
      let v_96 <- eval (concat (mux (sgt v_11 v_12) v_11 v_12) v_95);
      let v_97 <- eval (concat (mux (sgt v_9 v_10) v_9 v_10) v_96);
      let v_98 <- eval (concat (mux (sgt v_7 v_8) v_7 v_8) v_97);
      let v_99 <- eval (concat (mux (sgt v_4 v_6) v_4 v_6) v_98);
