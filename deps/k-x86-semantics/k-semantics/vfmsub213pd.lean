  ...
  definst "vfmsub213pd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 64);
      let (v_14 : expression (bv 56)) <- eval (extract v_13 0 56);
      let (v_15 : expression (bv 8)) <- eval (extract v_13 56 64);
      let v_16 <- eval (concat v_14 v_15);
      let (v_17 : expression (bv 64)) <- eval (extract v_3 64 128);
      let v_18 <- eval (bv_bitcast_to_fp float_class.fp64 v_17);
      let (v_19 : expression (bv 64)) <- eval (extract v_6 64 128);
      let v_20 <- eval (bv_bitcast_to_fp float_class.fp64 v_19);
      let (v_21 : expression (bv 64)) <- eval (extract v_10 64 128);
      let v_22 <- eval (bv_bitcast_to_fp float_class.fp64 v_21);
      let v_23 <- eval (concat v_16 (fp_bitcast_to_bv (fp_sub (fp_mul v_18 v_20) v_22) 64));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_22 <- eval (bv_bitcast_to_fp float_class.fp64 v_21);
      let (v_23 : expression (bv 64)) <- eval (extract v_10 128 192);
      ...
      let (v_29 : expression (bv 64)) <- eval (extract v_10 192 256);
      let v_30 <- eval (bv_bitcast_to_fp float_class.fp64 v_29);
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_20 v_22) v_24) 64) (fp_bitcast_to_bv (fp_sub (fp_mul v_26 v_28) v_30) 64));
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_14 v_16) v_18) 64) v_31);
      let v_33 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 64) v_32);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_12 <- eval (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_11) 64);
      let (v_13 : expression (bv 56)) <- eval (extract v_12 0 56);
      let (v_14 : expression (bv 8)) <- eval (extract v_12 56 64);
      let v_15 <- eval (concat v_13 v_14);
      let (v_16 : expression (bv 64)) <- eval (extract v_3 64 128);
      let v_17 <- eval (bv_bitcast_to_fp float_class.fp64 v_16);
      let (v_18 : expression (bv 64)) <- eval (extract v_6 64 128);
      let v_19 <- eval (bv_bitcast_to_fp float_class.fp64 v_18);
      let (v_20 : expression (bv 64)) <- eval (extract v_9 64 128);
      let v_21 <- eval (bv_bitcast_to_fp float_class.fp64 v_20);
      let v_22 <- eval (concat v_15 (fp_bitcast_to_bv (fp_sub (fp_mul v_17 v_19) v_21) 64));
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_17 <- eval (bv_bitcast_to_fp float_class.fp64 v_16);
      let (v_18 : expression (bv 64)) <- eval (extract v_3 128 192);
      let v_19 <- eval (bv_bitcast_to_fp float_class.fp64 v_18);
      let (v_20 : expression (bv 64)) <- eval (extract v_6 128 192);
      let v_21 <- eval (bv_bitcast_to_fp float_class.fp64 v_20);
      let (v_22 : expression (bv 64)) <- eval (extract v_9 128 192);
      let v_23 <- eval (bv_bitcast_to_fp float_class.fp64 v_22);
      let (v_24 : expression (bv 64)) <- eval (extract v_3 192 256);
      let v_25 <- eval (bv_bitcast_to_fp float_class.fp64 v_24);
      let (v_26 : expression (bv 64)) <- eval (extract v_6 192 256);
      let v_27 <- eval (bv_bitcast_to_fp float_class.fp64 v_26);
      let (v_28 : expression (bv 64)) <- eval (extract v_9 192 256);
      let v_29 <- eval (bv_bitcast_to_fp float_class.fp64 v_28);
      let v_30 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_19 v_21) v_23) 64) (fp_bitcast_to_bv (fp_sub (fp_mul v_25 v_27) v_29) 64));
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_13 v_15) v_17) 64) v_30);
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_11) 64) v_31);
