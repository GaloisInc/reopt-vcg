  ...
  definst "mulps" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_23 <- eval (concat (fp_bitcast_to_bv (fp_mul v_4 v_8) 32) v_22);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_20 <- eval (concat (fp_bitcast_to_bv (fp_mul v_13 v_15) 32) (fp_bitcast_to_bv (fp_mul v_17 v_19) 32));
      let v_21 <- eval (concat (fp_bitcast_to_bv (fp_mul v_9 v_11) 32) v_20);
      let v_22 <- eval (concat (fp_bitcast_to_bv (fp_mul v_4 v_7) 32) v_21);
