def divw : instruction :=
  definst "divw" $ do
    pattern fun (mem_0 : Mem) => do
      ...
      setRegister rax (concat v_9 (/- (_,_) -/  div_quotient_int16 v_6 v_8));
      setRegister rdx (concat v_2 (/- (_,_) -/  div_remainder_int16 v_6 v_8));
    ...
    pattern fun (r16_0 : reg (bv 16)) => do
      ...
      setRegister rax (concat v_8 (/- (_,_) -/  div_quotient_int16 v_6 v_7));
      setRegister rdx (concat v_2 (/- (_,_) -/  div_remainder_int16 v_6 v_7));
      setRegister af undef;
      setRegister cf undef;
      setRegister of undef;
      setRegister pf undef;
