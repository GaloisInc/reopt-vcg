def pcmpgtd : instruction :=
  definst "pcmpgtd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_3 v_6) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) (concat (mux (sgt v_7 v_8) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) (concat (mux (sgt v_9 v_10) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) (mux (sgt v_11 v_12) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_3 v_5) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) (concat (mux (sgt v_6 v_7) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) (concat (mux (sgt v_8 v_9) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) (mux (sgt v_10 v_11) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)))));
      pure ()
    pat_end
