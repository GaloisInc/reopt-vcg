  ...
  definst "vpmovzxbd" $ do
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_16 <- eval (concat (expression.bv_nat 24 0) v_15);
      let v_17 <- eval (concat v_8 v_16);
      let v_18 <- eval (concat (expression.bv_nat 24 0) v_17);
      let v_19 <- eval (concat v_7 v_18);
      let v_20 <- eval (concat (expression.bv_nat 24 0) v_19);
      let v_21 <- eval (concat v_6 v_20);
      let v_22 <- eval (concat (expression.bv_nat 24 0) v_21);
      let v_23 <- eval (concat v_5 v_22);
      let v_24 <- eval (concat (expression.bv_nat 24 0) v_23);
      let v_25 <- eval (concat v_4 v_24);
      let v_26 <- eval (concat (expression.bv_nat 24 0) v_25);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (ymm_1 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_15 <- eval (concat (expression.bv_nat 24 0) v_14);
      let v_16 <- eval (concat v_7 v_15);
      let v_17 <- eval (concat (expression.bv_nat 24 0) v_16);
      let v_18 <- eval (concat v_6 v_17);
      let v_19 <- eval (concat (expression.bv_nat 24 0) v_18);
      let v_20 <- eval (concat v_5 v_19);
      let v_21 <- eval (concat (expression.bv_nat 24 0) v_20);
      let v_22 <- eval (concat v_4 v_21);
      let v_23 <- eval (concat (expression.bv_nat 24 0) v_22);
      let v_24 <- eval (concat v_3 v_23);
      let v_25 <- eval (concat (expression.bv_nat 24 0) v_24);
