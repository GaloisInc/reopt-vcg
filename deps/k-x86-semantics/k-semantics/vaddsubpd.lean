  ...
  definst "vaddsubpd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_14 <- eval (concat (fp_bitcast_to_bv (fp_add v_5 v_9) 64) (fp_bitcast_to_bv (fp_sub v_11 v_13) 64));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (bv_bitcast_to_fp float_class.fp64 v_12);
      let v_14 <- eval (concat (fp_bitcast_to_bv (fp_add v_5 v_9) 64) (fp_bitcast_to_bv (fp_sub v_11 v_13) 64));
      let (v_15 : expression (bv 64)) <- eval (extract v_3 128 192);
      let v_16 <- eval (bv_bitcast_to_fp float_class.fp64 v_15);
      let (v_17 : expression (bv 64)) <- eval (extract v_7 128 192);
      ...
      let v_23 <- eval (concat (fp_bitcast_to_bv (fp_add v_16 v_18) 64) (fp_bitcast_to_bv (fp_sub v_20 v_22) 64));
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (concat (fp_bitcast_to_bv (fp_add v_5 v_8) 64) (fp_bitcast_to_bv (fp_sub v_10 v_12) 64));
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_16 : expression (bv 64)) <- eval (extract v_6 128 192);
      ...
      let (v_20 : expression (bv 64)) <- eval (extract v_6 192 256);
      let v_21 <- eval (bv_bitcast_to_fp float_class.fp64 v_20);
      let v_22 <- eval (concat (fp_bitcast_to_bv (fp_add v_15 v_17) 64) (fp_bitcast_to_bv (fp_sub v_19 v_21) 64));
