  ...
  definst "vfnmsub231ps" $ do
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_14 v_16)) v_18) 32) v_31);
      let v_33 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_9)) v_12) 32) v_32);
      let (v_34 : expression (bv 32)) <- eval (extract v_3 128 160);
      let v_35 <- eval (bv_bitcast_to_fp float_class.fp32 v_34);
      let (v_36 : expression (bv 32)) <- eval (extract v_7 128 160);
      let v_37 <- eval (bv_bitcast_to_fp float_class.fp32 v_36);
      let (v_38 : expression (bv 32)) <- eval (extract v_10 128 160);
      let v_39 <- eval (bv_bitcast_to_fp float_class.fp32 v_38);
      let (v_40 : expression (bv 32)) <- eval (extract v_3 160 192);
      let v_41 <- eval (bv_bitcast_to_fp float_class.fp32 v_40);
      let (v_42 : expression (bv 32)) <- eval (extract v_7 160 192);
      let v_43 <- eval (bv_bitcast_to_fp float_class.fp32 v_42);
      let (v_44 : expression (bv 32)) <- eval (extract v_10 160 192);
      let v_45 <- eval (bv_bitcast_to_fp float_class.fp32 v_44);
      let (v_46 : expression (bv 32)) <- eval (extract v_3 192 224);
      let v_47 <- eval (bv_bitcast_to_fp float_class.fp32 v_46);
      let (v_48 : expression (bv 32)) <- eval (extract v_7 192 224);
      let v_49 <- eval (bv_bitcast_to_fp float_class.fp32 v_48);
      let (v_50 : expression (bv 32)) <- eval (extract v_10 192 224);
      let v_51 <- eval (bv_bitcast_to_fp float_class.fp32 v_50);
      let (v_52 : expression (bv 32)) <- eval (extract v_3 224 256);
      let v_53 <- eval (bv_bitcast_to_fp float_class.fp32 v_52);
      let (v_54 : expression (bv 32)) <- eval (extract v_7 224 256);
      let v_55 <- eval (bv_bitcast_to_fp float_class.fp32 v_54);
      let (v_56 : expression (bv 32)) <- eval (extract v_10 224 256);
      let v_57 <- eval (bv_bitcast_to_fp float_class.fp32 v_56);
      let v_58 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_47 v_49)) v_51) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_53 v_55)) v_57) 32));
      let v_59 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_41 v_43)) v_45) 32) v_58);
      let v_60 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_35 v_37)) v_39) 32) v_59);
      let v_61 <- eval (concat v_33 v_60);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_13 v_15)) v_17) 32) v_30);
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_8)) v_11) 32) v_31);
      let (v_33 : expression (bv 32)) <- eval (extract v_3 128 160);
      let v_34 <- eval (bv_bitcast_to_fp float_class.fp32 v_33);
      let (v_35 : expression (bv 32)) <- eval (extract v_6 128 160);
      let v_36 <- eval (bv_bitcast_to_fp float_class.fp32 v_35);
      let (v_37 : expression (bv 32)) <- eval (extract v_9 128 160);
      let v_38 <- eval (bv_bitcast_to_fp float_class.fp32 v_37);
      let (v_39 : expression (bv 32)) <- eval (extract v_3 160 192);
      let v_40 <- eval (bv_bitcast_to_fp float_class.fp32 v_39);
      let (v_41 : expression (bv 32)) <- eval (extract v_6 160 192);
      let v_42 <- eval (bv_bitcast_to_fp float_class.fp32 v_41);
      let (v_43 : expression (bv 32)) <- eval (extract v_9 160 192);
      let v_44 <- eval (bv_bitcast_to_fp float_class.fp32 v_43);
      let (v_45 : expression (bv 32)) <- eval (extract v_3 192 224);
      let v_46 <- eval (bv_bitcast_to_fp float_class.fp32 v_45);
      let (v_47 : expression (bv 32)) <- eval (extract v_6 192 224);
      let v_48 <- eval (bv_bitcast_to_fp float_class.fp32 v_47);
      let (v_49 : expression (bv 32)) <- eval (extract v_9 192 224);
      let v_50 <- eval (bv_bitcast_to_fp float_class.fp32 v_49);
      let (v_51 : expression (bv 32)) <- eval (extract v_3 224 256);
      let v_52 <- eval (bv_bitcast_to_fp float_class.fp32 v_51);
      let (v_53 : expression (bv 32)) <- eval (extract v_6 224 256);
      let v_54 <- eval (bv_bitcast_to_fp float_class.fp32 v_53);
      let (v_55 : expression (bv 32)) <- eval (extract v_9 224 256);
      let v_56 <- eval (bv_bitcast_to_fp float_class.fp32 v_55);
      let v_57 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_46 v_48)) v_50) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_52 v_54)) v_56) 32));
      let v_58 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_40 v_42)) v_44) 32) v_57);
      let v_59 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_34 v_36)) v_38) 32) v_58);
