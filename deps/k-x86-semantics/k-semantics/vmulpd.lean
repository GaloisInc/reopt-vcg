def vmulpd : instruction :=
  definst "vmulpd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_mul v_5 v_9) 64) (fp_bitcast_to_bv (fp_mul v_11 v_13) 64));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_mul v_5 v_9) 64) (concat (fp_bitcast_to_bv (fp_mul v_11 v_13) 64) (concat (fp_bitcast_to_bv (fp_mul v_15 v_17) 64) (fp_bitcast_to_bv (fp_mul v_19 v_21) 64))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_mul v_5 v_8) 64) (fp_bitcast_to_bv (fp_mul v_10 v_12) 64));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_mul v_5 v_8) 64) (concat (fp_bitcast_to_bv (fp_mul v_10 v_12) 64) (concat (fp_bitcast_to_bv (fp_mul v_14 v_16) 64) (fp_bitcast_to_bv (fp_mul v_18 v_20) 64))));
      pure ()
    pat_end
