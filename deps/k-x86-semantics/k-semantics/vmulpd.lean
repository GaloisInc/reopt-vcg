  ...
  definst "vmulpd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_14 <- eval (concat (fp_bitcast_to_bv (fp_mul v_5 v_9) 64) (fp_bitcast_to_bv (fp_mul v_11 v_13) 64));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_22 <- eval (concat (fp_bitcast_to_bv (fp_mul v_15 v_17) 64) (fp_bitcast_to_bv (fp_mul v_19 v_21) 64));
      let v_23 <- eval (concat (fp_bitcast_to_bv (fp_mul v_11 v_13) 64) v_22);
      let v_24 <- eval (concat (fp_bitcast_to_bv (fp_mul v_5 v_9) 64) v_23);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (concat (fp_bitcast_to_bv (fp_mul v_5 v_8) 64) (fp_bitcast_to_bv (fp_mul v_10 v_12) 64));
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_21 <- eval (concat (fp_bitcast_to_bv (fp_mul v_14 v_16) 64) (fp_bitcast_to_bv (fp_mul v_18 v_20) 64));
      let v_22 <- eval (concat (fp_bitcast_to_bv (fp_mul v_10 v_12) 64) v_21);
      let v_23 <- eval (concat (fp_bitcast_to_bv (fp_mul v_5 v_8) 64) v_22);
