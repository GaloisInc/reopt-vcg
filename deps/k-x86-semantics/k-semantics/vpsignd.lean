  ...
  definst "vpsignd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_14 <- eval (concat (mux (sgt v_10 (expression.bv_nat 32 0)) v_11 (mux (eq v_10 (expression.bv_nat 32 0)) (expression.bv_nat 32 0) (add (expression.bv_nat 32 1) (bv_xor v_11 (expression.bv_nat 32 4294967295))))) (mux (sgt v_12 (expression.bv_nat 32 0)) v_13 (mux (eq v_12 (expression.bv_nat 32 0)) (expression.bv_nat 32 0) (add (expression.bv_nat 32 1) (bv_xor v_13 (expression.bv_nat 32 4294967295))))));
      let v_15 <- eval (concat (mux (sgt v_8 (expression.bv_nat 32 0)) v_9 (mux (eq v_8 (expression.bv_nat 32 0)) (expression.bv_nat 32 0) (add (expression.bv_nat 32 1) (bv_xor v_9 (expression.bv_nat 32 4294967295))))) v_14);
      let v_16 <- eval (concat (mux (sgt v_5 (expression.bv_nat 32 0)) v_7 (mux (eq v_5 (expression.bv_nat 32 0)) (expression.bv_nat 32 0) (add (expression.bv_nat 32 1) (bv_xor v_7 (expression.bv_nat 32 4294967295))))) v_15);
