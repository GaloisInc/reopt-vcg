  ...
  definst "vpaddd" $ do
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_22 <- eval (concat (add v_18 v_19) (add v_20 v_21));
      let v_23 <- eval (concat (add v_16 v_17) v_22);
      let v_24 <- eval (concat (add v_14 v_15) v_23);
      let v_25 <- eval (concat (add v_12 v_13) v_24);
      let v_26 <- eval (concat (add v_10 v_11) v_25);
      let v_27 <- eval (concat (add v_8 v_9) v_26);
      let v_28 <- eval (concat (add v_4 v_7) v_27);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_27 <- eval (concat (add v_4 v_6) v_26);
