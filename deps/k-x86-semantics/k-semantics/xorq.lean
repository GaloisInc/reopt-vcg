  ...
  definst "xorq" $ do
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_5 <- eval (bv_xor v_3 (sext v_4 64));
      store v_2 v_5 8;
      ...
      setRegister pf (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (eq (bv_xor v_7 v_8) (expression.bv_nat 1 1)) (eq (bv_xor v_9 v_10) (expression.bv_nat 1 1)))) (eq (bv_xor v_11 v_12) (expression.bv_nat 1 1)))) (eq (bv_xor v_13 v_14) (expression.bv_nat 1 1)))) (eq (bv_xor v_15 v_16) (expression.bv_nat 1 1)))) (eq (bv_xor v_17 v_18) (expression.bv_nat 1 1)))) (eq (bv_xor v_19 v_20) (expression.bv_nat 1 1)))) (eq (bv_xor v_21 v_22) (expression.bv_nat 1 1)));
    ...
    instr_pat $ fun (imm_0 : imm int) (r64_1 : reg (bv 64)) =>
     let action : semantics Unit := do
      ...
      let v_4 <- eval (bv_xor v_2 (sext v_3 64));
      ...
      setRegister cf bit_zero;
      setRegister of bit_zero;
      setRegister pf (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (eq (bv_xor v_5 v_6) (expression.bv_nat 1 1)) (eq (bv_xor v_7 v_8) (expression.bv_nat 1 1)))) (eq (bv_xor v_9 v_10) (expression.bv_nat 1 1)))) (eq (bv_xor v_11 v_12) (expression.bv_nat 1 1)))) (eq (bv_xor v_13 v_14) (expression.bv_nat 1 1)))) (eq (bv_xor v_15 v_16) (expression.bv_nat 1 1)))) (eq (bv_xor v_17 v_18) (expression.bv_nat 1 1)))) (eq (bv_xor v_19 v_20) (expression.bv_nat 1 1)));
