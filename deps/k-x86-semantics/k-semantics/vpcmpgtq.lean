  ...
  definst "vpcmpgtq" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_10 <- eval (concat (mux (sgt v_4 v_7) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) (mux (sgt v_8 v_9) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_14 <- eval (concat (mux (sgt v_10 v_11) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) (mux (sgt v_12 v_13) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)));
      let v_15 <- eval (concat (mux (sgt v_8 v_9) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) v_14);
      let v_16 <- eval (concat (mux (sgt v_4 v_7) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) v_15);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_9 <- eval (concat (mux (sgt v_4 v_6) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) (mux (sgt v_7 v_8) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)));
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (concat (mux (sgt v_9 v_10) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) (mux (sgt v_11 v_12) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)));
      let v_14 <- eval (concat (mux (sgt v_7 v_8) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) v_13);
      let v_15 <- eval (concat (mux (sgt v_4 v_6) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) v_14);
