  ...
  definst "pcmpeqq" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_9 <- eval (concat (mux (eq v_3 v_6) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) (mux (eq v_7 v_8) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)));
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_8 <- eval (concat (mux (eq v_3 v_5) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)) (mux (eq v_6 v_7) (expression.bv_nat 64 18446744073709551615) (expression.bv_nat 64 0)));
