def vfmadd213pd : instruction :=
  definst "vfmadd213pd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      (v_16 : expression (bv 64)) <- eval (extract v_6 64 128);
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_13) 64) (fp_bitcast_to_bv (fp_sub (fp_mul v_15 v_17) v_20) 64));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      (v_14 : expression (bv 64)) <- eval (extract v_6 128 192);
      (v_15 : expression (bv 64)) <- eval (extract v_8 128 192);
      (v_16 : expression (bv 64)) <- eval (extract v_3 192 256);
      (v_17 : expression (bv 64)) <- eval (extract v_6 192 256);
      (v_18 : expression (bv 64)) <- eval (extract v_8 192 256);
      setRegister (lhs.of_reg ymm_2) (concat (/- (_,_,_) -/ vfmadd132_double v_4 v_7 v_9) (concat (/- (_,_,_) -/ vfmadd132_double v_10 v_11 v_12) (concat (/- (_,_,_) -/ vfmadd132_double v_13 v_14 v_15) (/- (_,_,_) -/ vfmadd132_double v_16 v_17 v_18))));
      pure ()
    pat_end;
