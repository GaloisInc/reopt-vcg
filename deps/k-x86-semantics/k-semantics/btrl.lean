def btrl : instruction :=
  definst "btrl" $ do
    pattern fun (imm_0 : imm int) (mem_1 : Mem) => do
      ...
      store v_5 (bv_and v_6 (bv_xor v_9 (expression.bv_nat 8 255))) 1;
    ...
    pattern fun (imm_0 : imm int) (r32_1 : reg (bv 32)) => do
      ...
      setRegister (lhs.of_reg r32_1) (bv_and v_2 (bv_xor v_4 (expression.bv_nat 32 4294967295)));
      setRegister af undef;
    ...
    pattern fun (r32_0 : reg (bv 32)) (r32_1 : reg (bv 32)) => do
      ...
      setRegister (lhs.of_reg r32_1) (bv_and v_2 (bv_xor v_5 (expression.bv_nat 32 4294967295)));
      setRegister af undef;
