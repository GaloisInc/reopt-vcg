  ...
  definst "vfnmsub132ps" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_20 v_22)) v_24) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_26 v_28)) v_30) 32));
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_14 v_16)) v_18) 32) v_31);
      let v_33 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_9)) v_12) 32) v_32);
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_55 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_44 v_46)) v_48) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_50 v_52)) v_54) 32));
      let v_56 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_38 v_40)) v_42) 32) v_55);
      let v_57 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_32 v_34)) v_36) 32) v_56);
      let v_58 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_26 v_28)) v_30) 32) v_57);
      let v_59 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_20 v_22)) v_24) 32) v_58);
      let v_60 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_14 v_16)) v_18) 32) v_59);
      let v_61 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_9)) v_12) 32) v_60);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_30 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_19 v_21)) v_23) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_25 v_27)) v_29) 32));
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_13 v_15)) v_17) 32) v_30);
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_8)) v_11) 32) v_31);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_54 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_43 v_45)) v_47) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_49 v_51)) v_53) 32));
      let v_55 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_37 v_39)) v_41) 32) v_54);
      let v_56 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_31 v_33)) v_35) 32) v_55);
      let v_57 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_25 v_27)) v_29) 32) v_56);
      let v_58 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_19 v_21)) v_23) 32) v_57);
      let v_59 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_13 v_15)) v_17) 32) v_58);
      let v_60 <- eval (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_8)) v_11) 32) v_59);
