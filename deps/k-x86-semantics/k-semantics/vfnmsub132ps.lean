def vfnmsub132ps : instruction :=
  definst "vfnmsub132ps" $ do
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_9)) v_12) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_14 v_16)) v_18) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_20 v_22)) v_24) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_26 v_28)) v_30) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_32 v_34)) v_36) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_38 v_40)) v_42) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_44 v_46)) v_48) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_50 v_52)) v_54) 32))))))));
      pure ()
    pat_end;
