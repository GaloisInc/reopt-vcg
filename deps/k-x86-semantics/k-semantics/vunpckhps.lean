  ...
  definst "vunpckhps" $ do
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_11 : expression (bv 32)) <- eval (extract v_6 32 64);
      let v_12 <- eval (concat v_10 v_11);
      let (v_13 : expression (bv 32)) <- eval (extract v_4 128 160);
      let (v_14 : expression (bv 32)) <- eval (extract v_6 128 160);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_13 : expression (bv 32)) <- eval (extract v_5 128 160);
