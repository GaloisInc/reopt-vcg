  ...
  definst "pcmpeqd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_15 <- eval (concat (mux (eq v_3 v_6) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) v_14);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_12 <- eval (concat (mux (eq v_8 v_9) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) (mux (eq v_10 v_11) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)));
      let v_13 <- eval (concat (mux (eq v_6 v_7) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) v_12);
      let v_14 <- eval (concat (mux (eq v_3 v_5) (expression.bv_nat 32 4294967295) (expression.bv_nat 32 0)) v_13);
