def paddd : instruction :=
  definst "paddd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (add v_3 v_6) (concat (add v_7 v_8) (concat (add v_9 v_10) (add v_11 v_12))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (add v_3 v_5) (concat (add v_6 v_7) (concat (add v_8 v_9) (add v_10 v_11))));
      pure ()
    pat_end
