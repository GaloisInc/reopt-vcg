  ...
  definst "vpsravd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_14 <- eval (concat (ashr v_10 v_11) (ashr v_12 v_13));
      let v_15 <- eval (concat (ashr v_8 v_9) v_14);
      let v_16 <- eval (concat (ashr v_4 v_7) v_15);
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_22 <- eval (concat (ashr v_18 v_19) (ashr v_20 v_21));
      let v_23 <- eval (concat (ashr v_16 v_17) v_22);
      let v_24 <- eval (concat (ashr v_14 v_15) v_23);
      let v_25 <- eval (concat (ashr v_12 v_13) v_24);
      let v_26 <- eval (concat (ashr v_10 v_11) v_25);
      let v_27 <- eval (concat (ashr v_8 v_9) v_26);
      let v_28 <- eval (concat (ashr v_4 v_7) v_27);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (concat (ashr v_9 v_10) (ashr v_11 v_12));
      let v_14 <- eval (concat (ashr v_7 v_8) v_13);
      let v_15 <- eval (concat (ashr v_4 v_6) v_14);
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_21 <- eval (concat (ashr v_17 v_18) (ashr v_19 v_20));
      let v_22 <- eval (concat (ashr v_15 v_16) v_21);
      let v_23 <- eval (concat (ashr v_13 v_14) v_22);
      let v_24 <- eval (concat (ashr v_11 v_12) v_23);
      let v_25 <- eval (concat (ashr v_9 v_10) v_24);
      let v_26 <- eval (concat (ashr v_7 v_8) v_25);
      let v_27 <- eval (concat (ashr v_4 v_6) v_26);
