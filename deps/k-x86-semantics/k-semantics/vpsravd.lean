def vpsravd : instruction :=
  definst "vpsravd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (ashr v_4 v_7) (concat (ashr v_8 v_9) (concat (ashr v_10 v_11) (ashr v_12 v_13))));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (ashr v_4 v_7) (concat (ashr v_8 v_9) (concat (ashr v_10 v_11) (concat (ashr v_12 v_13) (concat (ashr v_14 v_15) (concat (ashr v_16 v_17) (concat (ashr v_18 v_19) (ashr v_20 v_21))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (ashr v_4 v_6) (concat (ashr v_7 v_8) (concat (ashr v_9 v_10) (ashr v_11 v_12))));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (ashr v_4 v_6) (concat (ashr v_7 v_8) (concat (ashr v_9 v_10) (concat (ashr v_11 v_12) (concat (ashr v_13 v_14) (concat (ashr v_15 v_16) (concat (ashr v_17 v_18) (ashr v_19 v_20))))))));
      pure ()
    pat_end
