  ...
  definst "sarb" $ do
    instr_pat $ fun (_ : clReg) (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux v_11 v_16 (isBitSet v_8 8));
      setRegister of (bit_and (notBool_ (eq v_6 (expression.bv_nat 8 1))) (mux v_11 v_15 undef));
    ...
    instr_pat $ fun (_ : clReg) (rh_0 : reg (bv 8)) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux v_4 v_14 (isBitSet v_9 8));
      setRegister of (bit_and (notBool_ (eq v_3 (expression.bv_nat 8 1))) (mux v_4 v_13 undef));
    ...
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux v_10 v_15 (isBitSet v_7 8));
      setRegister of (bit_and (notBool_ (eq v_5 (expression.bv_nat 8 1))) (mux v_10 v_14 undef));
    ...
    instr_pat $ fun (imm_0 : imm int) (rh_1 : reg (bv 8)) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux v_3 v_13 (isBitSet v_8 8));
      setRegister of (bit_and (notBool_ (eq v_2 (expression.bv_nat 8 1))) (mux v_3 v_12 undef));
    ...
    instr_pat $ fun (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_2 <- load v_1 1;
      let v_3 <- eval (concat v_2 (expression.bv_nat 1 0));
      let v_4 <- eval (ashr v_3 (expression.bv_nat 9 1));
    ...
    instr_pat $ fun (rh_0 : reg (bv 8)) =>
     let action : semantics Unit := do
      ...
      let v_3 <- eval (ashr v_2 (expression.bv_nat 9 1));
