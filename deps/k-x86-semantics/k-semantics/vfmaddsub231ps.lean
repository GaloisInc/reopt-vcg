  ...
  definst "vfmaddsub231ps" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_19 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_5 v_9) v_12) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_14 v_16) v_18) 32));
      let (v_20 : expression (bv 32)) <- eval (extract v_3 64 96);
      let v_21 <- eval (bv_bitcast_to_fp float_class.fp32 v_20);
      let (v_22 : expression (bv 32)) <- eval (extract v_7 64 96);
      ...
      let (v_28 : expression (bv 32)) <- eval (extract v_7 96 128);
      ...
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_21 v_23) v_25) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_27 v_29) v_31) 32));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_35 : expression (bv 32)) <- eval (extract v_7 128 160);
      let v_36 <- eval (bv_bitcast_to_fp float_class.fp32 v_35);
      let (v_37 : expression (bv 32)) <- eval (extract v_10 128 160);
      ...
      let (v_41 : expression (bv 32)) <- eval (extract v_7 160 192);
      let v_42 <- eval (bv_bitcast_to_fp float_class.fp32 v_41);
      let (v_43 : expression (bv 32)) <- eval (extract v_10 160 192);
      let v_44 <- eval (bv_bitcast_to_fp float_class.fp32 v_43);
      let v_45 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_34 v_36) v_38) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_40 v_42) v_44) 32));
      ...
      let v_58 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_47 v_49) v_51) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_53 v_55) v_57) 32));
      let v_59 <- eval (concat v_45 v_58);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_18 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_5 v_8) v_11) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_13 v_15) v_17) 32));
      ...
      let v_31 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_20 v_22) v_24) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_26 v_28) v_30) 32));
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let (v_36 : expression (bv 32)) <- eval (extract v_9 128 160);
      ...
      let (v_42 : expression (bv 32)) <- eval (extract v_9 160 192);
      let v_43 <- eval (bv_bitcast_to_fp float_class.fp32 v_42);
      let v_44 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_33 v_35) v_37) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_39 v_41) v_43) 32));
      ...
      let v_57 <- eval (concat (fp_bitcast_to_bv (fp_add (fp_mul v_46 v_48) v_50) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_52 v_54) v_56) 32));
      let v_58 <- eval (concat v_44 v_57);
