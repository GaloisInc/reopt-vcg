  ...
  definst "mulpd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (concat (fp_bitcast_to_bv (fp_mul v_4 v_8) 64) (fp_bitcast_to_bv (fp_mul v_10 v_12) 64));
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_12 <- eval (concat (fp_bitcast_to_bv (fp_mul v_4 v_7) 64) (fp_bitcast_to_bv (fp_mul v_9 v_11) 64));
