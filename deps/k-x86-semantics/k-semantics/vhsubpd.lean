  ...
  definst "vhsubpd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_14 <- eval (concat (fp_bitcast_to_bv (fp_sub v_6 v_8) 64) (fp_bitcast_to_bv (fp_sub v_11 v_13) 64));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_23 <- eval (concat (fp_bitcast_to_bv (fp_sub v_16 v_18) 64) (fp_bitcast_to_bv (fp_sub v_20 v_22) 64));
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (concat (fp_bitcast_to_bv (fp_sub v_5 v_7) 64) (fp_bitcast_to_bv (fp_sub v_10 v_12) 64));
