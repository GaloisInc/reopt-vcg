  ...
  definst "vfnmadd231ss" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (bv_bitcast_to_fp float_class.fp32 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul (MInt2Float (expression.bv_nat 32 0) 24 8) v_12)) v_12) 32));
      let v_14 <- eval (concat v_4 (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_7 v_10)) v_13) 32));
