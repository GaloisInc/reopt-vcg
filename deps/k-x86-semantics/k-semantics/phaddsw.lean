  ...
  definst "phaddsw" $ do
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_5 <- eval (add (sext v_3 32) (sext v_4 32));
      ...
      let v_9 <- eval (add (sext v_7 32) (sext v_8 32));
      ...
      let v_13 <- eval (add (sext v_11 32) (sext v_12 32));
      ...
      let v_17 <- eval (add (sext v_15 32) (sext v_16 32));
      ...
      let (v_21 : expression (bv 16)) <- eval (extract v_19 16 32);
      ...
      let (v_25 : expression (bv 16)) <- eval (extract v_19 48 64);
      ...
      let (v_29 : expression (bv 16)) <- eval (extract v_19 80 96);
