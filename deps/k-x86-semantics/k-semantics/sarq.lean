  ...
  definst "sarq" $ do
    instr_pat $ fun (_ : clReg) (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux v_11 v_17 (isBitSet v_8 64));
    ...
    instr_pat $ fun (_ : clReg) (r64_0 : reg (bv 64)) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux v_4 v_15 (isBitSet v_9 64));
    ...
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux v_10 v_16 (isBitSet v_7 64));
    ...
    instr_pat $ fun (imm_0 : imm int) (r64_1 : reg (bv 64)) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux v_3 v_14 (isBitSet v_8 64));
    ...
    instr_pat $ fun (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_2 <- load v_1 8;
      let v_3 <- eval (concat v_2 (expression.bv_nat 1 0));
      let v_4 <- eval (ashr v_3 (expression.bv_nat 65 1));
    ...
    instr_pat $ fun (r64_0 : reg (bv 64)) =>
     let action : semantics Unit := do
      ...
      let v_3 <- eval (ashr v_2 (expression.bv_nat 65 1));
