  ...
  definst "minpd" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_9 <- eval (concat (mux (eq (/- (_,_) -/  mincmp_double v_3 v_6) (expression.bv_nat 1 1)) v_3 v_6) (mux (eq (/- (_,_) -/  mincmp_double v_7 v_8) (expression.bv_nat 1 1)) v_7 v_8));
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_8 <- eval (concat (mux (eq (/- (_,_) -/  mincmp_double v_3 v_5) (expression.bv_nat 1 1)) v_3 v_5) (mux (eq (/- (_,_) -/  mincmp_double v_6 v_7) (expression.bv_nat 1 1)) v_6 v_7));
