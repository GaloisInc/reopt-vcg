  ...
  definst "vhsubps" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_13 <- eval (concat (fp_bitcast_to_bv (fp_sub v_6 v_8) 32) (fp_bitcast_to_bv (fp_sub v_10 v_12) 32));
      ...
      let v_19 <- eval (concat v_13 (fp_bitcast_to_bv (fp_sub v_16 v_18) 32));
      ...
      let v_24 <- eval (concat v_19 (fp_bitcast_to_bv (fp_sub v_21 v_23) 32));
    ...
    instr_pat $ fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_33 <- eval (concat (fp_bitcast_to_bv (fp_sub v_26 v_28) 32) (fp_bitcast_to_bv (fp_sub v_30 v_32) 32));
      ...
      let v_38 <- eval (concat v_33 (fp_bitcast_to_bv (fp_sub v_35 v_37) 32));
      ...
      let v_43 <- eval (concat v_38 (fp_bitcast_to_bv (fp_sub v_40 v_42) 32));
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_12 <- eval (concat (fp_bitcast_to_bv (fp_sub v_5 v_7) 32) (fp_bitcast_to_bv (fp_sub v_9 v_11) 32));
      ...
      let v_18 <- eval (concat v_12 (fp_bitcast_to_bv (fp_sub v_15 v_17) 32));
      ...
      let v_23 <- eval (concat v_18 (fp_bitcast_to_bv (fp_sub v_20 v_22) 32));
    ...
    instr_pat $ fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) =>
     let action : semantics Unit := do
      ...
      let v_32 <- eval (concat (fp_bitcast_to_bv (fp_sub v_25 v_27) 32) (fp_bitcast_to_bv (fp_sub v_29 v_31) 32));
      ...
      let v_37 <- eval (concat v_32 (fp_bitcast_to_bv (fp_sub v_34 v_36) 32));
      ...
      let v_42 <- eval (concat v_37 (fp_bitcast_to_bv (fp_sub v_39 v_41) 32));
