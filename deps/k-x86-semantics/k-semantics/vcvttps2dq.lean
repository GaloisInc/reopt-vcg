def vcvttps2dq : instruction :=
  definst "vcvttps2dq" $ do
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_1) (concat (/- (_) -/ cvt_single_to_int32_truncate v_4) (concat (/- (_) -/ cvt_single_to_int32_truncate v_5) (concat (/- (_) -/ cvt_single_to_int32_truncate v_6) (concat (/- (_) -/ cvt_single_to_int32_truncate v_7) (concat (/- (_) -/ cvt_single_to_int32_truncate v_8) (concat (/- (_) -/ cvt_single_to_int32_truncate v_9) (concat (/- (_) -/ cvt_single_to_int32_truncate v_10) (/- (_) -/ cvt_single_to_int32_truncate v_11))))))));
      pure ()
    pat_end;
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_1) (concat (/- (_) -/ cvt_single_to_int32_truncate v_3) (concat (/- (_) -/ cvt_single_to_int32_truncate v_4) (concat (/- (_) -/ cvt_single_to_int32_truncate v_5) (concat (/- (_) -/ cvt_single_to_int32_truncate v_6) (concat (/- (_) -/ cvt_single_to_int32_truncate v_7) (concat (/- (_) -/ cvt_single_to_int32_truncate v_8) (concat (/- (_) -/ cvt_single_to_int32_truncate v_9) (/- (_) -/ cvt_single_to_int32_truncate v_10))))))));
      pure ()
    pat_end
