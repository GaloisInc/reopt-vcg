  ...
  definst "movsb" $ do
    instr_pat $
     let action : semantics Unit := do
      ...
      let v_4 <- load v_3 1;
      store v_2 v_4 1;
      setRegister rdi (add v_2 (expression.bv_nat 64 1));
      setRegister rsi (add v_3 (expression.bv_nat 64 1));
      pure ()
     action;
    instr_pat $
     let action : semantics Unit := do
      ...
      let v_4 <- load v_3 1;
      store v_2 v_4 1;
      setRegister rdi (sub v_2 (expression.bv_nat 64 1));
      setRegister rsi (sub v_3 (expression.bv_nat 64 1));
      pure ()
     action;
    instr_pat $ fun (mem_0 : Mem) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_6 <- load v_5 1;
      store v_4 v_6 1;
      setRegister rdi (add v_4 (expression.bv_nat 64 1));
      setRegister rsi (add v_5 (expression.bv_nat 64 1));
      pure ()
     action;
    instr_pat $ fun (mem_0 : Mem) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_6 <- load v_5 1;
      store v_4 v_6 1;
      setRegister rdi (sub v_4 (expression.bv_nat 64 1));
      setRegister rsi (sub v_5 (expression.bv_nat 64 1));
      pure ()
     action
