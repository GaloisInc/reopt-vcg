  ...
  definst "vblendpd" $ do
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) (xmm_2 : reg (bv 128)) (xmm_3 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_12 <- eval (concat (mux (isBitClear v_4 6) v_6 v_9) (mux (isBitClear v_4 7) v_10 v_11));
    ...
    instr_pat $ fun (imm_0 : imm int) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) (xmm_3 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_11 <- eval (concat (mux (isBitClear v_4 6) v_6 v_8) (mux (isBitClear v_4 7) v_9 v_10));
