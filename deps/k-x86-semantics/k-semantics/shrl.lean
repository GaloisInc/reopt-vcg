  ...
  definst "shrl" $ do
    instr_pat $ fun (_ : clReg) (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux (uge v_6 (expression.bv_nat 8 32)) undef (mux v_11 v_17 (isBitSet v_8 32)));
    ...
    instr_pat $ fun (_ : clReg) (r32_0 : reg (bv 32)) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux (uge v_3 (expression.bv_nat 8 32)) undef (mux v_4 v_15 (isBitSet v_9 32)));
    ...
    instr_pat $ fun (imm_0 : imm int) (mem_1 : Mem) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux (uge v_5 (expression.bv_nat 8 32)) undef (mux v_10 v_16 (isBitSet v_7 32)));
    ...
    instr_pat $ fun (imm_0 : imm int) (r32_1 : reg (bv 32)) =>
     let action : semantics Unit := do
      ...
      setRegister cf (mux (uge v_2 (expression.bv_nat 8 32)) undef (mux v_3 v_14 (isBitSet v_8 32)));
    ...
    instr_pat $ fun (mem_0 : Mem) =>
     let action : semantics Unit := do
      ...
      let v_2 <- load v_1 4;
      let v_3 <- eval (concat v_2 (expression.bv_nat 1 0));
      let v_4 <- eval (lshr v_3 (expression.bv_nat 33 1));
    ...
    instr_pat $ fun (r32_0 : reg (bv 32)) =>
     let action : semantics Unit := do
      ...
      let v_3 <- eval (lshr v_2 (expression.bv_nat 33 1));
