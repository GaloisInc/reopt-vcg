  ...
  definst "paddsw" $ do
    instr_pat $ fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_7 <- eval (add (sext v_3 32) (sext v_6 32));
      ...
      let v_40 <- eval (concat (mux (sgt v_19 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_19 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_20)) v_39);
      let v_41 <- eval (concat (mux (sgt v_15 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_15 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_16)) v_40);
      let v_42 <- eval (concat (mux (sgt v_11 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_11 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_12)) v_41);
      let v_43 <- eval (concat (mux (sgt v_7 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_7 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_8)) v_42);
    ...
    instr_pat $ fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) =>
     let action : semantics Unit := do
      ...
      let v_6 <- eval (add (sext v_3 32) (sext v_5 32));
      ...
      let v_22 <- eval (add (sext v_20 32) (sext v_21 32));
      ...
      let v_26 <- eval (add (sext v_24 32) (sext v_25 32));
      ...
      let v_30 <- eval (add (sext v_28 32) (sext v_29 32));
      ...
      let v_34 <- eval (add (sext v_32 32) (sext v_33 32));
      ...
      let v_39 <- eval (concat (mux (sgt v_18 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_18 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_19)) v_38);
      let v_40 <- eval (concat (mux (sgt v_14 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_14 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_15)) v_39);
      let v_41 <- eval (concat (mux (sgt v_10 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_10 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_11)) v_40);
      let v_42 <- eval (concat (mux (sgt v_6 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_6 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_7)) v_41);
