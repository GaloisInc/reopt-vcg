; main.block_0_201340.1 @ 0x201354: precondition ((= rsp (bvsub stack_high (_ bv24 64))), for jump)
(set-logic ALL)
...
(assert (= fnstart_rbx fnstart_rbx))
(check-sat-assuming ((not (= (bvadd (ite true rsp1 (ite true rsp0 (ite true rsp fnstart_rsp))) #x0000000000000008) (bvsub fnstart_rsp #x0000000000000018)))))
(exit)
