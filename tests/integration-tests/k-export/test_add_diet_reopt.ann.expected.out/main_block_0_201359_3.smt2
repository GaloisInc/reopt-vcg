; main.block_0_201359.0 @ 0x201366: stack height preserved (after return)
(set-logic ALL)
...
(check-sat-assuming ((not (= (ite true rsp1 (ite true rsp0 (ite true rsp a0x201359_rsp))) (bvadd fnstart_rsp #x0000000000000008)))))
(exit)
