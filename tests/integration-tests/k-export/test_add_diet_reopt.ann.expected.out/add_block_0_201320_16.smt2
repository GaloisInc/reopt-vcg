; add.block_0_201320.1 @ 0x20133b: LLVM and machine code return values match (%t0)
(set-logic ALL)
...
(define-fun addr0 () (_ BitVec 64) (bvadd (ite true rbp fnstart_rbp) (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x0000000000000007))))
...
(define-fun addr1 () (_ BitVec 64) (bvadd (ite true rbp fnstart_rbp) (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x0000000000000007))))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr1 #x0000000000000008))
(assert (= readv (mem_readbv64 mem0 addr1)))
(define-fun addr2 () (_ BitVec 64) (bvadd (ite true rbp fnstart_rbp) (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x000000000000000f))))
...
(define-fun addr3 () (_ BitVec 64) (bvadd (ite true rbp fnstart_rbp) (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x000000000000000f))))
(declare-fun readv0 () (_ BitVec 64))
(assert (on_stack addr3 #x0000000000000008))
(assert (= readv0 (mem_readbv64 mem1 addr3)))
(define-fun rax () (_ BitVec 64) ((_ extract 63 0) (bvadd (concat #b0 ((_ sign_extend 32) #x00000001)) (concat #b0 (ite true readv0 (ite true readv fnstart_rax))))))
...
(assert (= (ite true readv1 (ite true rbp fnstart_rbp)) fnstart_rbp))
(assert (= fnstart_rbx fnstart_rbx))
(assert (= fnstart_r12 fnstart_r12))
(assert (= fnstart_r13 fnstart_r13))
(assert (= fnstart_r14 fnstart_r14))
(assert (= fnstart_r15 fnstart_r15))
(check-sat-assuming ((not (= %t0 (ite true rax (ite true readv0 (ite true readv fnstart_rax)))))))
(exit)
