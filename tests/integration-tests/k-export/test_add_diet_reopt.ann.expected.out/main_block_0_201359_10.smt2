...
(define-fun addr () (_ BitVec 64) (bvadd a0x201359_rbp #xfffffffffffffff0))
...
(define-fun rsp () (_ BitVec 64) ((_ extract 63 0) (bvadd #b00000000000000000000000000000000000000000000000000000000000010000 (concat #b0 a0x201359_rsp))))
