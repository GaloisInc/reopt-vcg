...
(define-fun rsp0 () (_ BitVec 64) ((_ extract 63 0) (bvadd #b01111111111111111111111111111111111111111111111111111111111110000 (concat #b0 rsp))))
(define-fun addr () (_ BitVec 64) (bvadd rsp #xfffffffffffffffc))
(assert (is_in_mc_only_stack_range addr #x0000000000000004))
(define-fun mem0 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 mem addr #x00000000))
...
(assert (= (mem_readbv64 init_mem fnstart_rsp) (mem_readbv64 mem2 fnstart_rsp)))
(assert true)
(assert (= a0x201359_df false))
(assert (= fnstart_rbx fnstart_rbx))
(check-sat-assuming ((not (= (bvadd rsp1 #x0000000000000008) (bvsub fnstart_rsp #x0000000000000018)))))
(exit)
