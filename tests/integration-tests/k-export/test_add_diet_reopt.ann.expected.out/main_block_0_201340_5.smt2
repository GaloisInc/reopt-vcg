; main.block_0_201340.0 @ 0x201354: return address is next instruction
(set-logic ALL)
...
(check-sat-assuming ((not (= (mem_readbv64 mem1 (ite true rsp1 (ite true rsp0 (ite true rsp fnstart_rsp)))) #x0000000000201359))))
(exit)
