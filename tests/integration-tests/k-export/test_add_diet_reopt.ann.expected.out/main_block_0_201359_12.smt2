; main.block_0_201359.0 @ 0x201366: LLVM and machine code return values match (0)
(set-logic ALL)
...
; LLVM:     ret i64 0
(define-fun rcx () (_ BitVec 64) ((_ zero_extend 32) (bvxor ((_ extract 31 0) a0x201359_rcx) ((_ extract 31 0) a0x201359_rcx))))
(define-fun addr () (_ BitVec 64) (bvadd a0x201359_rbp (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x000000000000000f))))
...
(define-fun rax () (_ BitVec 64) ((_ zero_extend 32) ((_ extract 31 0) (ite true rcx a0x201359_rcx))))
(define-fun rsp () (_ BitVec 64) ((_ extract 63 0) (bvadd (concat #b0 ((_ sign_extend 32) #x00000010)) (concat #b0 a0x201359_rsp))))
(define-fun addr0 () (_ BitVec 64) (ite true rsp a0x201359_rsp))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr0 #x0000000000000008))
(assert (= readv (mem_readbv64 mem addr0)))
(define-fun rsp0 () (_ BitVec 64) (bvadd (ite true rsp a0x201359_rsp) #x0000000000000008))
(define-fun addr1 () (_ BitVec 64) (ite true rsp0 (ite true rsp a0x201359_rsp)))
(declare-fun readv0 () (_ BitVec 64))
(assert (on_stack addr1 #x0000000000000008))
(assert (= readv0 (mem_readbv64 mem addr1)))
(define-fun rsp1 () (_ BitVec 64) (bvadd (ite true rsp0 (ite true rsp a0x201359_rsp)) #x0000000000000008))
(assert (= (ite true rsp1 (ite true rsp0 (ite true rsp a0x201359_rsp))) (bvadd fnstart_rsp #x0000000000000008)))
(assert (= readv0 (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x201359_df))
(assert (= (ite true readv a0x201359_rbp) fnstart_rbp))
(assert (= a0x201359_rbx fnstart_rbx))
(assert (= a0x201359_r12 fnstart_r12))
(assert (= a0x201359_r13 fnstart_r13))
(assert (= a0x201359_r14 fnstart_r14))
(assert (= a0x201359_r15 fnstart_r15))
(check-sat-assuming ((not (= #x0000000000000000 (ite true rax a0x201359_rax)))))
(exit)
