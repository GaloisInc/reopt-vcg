; main.block_0_201340.1 @ 0x201354: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= (ite true rbp fnstart_rbp) (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
