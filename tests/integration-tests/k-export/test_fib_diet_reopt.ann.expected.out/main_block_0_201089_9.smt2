; main.block_0_201089.1 @ 0x201098: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x201089_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
