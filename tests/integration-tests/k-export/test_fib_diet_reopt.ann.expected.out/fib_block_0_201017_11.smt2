; fib.block_0_201017.0 @ 0x20101f: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
(declare-fun a0x201017_xmm0 () (_ BitVec 256))
(declare-fun a0x201017_xmm1 () (_ BitVec 256))
(declare-fun a0x201017_xmm2 () (_ BitVec 256))
(declare-fun a0x201017_xmm3 () (_ BitVec 256))
(declare-fun a0x201017_xmm4 () (_ BitVec 256))
(declare-fun a0x201017_xmm5 () (_ BitVec 256))
(declare-fun a0x201017_xmm6 () (_ BitVec 256))
(declare-fun a0x201017_xmm7 () (_ BitVec 256))
(declare-fun a0x201017_xmm8 () (_ BitVec 256))
(declare-fun a0x201017_xmm9 () (_ BitVec 256))
(declare-fun a0x201017_xmm10 () (_ BitVec 256))
(declare-fun a0x201017_xmm11 () (_ BitVec 256))
(declare-fun a0x201017_xmm12 () (_ BitVec 256))
(declare-fun a0x201017_xmm13 () (_ BitVec 256))
(declare-fun a0x201017_xmm14 () (_ BitVec 256))
(declare-fun a0x201017_xmm15 () (_ BitVec 256))
...
(define-fun addr () (_ BitVec 64) (bvadd a0x201017_rbp (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x000000000000000f))))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem addr)))
(define-fun addr0 () (_ BitVec 64) (bvadd a0x201017_rbp (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x0000000000000007))))
...
(assert (= #x0000000000201058 (bvadd (bvadd #x0000000000000000 (bvadd (bvmul #x0000000000000000 #x0000000000000000) #x0000000000000034)) #x0000000000201024)))
(assert (= %t4 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= a0x201017_rbx fnstart_rbx))
(assert (= a0x201017_rsp (bvsub fnstart_rsp #x0000000000000028)))
(assert (= a0x201017_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x201017_r12 fnstart_r12))
...
(assert (= a0x201017_r14 fnstart_r14))
(assert (= a0x201017_r15 fnstart_r15))
(check-sat-assuming ((not (= (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))))
(exit)
