; fib.block_0_201058.0 @ 0x201061: LLVM and machine code return values match
(set-logic ALL)
...
(declare-fun a0x201058_rax () (_ BitVec 64))
(declare-fun a0x201058_rcx () (_ BitVec 64))
(declare-fun a0x201058_rdx () (_ BitVec 64))
(declare-fun a0x201058_rbx () (_ BitVec 64))
(declare-fun a0x201058_rsp () (_ BitVec 64))
(declare-fun a0x201058_rbp () (_ BitVec 64))
(declare-fun a0x201058_rsi () (_ BitVec 64))
(declare-fun a0x201058_rdi () (_ BitVec 64))
(declare-fun a0x201058_r8 () (_ BitVec 64))
(declare-fun a0x201058_r9 () (_ BitVec 64))
(declare-fun a0x201058_r10 () (_ BitVec 64))
(declare-fun a0x201058_r11 () (_ BitVec 64))
(declare-fun a0x201058_r12 () (_ BitVec 64))
(declare-fun a0x201058_r13 () (_ BitVec 64))
(declare-fun a0x201058_r14 () (_ BitVec 64))
(declare-fun a0x201058_r15 () (_ BitVec 64))
(declare-fun a0x201058_cf () Bool)
(declare-fun a0x201058_RESERVED_1 () Bool)
(declare-fun a0x201058_pf () Bool)
(declare-fun a0x201058_RESERVED_3 () Bool)
(declare-fun a0x201058_af () Bool)
(declare-fun a0x201058_RESERVED_5 () Bool)
(declare-fun a0x201058_zf () Bool)
(declare-fun a0x201058_sf () Bool)
(declare-fun a0x201058_tf () Bool)
(declare-fun a0x201058_if () Bool)
(define-fun a0x201058_df () Bool false)
(declare-fun a0x201058_of () Bool)
(declare-fun a0x201058_iopl1 () Bool)
(declare-fun a0x201058_iopl2 () Bool)
(declare-fun a0x201058_nt () Bool)
(declare-fun a0x201058_RESERVED_15 () Bool)
(declare-fun a0x201058_rf () Bool)
(declare-fun a0x201058_vm () Bool)
(declare-fun a0x201058_ac () Bool)
(declare-fun a0x201058_vif () Bool)
(declare-fun a0x201058_vip () Bool)
(declare-fun a0x201058_id () Bool)
(declare-fun a0x201058_el () Bool)
(declare-fun a0x201058_el0 () Bool)
(declare-fun a0x201058_el1 () Bool)
(declare-fun a0x201058_el2 () Bool)
(declare-fun a0x201058_el3 () Bool)
(declare-fun a0x201058_el4 () Bool)
(declare-fun a0x201058_el5 () Bool)
(declare-fun a0x201058_el6 () Bool)
(declare-fun a0x201058_el7 () Bool)
(declare-fun a0x201058_el8 () Bool)
(declare-fun a0x201058_xmm0 () (_ BitVec 256))
(declare-fun a0x201058_xmm1 () (_ BitVec 256))
(declare-fun a0x201058_xmm2 () (_ BitVec 256))
(declare-fun a0x201058_xmm3 () (_ BitVec 256))
(declare-fun a0x201058_xmm4 () (_ BitVec 256))
(declare-fun a0x201058_xmm5 () (_ BitVec 256))
(declare-fun a0x201058_xmm6 () (_ BitVec 256))
(declare-fun a0x201058_xmm7 () (_ BitVec 256))
(declare-fun a0x201058_xmm8 () (_ BitVec 256))
(declare-fun a0x201058_xmm9 () (_ BitVec 256))
(declare-fun a0x201058_xmm10 () (_ BitVec 256))
(declare-fun a0x201058_xmm11 () (_ BitVec 256))
(declare-fun a0x201058_xmm12 () (_ BitVec 256))
(declare-fun a0x201058_xmm13 () (_ BitVec 256))
(declare-fun a0x201058_xmm14 () (_ BitVec 256))
(declare-fun a0x201058_xmm15 () (_ BitVec 256))
...
(assert (= a0x201058_r12 fnstart_r12))
...
; LLVM:     ret i64 %t15
(define-fun addr () (_ BitVec 64) (bvadd a0x201058_rbp (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x0000000000000007))))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem addr)))
(define-fun rsp () (_ BitVec 64) ((_ extract 63 0) (bvadd (concat #b0 ((_ sign_extend 32) #x00000020)) (concat #b0 a0x201058_rsp))))
...
(define-fun rsp0 () (_ BitVec 64) (bvadd (ite true rsp a0x201058_rsp) #x0000000000000008))
(define-fun addr1 () (_ BitVec 64) (ite true rsp0 (ite true rsp a0x201058_rsp)))
(declare-fun readv1 () (_ BitVec 64))
(assert (on_stack addr1 #x0000000000000008))
(assert (= readv1 (mem_readbv64 init_mem addr1)))
(define-fun rsp1 () (_ BitVec 64) (bvadd (ite true rsp0 (ite true rsp a0x201058_rsp)) #x0000000000000008))
(assert (= (ite true rsp1 (ite true rsp0 (ite true rsp a0x201058_rsp))) (bvadd fnstart_rsp #x0000000000000008)))
(assert (= readv1 (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x201058_df))
(assert (= (ite true readv0 a0x201058_rbp) fnstart_rbp))
(assert (= a0x201058_rbx fnstart_rbx))
(assert (= a0x201058_r12 fnstart_r12))
(assert (= a0x201058_r13 fnstart_r13))
(assert (= a0x201058_r14 fnstart_r14))
(assert (= a0x201058_r15 fnstart_r15))
(check-sat-assuming ((not (= %t15 (ite true readv a0x201058_rax)))))
(exit)
