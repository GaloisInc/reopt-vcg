; fib.block_0_20104d.1 @ 0x201054: precondition ((= (llvm t12) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t11 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
