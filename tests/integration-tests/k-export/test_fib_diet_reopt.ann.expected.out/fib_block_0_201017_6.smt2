; fib.block_0_201017.0 @ 0x20101f: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x201017_rbx fnstart_rbx))
(assert (= a0x201017_rsp (bvsub fnstart_rsp #x0000000000000028)))
(check-sat-assuming ((not (= a0x201017_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
