...
(declare-fun %t2 () (_ BitVec 64))
(assert (= %t2 a0x201024_rdi))
(assert (= %t2 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000018))))
...
; LLVM:     %t3 = add i64 %t2, 18446744073709551615
(define-fun %t3 () (_ BitVec 64) (bvadd %t2 #xffffffffffffffff))
; LLVM:     %t4 = call i64 @fib (i64 %t3)
...
(define-fun rax () (_ BitVec 64) ((_ extract 63 0) (bvadd #b01111111111111111111111111111111111111111111111111111111111111111 (concat #b0 readv))))
...
(define-fun %t4 () (_ BitVec 64) a0x201036_rax)
...
(assert (= %t4 a0x201036_rax))
(assert (= %t2 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= a0x201024_rbx fnstart_rbx))
