; main.block_0_201070.1 @ 0x201084: precondition ((= r12 (fnstart r12)), for jump)
(set-logic ALL)
...
(define-fun rdi () (_ BitVec 64) ((_ zero_extend 32) #x00000005))
...
(assert (= (mem_readbv64 mem1 (ite true rsp1 (ite true rsp0 (ite true rsp fnstart_rsp)))) #x0000000000201089))
...
(assert (= #x0000000000201089 #x0000000000201089))
(assert (= a0x201089_df false))
(assert (= %t0 a0x201089_rax))
(assert (= fnstart_rbx fnstart_rbx))
