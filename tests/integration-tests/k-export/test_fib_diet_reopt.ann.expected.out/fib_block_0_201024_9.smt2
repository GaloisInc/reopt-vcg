; fib.block_0_201024.2 @ 0x201031: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x201024_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
