; fib.block_0_201017.0 @ 0x20101f: precondition ((= rsp (bvsub stack_high (_ bv40 64))), for jump)
(set-logic ALL)
...
(assert (= a0x201017_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x201017_rsp (bvsub fnstart_rsp #x0000000000000028)))))
(exit)
