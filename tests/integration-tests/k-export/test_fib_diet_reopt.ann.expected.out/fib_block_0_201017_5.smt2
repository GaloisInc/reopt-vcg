; fib.block_0_201017.0 @ 0x20101f: precondition ((= (llvm t12) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t1 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
