; fib.block_0_201000.4 @ 0x201011: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t3 #b1) (= (ite true rbp fnstart_rbp) (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
