; fib.block_0_20104d.1 @ 0x201054: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
(declare-fun %t10 () (_ BitVec 64))
(declare-fun %t9 () (_ BitVec 64))
(assert (= %t9 a0x20104d_rax))
(assert (= %t10 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000020))))
...
; LLVM:     %t11 = add i64 %t10, %t9
(define-fun %t11 () (_ BitVec 64) (bvadd %t10 %t9))
...
(define-fun rcx () (_ BitVec 64) ((_ extract 63 0) (bvadd (concat #b0 a0x20104d_rax) (concat #b0 readv))))
...
(assert (= (mem_readbv64 init_mem fnstart_rsp) (mem_readbv64 mem fnstart_rsp)))
(assert true)
(assert (= a0x20104d_df false))
(assert (= %t11 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= a0x20104d_rbx fnstart_rbx))
(assert (= a0x20104d_rsp (bvsub fnstart_rsp #x0000000000000028)))
(assert (= a0x20104d_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x20104d_r12 fnstart_r12))
