; fib.block_0_201000.4 @ 0x201011: precondition ((= rdi (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t3 #b1)) (= fnstart_rdi (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000018)))))))
(exit)
