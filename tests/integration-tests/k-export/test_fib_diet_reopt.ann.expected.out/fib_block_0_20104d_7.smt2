; fib.block_0_20104d.1 @ 0x201054: precondition ((= rsp (bvsub stack_high (_ bv40 64))), for jump)
(set-logic ALL)
...
(assert (= a0x20104d_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x20104d_rsp (bvsub fnstart_rsp #x0000000000000028)))))
(exit)
