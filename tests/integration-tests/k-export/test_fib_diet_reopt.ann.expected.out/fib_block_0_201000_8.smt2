; fib.block_0_201000.4 @ 0x201011: precondition ((= rsp (bvsub stack_high (_ bv40 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t3 #b1) (= (ite true rsp0 (ite true rsp fnstart_rsp)) (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
