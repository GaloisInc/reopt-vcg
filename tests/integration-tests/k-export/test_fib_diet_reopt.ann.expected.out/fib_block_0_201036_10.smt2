; fib.block_0_201036.2 @ 0x201048: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x201036_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
