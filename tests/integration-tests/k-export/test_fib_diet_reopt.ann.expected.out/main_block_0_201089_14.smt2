; main.block_0_201089.1 @ 0x201098: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
(define-fun a0x201089_df () Bool false)
...
(declare-fun a0x201089_xmm0 () (_ BitVec 512))
(declare-fun a0x201089_xmm1 () (_ BitVec 512))
(declare-fun a0x201089_xmm2 () (_ BitVec 512))
(declare-fun a0x201089_xmm3 () (_ BitVec 512))
(declare-fun a0x201089_xmm4 () (_ BitVec 512))
(declare-fun a0x201089_xmm5 () (_ BitVec 512))
(declare-fun a0x201089_xmm6 () (_ BitVec 512))
(declare-fun a0x201089_xmm7 () (_ BitVec 512))
(declare-fun a0x201089_xmm8 () (_ BitVec 512))
(declare-fun a0x201089_xmm9 () (_ BitVec 512))
(declare-fun a0x201089_xmm10 () (_ BitVec 512))
(declare-fun a0x201089_xmm11 () (_ BitVec 512))
(declare-fun a0x201089_xmm12 () (_ BitVec 512))
...
(define-fun rax () (_ BitVec 64) (bvor (bvand a0x201089_rax (bvnot (bvshl ((_ zero_extend 56) ((_ repeat 8) #b1)) #x0000000000000000))) (bvshl ((_ zero_extend 56) #x00) #x0000000000000000)))
...
(assert (= #x00000000002001d2 (ite true #x00000000002001d2 a0x201089_rdi)))
(assert (= %t1 (ite true a0x201089_rax a0x201089_rsi)))
(assert (not a0x201089_df))
