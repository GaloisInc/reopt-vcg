; main.block_0_20109d.0 @ 0x2010a9: LLVM and machine code return values match (0)
(set-logic ALL)
...
(define-fun a0x20109d_df () Bool false)
...
(declare-fun a0x20109d_xmm0 () (_ BitVec 512))
(declare-fun a0x20109d_xmm1 () (_ BitVec 512))
(declare-fun a0x20109d_xmm2 () (_ BitVec 512))
(declare-fun a0x20109d_xmm3 () (_ BitVec 512))
(declare-fun a0x20109d_xmm4 () (_ BitVec 512))
(declare-fun a0x20109d_xmm5 () (_ BitVec 512))
(declare-fun a0x20109d_xmm6 () (_ BitVec 512))
(declare-fun a0x20109d_xmm7 () (_ BitVec 512))
(declare-fun a0x20109d_xmm8 () (_ BitVec 512))
(declare-fun a0x20109d_xmm9 () (_ BitVec 512))
(declare-fun a0x20109d_xmm10 () (_ BitVec 512))
(declare-fun a0x20109d_xmm11 () (_ BitVec 512))
(declare-fun a0x20109d_xmm12 () (_ BitVec 512))
(declare-fun a0x20109d_xmm13 () (_ BitVec 512))
(declare-fun a0x20109d_xmm14 () (_ BitVec 512))
(declare-fun a0x20109d_xmm15 () (_ BitVec 512))
(assert (= a0x20109d_rbx fnstart_rbx))
(assert (= a0x20109d_rsp (bvsub fnstart_rsp #x0000000000000018)))
(assert (= a0x20109d_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x20109d_r12 fnstart_r12))
(assert (= a0x20109d_r13 fnstart_r13))
(assert (= a0x20109d_r14 fnstart_r14))
(assert (= a0x20109d_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     ret i64 0
(define-fun rcx () (_ BitVec 64) ((_ zero_extend 32) (bvxor ((_ extract 31 0) a0x20109d_rcx) ((_ extract 31 0) a0x20109d_rcx))))
(define-fun addr () (_ BitVec 64) (bvadd a0x20109d_rbp (bvadd (bvmul #x0000000000000001 #x0000000000000000) (bvnot #x0000000000000007))))
(assert (is_in_mc_only_stack_range addr #x0000000000000004))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 init_mem addr ((_ extract 31 0) a0x20109d_rax)))
(define-fun rax () (_ BitVec 64) ((_ zero_extend 32) ((_ extract 31 0) (ite true rcx a0x20109d_rcx))))
(define-fun rsp () (_ BitVec 64) ((_ extract 63 0) (bvadd (concat #b0 ((_ sign_extend 32) #x00000010)) (concat #b0 a0x20109d_rsp))))
(define-fun addr0 () (_ BitVec 64) (ite true rsp a0x20109d_rsp))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr0 #x0000000000000008))
(assert (= readv (mem_readbv64 mem addr0)))
(define-fun rsp0 () (_ BitVec 64) (bvadd (ite true rsp a0x20109d_rsp) #x0000000000000008))
(define-fun addr1 () (_ BitVec 64) (ite true rsp0 (ite true rsp a0x20109d_rsp)))
(declare-fun readv0 () (_ BitVec 64))
(assert (on_stack addr1 #x0000000000000008))
(assert (= readv0 (mem_readbv64 mem addr1)))
(define-fun rsp1 () (_ BitVec 64) (bvadd (ite true rsp0 (ite true rsp a0x20109d_rsp)) #x0000000000000008))
(assert (= (ite true rsp1 (ite true rsp0 (ite true rsp a0x20109d_rsp))) (bvadd fnstart_rsp #x0000000000000008)))
(assert (= readv0 (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x20109d_df))
(assert (= (ite true readv a0x20109d_rbp) fnstart_rbp))
(assert (= a0x20109d_rbx fnstart_rbx))
(assert (= a0x20109d_r12 fnstart_r12))
(assert (= a0x20109d_r13 fnstart_r13))
(assert (= a0x20109d_r14 fnstart_r14))
(assert (= a0x20109d_r15 fnstart_r15))
(check-sat-assuming ((not (= #x0000000000000000 (ite true rax a0x20109d_rax)))))
(exit)
