...
(assert (= (mem_readbv64 init_mem fnstart_rsp) (mem_readbv64 mem1 fnstart_rsp)))
(assert true)
(assert (= a0x20104d_df false))
(assert (= %t8 a0x20104d_rax))
(assert (= %t5 (mem_readbv64 mem1 (bvsub fnstart_rsp #x0000000000000020))))
(assert (= a0x201036_rbx fnstart_rbx))
