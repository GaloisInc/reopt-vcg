; fib.block_0_201036.2 @ 0x201048: precondition ((= rsp (bvsub stack_high (_ bv40 64))), for jump)
(set-logic ALL)
...
(assert (= a0x201036_rbx fnstart_rbx))
(check-sat-assuming ((not (= (bvadd (ite true rsp a0x201036_rsp) #x0000000000000008) (bvsub fnstart_rsp #x0000000000000028)))))
(exit)
