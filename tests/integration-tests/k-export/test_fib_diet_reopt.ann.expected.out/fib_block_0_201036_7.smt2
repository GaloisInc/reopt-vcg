; fib.block_0_201036.2 @ 0x201048: precondition ((= (llvm t13) (mcstack (bvsub stack_high (_ bv32 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t8 (mem_readbv64 mem1 (bvsub fnstart_rsp #x0000000000000020))))))
(exit)
