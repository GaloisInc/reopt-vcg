; fib.block_0_20104d.1 @ 0x201054: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x20104d_rbx fnstart_rbx))
(assert (= a0x20104d_rsp (bvsub fnstart_rsp #x0000000000000028)))
(check-sat-assuming ((not (= a0x20104d_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
