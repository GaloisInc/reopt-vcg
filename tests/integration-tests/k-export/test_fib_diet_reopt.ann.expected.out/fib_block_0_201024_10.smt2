; fib.block_0_201024.2 @ 0x201031: precondition ((= (llvm t6) (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t2 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000018))))))
(exit)
