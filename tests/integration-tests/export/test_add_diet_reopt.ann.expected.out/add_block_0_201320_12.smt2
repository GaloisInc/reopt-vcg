...
(define-fun addr () (_ BitVec 64) (bvadd rsp (bvadd (bvmul #x0000000000000001 #x0000000000000000) #xfffffffffffffff8)))
...
(define-fun addr0 () (_ BitVec 64) (bvadd rsp (bvadd (bvmul #x0000000000000001 #x0000000000000000) #xfffffffffffffff8)))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr0 #x0000000000000008))
(assert (= readv (mem_readbv64 mem0 addr0)))
(define-fun addr1 () (_ BitVec 64) (bvadd rsp (bvadd (bvmul #x0000000000000001 #x0000000000000000) #xfffffffffffffff0)))
...
(define-fun addr2 () (_ BitVec 64) (bvadd rsp (bvadd (bvmul #x0000000000000001 #x0000000000000000) #xfffffffffffffff0)))
(declare-fun readv0 () (_ BitVec 64))
(assert (on_stack addr2 #x0000000000000008))
(assert (= readv0 (mem_readbv64 mem1 addr2)))
(define-fun rax () (_ BitVec 64) (bvadd readv0 ((_ sign_extend 32) #x00000001)))
