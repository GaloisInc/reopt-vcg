; fib.block_0_201000.1 @ 0x201011: instruction pointer is expected value (true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t0 #b1) (= (ite (and (ite (bvult (bvsub readv #x0000000000000000) #x0000000000000001) false true) (ite (= (bvsub readv #x0000000000000001) #x0000000000000000) false true)) #x0000000000201024 #x0000000000201017) #x0000000000201024)))))
(exit)
