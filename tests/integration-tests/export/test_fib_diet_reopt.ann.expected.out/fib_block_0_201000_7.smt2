; fib.block_0_201000.1 @ 0x201011: precondition ((= (llvm t2) (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t0 #b1) (= %arg0 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000018)))))))
(exit)
