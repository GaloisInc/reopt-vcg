; fib.block_0_201000.1 @ 0x201011: precondition ((= rsp (bvsub stack_high (_ bv40 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t0 #b1) (= rsp0 (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
