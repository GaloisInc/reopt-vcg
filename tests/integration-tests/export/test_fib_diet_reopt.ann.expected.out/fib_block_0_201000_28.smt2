...
(define-fun rsp0 () (_ BitVec 64) (bvsub (ite true rsp fnstart_rsp) ((_ sign_extend 56) #x20)))
(define-fun addr0 () (_ BitVec 64) (bvadd (ite true rbp fnstart_rbp) (bvadd (bvmul #x0000000000000001 #x0000000000000000) #xfffffffffffffff0)))
...
(define-fun addr1 () (_ BitVec 64) (bvadd (ite true rbp fnstart_rbp) (bvadd (bvmul #x0000000000000001 #x0000000000000000) #xfffffffffffffff0)))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr1 #x0000000000000008))
(assert (= readv (mem_readbv64 mem0 addr1)))
(assert (=> (= %t3 #b1) (= (ite (and (ite (ite true (bvult (bvsub readv (ite false #x0000000000000001 #x0000000000000000)) ((_ sign_extend 56) ((_ sign_extend 0) #x01))) (ite true (bvult (bvsub (bvsub (ite true rsp fnstart_rsp) ((_ sign_extend 56) #x20)) (ite false #x0000000000000001 #x0000000000000000)) ((_ sign_extend 56) #x20)) fnstart_cf)) false (not false)) (ite (ite true (= (bvsub readv ((_ sign_extend 56) ((_ sign_extend 0) #x01))) #x0000000000000000) (ite true (= (bvsub (ite true rsp fnstart_rsp) ((_ sign_extend 56) #x20)) #x0000000000000000) fnstart_zf)) false (not false))) (bvadd #x0000000000201017 ((_ sign_extend 32) #x0000000d)) #x0000000000201017) #x0000000000201024)))
...
(assert (=> (not (= %t3 #b1)) (= (ite (and (ite (ite true (bvult (bvsub readv (ite false #x0000000000000001 #x0000000000000000)) ((_ sign_extend 56) ((_ sign_extend 0) #x01))) (ite true (bvult (bvsub (bvsub (ite true rsp fnstart_rsp) ((_ sign_extend 56) #x20)) (ite false #x0000000000000001 #x0000000000000000)) ((_ sign_extend 56) #x20)) fnstart_cf)) false (not false)) (ite (ite true (= (bvsub readv ((_ sign_extend 56) ((_ sign_extend 0) #x01))) #x0000000000000000) (ite true (= (bvsub (ite true rsp fnstart_rsp) ((_ sign_extend 56) #x20)) #x0000000000000000) fnstart_zf)) false (not false))) (bvadd #x0000000000201017 ((_ sign_extend 32) #x0000000d)) #x0000000000201017) #x0000000000201017)))
