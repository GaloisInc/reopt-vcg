...
(check-sat-assuming ((not (=> (= %t3 #b1) (= (ite (and (ite (ite true (bvult (bvsub readv (ite false #x0000000000000001 #x0000000000000000)) ((_ sign_extend 56) ((_ sign_extend 0) #x01))) (ite true (bvult (bvsub (bvsub (ite true rsp fnstart_rsp) ((_ sign_extend 56) #x20)) (ite false #x0000000000000001 #x0000000000000000)) ((_ sign_extend 56) #x20)) fnstart_cf)) false (not false)) (ite (ite true (= (bvsub readv ((_ sign_extend 56) ((_ sign_extend 0) #x01))) #x0000000000000000) (ite true (= (bvsub (ite true rsp fnstart_rsp) ((_ sign_extend 56) #x20)) #x0000000000000000) fnstart_zf)) false (not false))) (bvadd #x0000000000201017 ((_ sign_extend 32) #x0000000d)) #x0000000000201017) #x0000000000201024)))))
(exit)
