...
(check-sat-assuming ((not (=> (not (= %t3 #b1)) (= (ite (and (ite (bvult (bvsub readv #x0000000000000000) #x0000000000000001) false true) (ite (= (bvsub readv #x0000000000000001) #x0000000000000000) false true)) #x0000000000201024 #x0000000000201017) #x0000000000201017)))))
(exit)
