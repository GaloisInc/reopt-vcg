; fib.block_0_201000.1 @ 0x201011: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t0 #b1) (= (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
