; fib.block_0_201000.1 @ 0x201011: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t0 #b1)) (= rsp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
