; fib.block_0_201000.1 @ 0x201011: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
; LLVM:     %t0 = icmp ult i64 1, %arg0
(define-fun %t0 () (_ BitVec 1) (ite (bvult #x0000000000000001 %arg0) #b1 #b0))
; LLVM:     br i1 %t0, label %block_0_201024, label %block_0_201017
...
(define-fun rsp0 () (_ BitVec 64) (bvsub rsp #x0000000000000020))
(define-fun addr () (_ BitVec 64) (bvadd rsp #xfffffffffffffff0))
...
(define-fun addr0 () (_ BitVec 64) (bvadd rsp #xfffffffffffffff0))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr0 #x0000000000000008))
(assert (= readv (mem_readbv64 mem0 addr0)))
(assert (= (mem_readbv64 init_mem fnstart_rsp) (mem_readbv64 mem0 fnstart_rsp)))
(assert (=> (= %t0 #b1) (= (ite (and (ite (bvult (bvsub readv #x0000000000000000) #x0000000000000001) false true) (ite (= (bvsub readv #x0000000000000001) #x0000000000000000) false true)) #x0000000000201024 #x0000000000201017) #x0000000000201024)))
(assert (=> (= %t0 #b1) (= fnstart_df false)))
(assert (=> (= %t0 #b1) (= %arg0 fnstart_rdi)))
(assert (=> (= %t0 #b1) (= %arg0 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000018)))))
(assert (=> (= %t0 #b1) (= fnstart_rbx fnstart_rbx)))
(assert (=> (= %t0 #b1) (= rsp0 (bvsub fnstart_rsp #x0000000000000028))))
(assert (=> (= %t0 #b1) (= rsp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t0 #b1) (= fnstart_r12 fnstart_r12)))
(assert (=> (= %t0 #b1) (= fnstart_r13 fnstart_r13)))
(assert (=> (= %t0 #b1) (= fnstart_r14 fnstart_r14)))
(assert (=> (= %t0 #b1) (= fnstart_r15 fnstart_r15)))
(assert (=> (= %t0 #b1) (= fnstart_rdi (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000018)))))
(assert (=> (= %t0 #b1) (= (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t0 #b1)) (= (ite (and (ite (bvult (bvsub readv #x0000000000000000) #x0000000000000001) false true) (ite (= (bvsub readv #x0000000000000001) #x0000000000000000) false true)) #x0000000000201024 #x0000000000201017) #x0000000000201017)))
(assert (=> (not (= %t0 #b1)) (= fnstart_df false)))
(assert (=> (not (= %t0 #b1)) (= %arg0 fnstart_rdi)))
(assert (=> (not (= %t0 #b1)) (= %arg0 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000018)))))
(assert (=> (not (= %t0 #b1)) (= fnstart_rbx fnstart_rbx)))
(assert (=> (not (= %t0 #b1)) (= rsp0 (bvsub fnstart_rsp #x0000000000000028))))
(assert (=> (not (= %t0 #b1)) (= rsp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t0 #b1)) (= fnstart_r12 fnstart_r12)))
(assert (=> (not (= %t0 #b1)) (= fnstart_r13 fnstart_r13)))
(assert (=> (not (= %t0 #b1)) (= fnstart_r14 fnstart_r14)))
(assert (=> (not (= %t0 #b1)) (= fnstart_r15 fnstart_r15)))
(assert (=> (not (= %t0 #b1)) (= fnstart_rdi (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000018)))))
(check-sat-assuming ((not (=> (not (= %t0 #b1)) (= (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
