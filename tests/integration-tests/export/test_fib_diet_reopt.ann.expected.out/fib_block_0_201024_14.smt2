...
(define-fun addr () (_ BitVec 64) (bvadd a0x201024_rbp (bvadd (bvmul #x0000000000000001 #x0000000000000000) #xfffffffffffffff0)))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem addr)))
(define-fun rax () (_ BitVec 64) (bvsub (ite true readv a0x201024_rax) ((_ sign_extend 32) #x00000001)))
