...
(assert (= %t1 a0x201017_rdi))
(assert (= %t1 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000018))))
...
(define-fun addr0 () (_ BitVec 64) (bvadd a0x201017_rbp #xfffffffffffffff8))
...
(assert (= %t1 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= a0x201017_rbx fnstart_rbx))
(assert (= a0x201017_rsp (bvsub fnstart_rsp #x0000000000000028)))
(assert (= a0x201017_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x201017_r12 fnstart_r12))
