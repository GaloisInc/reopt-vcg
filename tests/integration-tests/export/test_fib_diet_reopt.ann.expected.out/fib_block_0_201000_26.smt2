...
(assert (=> (= %t3 #b1) (= #x0000000000201024 (ite (and (ite (bvult (bvsub readv (ite false #x0000000000000001 #x0000000000000000)) ((_ sign_extend 56) ((_ sign_extend 0) #x01))) false (not false)) (ite (= (bvsub readv ((_ sign_extend 56) ((_ sign_extend 0) #x01))) #x0000000000000000) false (not false))) (bvadd #x0000000000201017 ((_ sign_extend 32) #x0000000d)) #x0000000000201017))))
...
(assert (=> (not (= %t3 #b1)) (= #x0000000000201017 (ite (and (ite (bvult (bvsub readv (ite false #x0000000000000001 #x0000000000000000)) ((_ sign_extend 56) ((_ sign_extend 0) #x01))) false (not false)) (ite (= (bvsub readv ((_ sign_extend 56) ((_ sign_extend 0) #x01))) #x0000000000000000) false (not false))) (bvadd #x0000000000201017 ((_ sign_extend 32) #x0000000d)) #x0000000000201017))))
