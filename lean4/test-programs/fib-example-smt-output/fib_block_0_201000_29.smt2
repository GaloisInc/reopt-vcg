...
(assert (=> (= llvm_t3 (_ bv1 1)) (= a201000_rdi (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv24 64))))))
(assert (=> (= llvm_t3 (_ bv1 1)) (= (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp)))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= #x0000000000201017 x86local_23)))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= (_ bv7 3) (_ bv7 3))))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= false false)))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= llvm_arg0 a201000_rdi)))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= llvm_arg0 (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv24 64))))))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= a201000_rbx fnstart_rbx)))
...
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= a201000_r12 fnstart_r12)))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= a201000_r13 fnstart_r13)))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= a201000_r14 fnstart_r14)))
(assert (=> (not (= llvm_t3 (_ bv1 1))) (= a201000_r15 fnstart_r15)))
(check-sat-assuming ((not (=> (not (= llvm_t3 (_ bv1 1))) (= a201000_rdi (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv24 64))))))))
(exit)
