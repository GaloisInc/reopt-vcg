; fib.block_0_201024.2 (0x201031). jump precondition: (= rsp (bvsub stack_high (_ bv40 64)))
...
(assert (= llvm_t5 (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv24 64)))))
(assert (= a201036_rbx fnstart_rbx))
(check-sat-assuming ((not (= a201036_rsp (bvsub fnstart_rsp (_ bv40 64))))))
(exit)
