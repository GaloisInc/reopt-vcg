; main.block_0_20109d.0 (0x2010a9). Value of r12 at return is preserved.
...
(assert (on_stack x86local_8 (_ bv8 64)))
(define-fun x86local_13 () (_ BitVec 64) (mem_readbv64 x86mem_1 x86local_8))
(define-fun x86local_14 () (_ BitVec 64) (bvadd x86local_8 (_ bv8 64)))
(assert (on_stack x86local_14 (_ bv8 64)))
(define-fun x86local_15 () (_ BitVec 64) (mem_readbv64 x86mem_1 x86local_14))
(define-fun x86local_16 () (_ BitVec 64) (bvadd x86local_14 (_ bv8 64)))
(assert (= x86local_16 (bvadd fnstart_rsp (_ bv8 64))))
(assert (= x86local_15 return_addr))
(assert (= x86local_13 fnstart_rbp))
(assert (= a20109d_rbx fnstart_rbx))
(check-sat-assuming ((distinct a20109d_r12 fnstart_r12)))
(exit)
