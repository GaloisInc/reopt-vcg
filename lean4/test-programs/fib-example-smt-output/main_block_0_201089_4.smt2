; main.block_0_201089.0 (0x201098). Check return address matches next instruction.
...
(assert (= llvm_t1 a201089_rax))
(check-sat-assuming ((distinct (mem_readbv64 x86mem_1 x86local_1) #x000000000020109d)))
(exit)
