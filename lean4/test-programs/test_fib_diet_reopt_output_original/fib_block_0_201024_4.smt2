; fib.block_0_201024.1 (0x201031). Check return address matches next instruction.
...
(check-sat-assuming ((distinct (mem_readbv64 x86mem_1 x86local_11) #x0000000000201036)))
(exit)
