; main.block_0_201340.0 (0x201354). Check return address matches next instruction.
...
(check-sat-assuming ((distinct (mem_readbv64 x86mem_3 x86local_9) #x0000000000201359)))
(exit)
