def sarw : instruction :=
  definst "sarw" $ do
    pattern fun (_ : clReg) (mem_0 : Mem) => do
      ...
      v_6 <- eval (ashr (concat v_2 (expression.bv_nat 1 0)) (concat (expression.bv_nat 9 0) v_5));
      ...
      setRegister cf (mux v_9 v_15 (isBitSet v_6 16));
    ...
    pattern fun (_ : clReg) (r16_0 : reg (bv 16)) => do
      ...
      v_7 <- eval (ashr (concat v_6 (expression.bv_nat 1 0)) (concat (expression.bv_nat 9 0) v_3));
      ...
      setRegister cf (mux v_4 v_13 (isBitSet v_7 16));
    ...
    pattern fun (imm_0 : imm int) (mem_1 : Mem) => do
      ...
      v_5 <- eval (ashr (concat v_3 (expression.bv_nat 1 0)) (concat (expression.bv_nat 9 0) v_4));
      ...
      setRegister cf (mux v_8 v_14 (isBitSet v_5 16));
    ...
    pattern fun (imm_0 : imm int) (r16_1 : reg (bv 16)) => do
      ...
      v_6 <- eval (ashr (concat v_5 (expression.bv_nat 1 0)) (concat (expression.bv_nat 9 0) v_2));
      (v_7 : expression (bv 16)) <- eval (extract v_6 0 16);
      v_8 <- getRegister sf;
      v_9 <- getRegister pf;
      ...
      setRegister cf (mux v_3 v_12 (isBitSet v_6 16));
    ...
    pattern fun (mem_0 : Mem) => do
      v_1 <- evaluateAddress mem_0;
      v_2 <- load v_1 2;
      v_3 <- eval (ashr (concat v_2 (expression.bv_nat 1 0)) (expression.bv_nat 17 1));
    ...
    pattern fun (r16_0 : reg (bv 16)) => do
      ...
      v_2 <- eval (ashr (concat v_1 (expression.bv_nat 1 0)) (expression.bv_nat 17 1));
