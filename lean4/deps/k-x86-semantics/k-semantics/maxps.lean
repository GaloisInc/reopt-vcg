def maxps : instruction :=
  definst "maxps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (eq (/- (_,_) -/  maxcmp_single v_3 v_6) (expression.bv_nat 1 1)) v_3 v_6) (concat (mux (eq (/- (_,_) -/  maxcmp_single v_7 v_8) (expression.bv_nat 1 1)) v_7 v_8) (concat (mux (eq (/- (_,_) -/  maxcmp_single v_9 v_10) (expression.bv_nat 1 1)) v_9 v_10) (mux (eq (/- (_,_) -/  maxcmp_single v_11 v_12) (expression.bv_nat 1 1)) v_11 v_12))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (eq (/- (_,_) -/  maxcmp_single v_3 v_5) (expression.bv_nat 1 1)) v_3 v_5) (concat (mux (eq (/- (_,_) -/  maxcmp_single v_6 v_7) (expression.bv_nat 1 1)) v_6 v_7) (concat (mux (eq (/- (_,_) -/  maxcmp_single v_8 v_9) (expression.bv_nat 1 1)) v_8 v_9) (mux (eq (/- (_,_) -/  maxcmp_single v_10 v_11) (expression.bv_nat 1 1)) v_10 v_11))));
      pure ()
    pat_end
