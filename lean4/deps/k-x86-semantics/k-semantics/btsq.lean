def btsq : instruction :=
  definst "btsq" $ do
    ...
    pattern fun (imm_0 : imm int) (r64_1 : reg (bv 64)) => do
      ...
      setRegister (lhs.of_reg r64_1) (bv_or v_2 (extract (shl (expression.bv_nat 64 1) v_3) 0 64));
      setRegister af undef;
    ...
    pattern fun (r64_0 : reg (bv 64)) (r64_1 : reg (bv 64)) => do
      ...
      setRegister (lhs.of_reg r64_1) (bv_or v_2 (extract (shl (expression.bv_nat 64 1) v_4) 0 64));
      setRegister af undef;
