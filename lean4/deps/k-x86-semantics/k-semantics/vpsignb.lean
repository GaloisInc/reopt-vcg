def vpsignb : instruction :=
  definst "vpsignb" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      v_8 <- eval (extract v_4 8 16);
      v_9 <- eval (extract v_6 8 16);
      v_10 <- eval (extract v_4 16 24);
      v_11 <- eval (extract v_6 16 24);
      v_12 <- eval (extract v_4 24 32);
      v_13 <- eval (extract v_6 24 32);
      v_14 <- eval (extract v_4 32 40);
      v_15 <- eval (extract v_6 32 40);
      v_16 <- eval (extract v_4 40 48);
      v_17 <- eval (extract v_6 40 48);
      v_18 <- eval (extract v_4 48 56);
      v_19 <- eval (extract v_6 48 56);
      v_20 <- eval (extract v_4 56 64);
      v_21 <- eval (extract v_6 56 64);
      v_22 <- eval (extract v_4 64 72);
      v_23 <- eval (extract v_6 64 72);
      v_24 <- eval (extract v_4 72 80);
      v_25 <- eval (extract v_6 72 80);
      v_26 <- eval (extract v_4 80 88);
      v_27 <- eval (extract v_6 80 88);
      v_28 <- eval (extract v_4 88 96);
      v_29 <- eval (extract v_6 88 96);
      v_30 <- eval (extract v_4 96 104);
      v_31 <- eval (extract v_6 96 104);
      v_32 <- eval (extract v_4 104 112);
      v_33 <- eval (extract v_6 104 112);
      v_34 <- eval (extract v_4 112 120);
      v_35 <- eval (extract v_6 112 120);
      v_36 <- eval (extract v_4 120 128);
