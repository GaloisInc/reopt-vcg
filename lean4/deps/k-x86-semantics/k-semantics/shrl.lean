def shrl : instruction :=
  definst "shrl" $ do
    pattern fun (_ : clReg) (mem_0 : Mem) => do
      ...
      v_5 <- eval (lshr (concat v_2 (expression.bv_nat 1 0)) (concat (expression.bv_nat 25 0) v_4));
      ...
      setRegister cf (mux (uge v_4 (expression.bv_nat 8 32)) undef (mux v_8 v_13 (isBitSet v_5 32)));
      setRegister of (mux (eq v_4 (expression.bv_nat 8 1)) (isBitSet v_2 0) (mux v_8 v_12 undef));
      setRegister pf (mux v_8 v_11 (parityFlag (extract v_5 24 32)));
    ...
    pattern fun (_ : clReg) (r32_0 : reg (bv 32)) => do
      ...
      setRegister cf (mux (uge v_2 (expression.bv_nat 8 32)) undef (mux v_3 v_11 (isBitSet v_6 32)));
      setRegister of (mux (eq v_2 (expression.bv_nat 8 1)) (isBitSet v_5 0) (mux v_3 v_10 undef));
      setRegister pf (mux v_3 v_9 (parityFlag (extract v_6 24 32)));
