def shrl : instruction :=
  definst "shrl" $ do
    pattern fun (_ : clReg) (mem_0 : Mem) => do
      ...
      v_6 <- eval (lshr (concat v_2 (expression.bv_nat 1 0)) (concat (expression.bv_nat 25 0) v_5));
      ...
      setRegister cf (mux (uge v_5 (expression.bv_nat 8 32)) undef (mux v_9 v_15 (isBitSet v_6 32)));
      setRegister of (mux (eq v_5 (expression.bv_nat 8 1)) (isBitSet v_2 0) (mux v_9 v_14 undef));
    ...
    pattern fun (_ : clReg) (r32_0 : reg (bv 32)) => do
      ...
      v_7 <- eval (lshr (concat v_6 (expression.bv_nat 1 0)) (concat (expression.bv_nat 25 0) v_3));
      ...
      setRegister cf (mux (uge v_3 (expression.bv_nat 8 32)) undef (mux v_4 v_13 (isBitSet v_7 32)));
      setRegister of (mux (eq v_3 (expression.bv_nat 8 1)) (isBitSet v_6 0) (mux v_4 v_12 undef));
    ...
    pattern fun (imm_0 : imm int) (mem_1 : Mem) => do
      ...
      v_5 <- eval (lshr (concat v_3 (expression.bv_nat 1 0)) (concat (expression.bv_nat 25 0) v_4));
      ...
      setRegister cf (mux (uge v_4 (expression.bv_nat 8 32)) undef (mux v_8 v_14 (isBitSet v_5 32)));
      setRegister of (mux (eq v_4 (expression.bv_nat 8 1)) (isBitSet v_3 0) (mux v_8 v_13 undef));
    ...
    pattern fun (imm_0 : imm int) (r32_1 : reg (bv 32)) => do
      ...
      v_6 <- eval (lshr (concat v_5 (expression.bv_nat 1 0)) (concat (expression.bv_nat 25 0) v_2));
      (v_7 : expression (bv 32)) <- eval (extract v_6 0 32);
      v_8 <- getRegister sf;
      v_9 <- getRegister pf;
      ...
      setRegister cf (mux (uge v_2 (expression.bv_nat 8 32)) undef (mux v_3 v_12 (isBitSet v_6 32)));
      setRegister of (mux (eq v_2 (expression.bv_nat 8 1)) (isBitSet v_5 0) (mux v_3 v_11 undef));
    ...
    pattern fun (mem_0 : Mem) => do
      v_1 <- evaluateAddress mem_0;
      v_2 <- load v_1 4;
      v_3 <- eval (lshr (concat v_2 (expression.bv_nat 1 0)) (expression.bv_nat 33 1));
    ...
    pattern fun (r32_0 : reg (bv 32)) => do
      ...
      v_2 <- eval (lshr (concat v_1 (expression.bv_nat 1 0)) (expression.bv_nat 33 1));
