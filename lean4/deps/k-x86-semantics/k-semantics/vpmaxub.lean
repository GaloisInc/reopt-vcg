def vpmaxub : instruction :=
  definst "vpmaxub" $ do
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (mux (ugt v_4 v_7) v_4 v_7) (concat (mux (ugt v_8 v_9) v_8 v_9) (concat (mux (ugt v_10 v_11) v_10 v_11) (concat (mux (ugt v_12 v_13) v_12 v_13) (concat (mux (ugt v_14 v_15) v_14 v_15) (concat (mux (ugt v_16 v_17) v_16 v_17) (concat (mux (ugt v_18 v_19) v_18 v_19) (concat (mux (ugt v_20 v_21) v_20 v_21) (concat (mux (ugt v_22 v_23) v_22 v_23) (concat (mux (ugt v_24 v_25) v_24 v_25) (concat (mux (ugt v_26 v_27) v_26 v_27) (concat (mux (ugt v_28 v_29) v_28 v_29) (concat (mux (ugt v_30 v_31) v_30 v_31) (concat (mux (ugt v_32 v_33) v_32 v_33) (concat (mux (ugt v_34 v_35) v_34 v_35) (concat (mux (ugt v_36 v_37) v_36 v_37) (concat (mux (ugt v_38 v_39) v_38 v_39) (concat (mux (ugt v_40 v_41) v_40 v_41) (concat (mux (ugt v_42 v_43) v_42 v_43) (concat (mux (ugt v_44 v_45) v_44 v_45) (concat (mux (ugt v_46 v_47) v_46 v_47) (concat (mux (ugt v_48 v_49) v_48 v_49) (concat (mux (ugt v_50 v_51) v_50 v_51) (concat (mux (ugt v_52 v_53) v_52 v_53) (concat (mux (ugt v_54 v_55) v_54 v_55) (concat (mux (ugt v_56 v_57) v_56 v_57) (concat (mux (ugt v_58 v_59) v_58 v_59) (concat (mux (ugt v_60 v_61) v_60 v_61) (concat (mux (ugt v_62 v_63) v_62 v_63) (concat (mux (ugt v_64 v_65) v_64 v_65) (concat (mux (ugt v_66 v_67) v_66 v_67) (mux (ugt v_68 v_69) v_68 v_69))))))))))))))))))))))))))))))));
      pure ()
    pat_end;
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (mux (ugt v_4 v_6) v_4 v_6) (concat (mux (ugt v_7 v_8) v_7 v_8) (concat (mux (ugt v_9 v_10) v_9 v_10) (concat (mux (ugt v_11 v_12) v_11 v_12) (concat (mux (ugt v_13 v_14) v_13 v_14) (concat (mux (ugt v_15 v_16) v_15 v_16) (concat (mux (ugt v_17 v_18) v_17 v_18) (concat (mux (ugt v_19 v_20) v_19 v_20) (concat (mux (ugt v_21 v_22) v_21 v_22) (concat (mux (ugt v_23 v_24) v_23 v_24) (concat (mux (ugt v_25 v_26) v_25 v_26) (concat (mux (ugt v_27 v_28) v_27 v_28) (concat (mux (ugt v_29 v_30) v_29 v_30) (concat (mux (ugt v_31 v_32) v_31 v_32) (concat (mux (ugt v_33 v_34) v_33 v_34) (concat (mux (ugt v_35 v_36) v_35 v_36) (concat (mux (ugt v_37 v_38) v_37 v_38) (concat (mux (ugt v_39 v_40) v_39 v_40) (concat (mux (ugt v_41 v_42) v_41 v_42) (concat (mux (ugt v_43 v_44) v_43 v_44) (concat (mux (ugt v_45 v_46) v_45 v_46) (concat (mux (ugt v_47 v_48) v_47 v_48) (concat (mux (ugt v_49 v_50) v_49 v_50) (concat (mux (ugt v_51 v_52) v_51 v_52) (concat (mux (ugt v_53 v_54) v_53 v_54) (concat (mux (ugt v_55 v_56) v_55 v_56) (concat (mux (ugt v_57 v_58) v_57 v_58) (concat (mux (ugt v_59 v_60) v_59 v_60) (concat (mux (ugt v_61 v_62) v_61 v_62) (concat (mux (ugt v_63 v_64) v_63 v_64) (concat (mux (ugt v_65 v_66) v_65 v_66) (mux (ugt v_67 v_68) v_67 v_68))))))))))))))))))))))))))))))));
      pure ()
    pat_end
