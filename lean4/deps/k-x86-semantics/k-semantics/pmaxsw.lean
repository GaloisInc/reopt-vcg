def pmaxsw : instruction :=
  definst "pmaxsw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_3 v_6) v_3 v_6) (concat (mux (sgt v_7 v_8) v_7 v_8) (concat (mux (sgt v_9 v_10) v_9 v_10) (concat (mux (sgt v_11 v_12) v_11 v_12) (concat (mux (sgt v_13 v_14) v_13 v_14) (concat (mux (sgt v_15 v_16) v_15 v_16) (concat (mux (sgt v_17 v_18) v_17 v_18) (mux (sgt v_19 v_20) v_19 v_20))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_3 v_5) v_3 v_5) (concat (mux (sgt v_6 v_7) v_6 v_7) (concat (mux (sgt v_8 v_9) v_8 v_9) (concat (mux (sgt v_10 v_11) v_10 v_11) (concat (mux (sgt v_12 v_13) v_12 v_13) (concat (mux (sgt v_14 v_15) v_14 v_15) (concat (mux (sgt v_16 v_17) v_16 v_17) (mux (sgt v_18 v_19) v_18 v_19))))))));
      pure ()
    pat_end
