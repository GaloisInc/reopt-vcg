def vpaddb : instruction :=
  definst "vpaddb" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (add v_4 v_7) (concat (add v_8 v_9) (concat (add v_10 v_11) (concat (add v_12 v_13) (concat (add v_14 v_15) (concat (add v_16 v_17) (concat (add v_18 v_19) (concat (add v_20 v_21) (concat (add v_22 v_23) (concat (add v_24 v_25) (concat (add v_26 v_27) (concat (add v_28 v_29) (concat (add v_30 v_31) (concat (add v_32 v_33) (concat (add v_34 v_35) (add v_36 v_37))))))))))))))));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (add v_4 v_7) (concat (add v_8 v_9) (concat (add v_10 v_11) (concat (add v_12 v_13) (concat (add v_14 v_15) (concat (add v_16 v_17) (concat (add v_18 v_19) (concat (add v_20 v_21) (concat (add v_22 v_23) (concat (add v_24 v_25) (concat (add v_26 v_27) (concat (add v_28 v_29) (concat (add v_30 v_31) (concat (add v_32 v_33) (concat (add v_34 v_35) (concat (add v_36 v_37) (concat (add v_38 v_39) (concat (add v_40 v_41) (concat (add v_42 v_43) (concat (add v_44 v_45) (concat (add v_46 v_47) (concat (add v_48 v_49) (concat (add v_50 v_51) (concat (add v_52 v_53) (concat (add v_54 v_55) (concat (add v_56 v_57) (concat (add v_58 v_59) (concat (add v_60 v_61) (concat (add v_62 v_63) (concat (add v_64 v_65) (concat (add v_66 v_67) (add v_68 v_69))))))))))))))))))))))))))))))));
      pure ()
    pat_end;
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (add v_4 v_6) (concat (add v_7 v_8) (concat (add v_9 v_10) (concat (add v_11 v_12) (concat (add v_13 v_14) (concat (add v_15 v_16) (concat (add v_17 v_18) (concat (add v_19 v_20) (concat (add v_21 v_22) (concat (add v_23 v_24) (concat (add v_25 v_26) (concat (add v_27 v_28) (concat (add v_29 v_30) (concat (add v_31 v_32) (concat (add v_33 v_34) (concat (add v_35 v_36) (concat (add v_37 v_38) (concat (add v_39 v_40) (concat (add v_41 v_42) (concat (add v_43 v_44) (concat (add v_45 v_46) (concat (add v_47 v_48) (concat (add v_49 v_50) (concat (add v_51 v_52) (concat (add v_53 v_54) (concat (add v_55 v_56) (concat (add v_57 v_58) (concat (add v_59 v_60) (concat (add v_61 v_62) (concat (add v_63 v_64) (concat (add v_65 v_66) (add v_67 v_68))))))))))))))))))))))))))))))));
      pure ()
    pat_end
