def vhaddpd : instruction :=
  definst "vhaddpd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_add v_5 v_6) 64) (fp_bitcast_to_bv (fp_add v_8 v_9) 64));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_add v_5 v_6) 64) (fp_bitcast_to_bv (fp_add v_8 v_9) 64)) (concat (fp_bitcast_to_bv (fp_add v_10 v_11) 64) (fp_bitcast_to_bv (fp_add v_12 v_13) 64)));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_add v_4 v_5) 64) (fp_bitcast_to_bv (fp_add v_7 v_8) 64));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_add v_4 v_5) 64) (fp_bitcast_to_bv (fp_add v_7 v_8) 64)) (concat (fp_bitcast_to_bv (fp_add v_9 v_10) 64) (fp_bitcast_to_bv (fp_add v_11 v_12) 64)));
      pure ()
    pat_end
