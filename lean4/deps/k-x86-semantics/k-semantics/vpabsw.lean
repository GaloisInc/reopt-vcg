def vpabsw : instruction :=
  definst "vpabsw" $ do
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) => do
      ...
      (v_10 : expression (bv 16)) <- eval (extract v_3 96 112);
      (v_11 : expression (bv 16)) <- eval (extract v_3 112 128);
      (v_12 : expression (bv 16)) <- eval (extract v_3 128 144);
      (v_13 : expression (bv 16)) <- eval (extract v_3 144 160);
      (v_14 : expression (bv 16)) <- eval (extract v_3 160 176);
      (v_15 : expression (bv 16)) <- eval (extract v_3 176 192);
      (v_16 : expression (bv 16)) <- eval (extract v_3 192 208);
      (v_17 : expression (bv 16)) <- eval (extract v_3 208 224);
      (v_18 : expression (bv 16)) <- eval (extract v_3 224 240);
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) => do
      ...
      (v_9 : expression (bv 16)) <- eval (extract v_2 96 112);
      (v_10 : expression (bv 16)) <- eval (extract v_2 112 128);
      (v_11 : expression (bv 16)) <- eval (extract v_2 128 144);
      (v_12 : expression (bv 16)) <- eval (extract v_2 144 160);
      (v_13 : expression (bv 16)) <- eval (extract v_2 160 176);
      (v_14 : expression (bv 16)) <- eval (extract v_2 176 192);
      (v_15 : expression (bv 16)) <- eval (extract v_2 192 208);
      (v_16 : expression (bv 16)) <- eval (extract v_2 208 224);
      (v_17 : expression (bv 16)) <- eval (extract v_2 224 240);
      (v_18 : expression (bv 16)) <- eval (extract v_2 240 256);
