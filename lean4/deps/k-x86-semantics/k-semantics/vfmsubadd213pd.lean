def vfmsubadd213pd : instruction :=
  definst "vfmsubadd213pd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_14 v_16) v_18) 64));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_14 v_16) v_18) 64)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_20 v_22) v_24) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_26 v_28) v_30) 64)));
      pure ()
    pat_end;
