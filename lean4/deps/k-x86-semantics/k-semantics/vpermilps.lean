def vpermilps : instruction :=
  definst "vpermilps" $ do
    pattern fun (imm_0 : imm int) (mem_1 : Mem) (xmm_2 : reg (bv 128)) => do
      ...
      (v_4 : expression (bv 2)) <- eval (extract v_3 0 2);
      ...
      (v_10 : expression (bv 32)) <- eval (extract v_6 0 32);
      (v_11 : expression (bv 2)) <- eval (extract v_3 2 4);
      (v_12 : expression (bv 2)) <- eval (extract v_3 4 6);
      (v_13 : expression (bv 2)) <- eval (extract v_3 6 8);
    ...
    pattern fun (imm_0 : imm int) (mem_1 : Mem) (ymm_2 : reg (bv 256)) => do
      ...
      (v_27 : expression (bv 32)) <- eval (extract v_7 192 224);
      (v_28 : expression (bv 32)) <- eval (extract v_7 160 192);
      (v_29 : expression (bv 32)) <- eval (extract v_7 128 160);
    ...
    pattern fun (imm_0 : imm int) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      (v_7 : expression (bv 32)) <- eval (extract v_5 64 96);
      (v_8 : expression (bv 32)) <- eval (extract v_5 32 64);
      (v_9 : expression (bv 32)) <- eval (extract v_5 0 32);
      (v_10 : expression (bv 2)) <- eval (extract v_3 2 4);
      (v_11 : expression (bv 2)) <- eval (extract v_3 4 6);
      (v_12 : expression (bv 2)) <- eval (extract v_3 6 8);
    ...
    pattern fun (imm_0 : imm int) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      (v_9 : expression (bv 32)) <- eval (extract v_6 64 96);
    ...
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      v_4 <- load v_3 16;
      (v_5 : expression (bv 2)) <- eval (extract v_4 30 32);
      v_6 <- getRegister (lhs.of_reg xmm_1);
      (v_7 : expression (bv 32)) <- eval (extract v_6 96 128);
      (v_8 : expression (bv 32)) <- eval (extract v_6 64 96);
      (v_9 : expression (bv 32)) <- eval (extract v_6 32 64);
      (v_10 : expression (bv 32)) <- eval (extract v_6 0 32);
      (v_11 : expression (bv 2)) <- eval (extract v_4 62 64);
      (v_12 : expression (bv 2)) <- eval (extract v_4 94 96);
      (v_13 : expression (bv 2)) <- eval (extract v_4 126 128);
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      (v_12 : expression (bv 2)) <- eval (extract v_4 94 96);
      (v_13 : expression (bv 2)) <- eval (extract v_4 126 128);
      (v_14 : expression (bv 2)) <- eval (extract v_4 158 160);
      (v_15 : expression (bv 32)) <- eval (extract v_6 224 256);
      (v_16 : expression (bv 32)) <- eval (extract v_6 192 224);
      (v_17 : expression (bv 32)) <- eval (extract v_6 160 192);
      (v_18 : expression (bv 32)) <- eval (extract v_6 128 160);
      (v_19 : expression (bv 2)) <- eval (extract v_4 190 192);
      (v_20 : expression (bv 2)) <- eval (extract v_4 222 224);
      (v_21 : expression (bv 2)) <- eval (extract v_4 254 256);
    ...
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      (v_4 : expression (bv 2)) <- eval (extract v_3 30 32);
      v_5 <- getRegister (lhs.of_reg xmm_1);
      (v_6 : expression (bv 32)) <- eval (extract v_5 96 128);
      (v_7 : expression (bv 32)) <- eval (extract v_5 64 96);
      (v_8 : expression (bv 32)) <- eval (extract v_5 32 64);
      (v_9 : expression (bv 32)) <- eval (extract v_5 0 32);
      (v_10 : expression (bv 2)) <- eval (extract v_3 62 64);
      (v_11 : expression (bv 2)) <- eval (extract v_3 94 96);
      (v_12 : expression (bv 2)) <- eval (extract v_3 126 128);
      setRegister (lhs.of_reg xmm_2) (concat (mux (eq v_4 (expression.bv_nat 2 0)) v_6 (mux (eq v_4 (expression.bv_nat 2 1)) v_7 (mux (eq v_4 (expression.bv_nat 2 2)) v_8 v_9))) (concat (mux (eq v_10 (expression.bv_nat 2 0)) v_6 (mux (eq v_10 (expression.bv_nat 2 1)) v_7 (mux (eq v_10 (expression.bv_nat 2 2)) v_8 v_9))) (concat (mux (eq v_11 (expression.bv_nat 2 0)) v_6 (mux (eq v_11 (expression.bv_nat 2 1)) v_7 (mux (eq v_11 (expression.bv_nat 2 2)) v_8 v_9))) (mux (eq v_12 (expression.bv_nat 2 0)) v_6 (mux (eq v_12 (expression.bv_nat 2 1)) v_7 (mux (eq v_12 (expression.bv_nat 2 2)) v_8 v_9))))));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      (v_11 : expression (bv 2)) <- eval (extract v_3 94 96);
      (v_12 : expression (bv 2)) <- eval (extract v_3 126 128);
      (v_13 : expression (bv 2)) <- eval (extract v_3 158 160);
      (v_14 : expression (bv 32)) <- eval (extract v_5 224 256);
      (v_15 : expression (bv 32)) <- eval (extract v_5 192 224);
      (v_16 : expression (bv 32)) <- eval (extract v_5 160 192);
      (v_17 : expression (bv 32)) <- eval (extract v_5 128 160);
      (v_18 : expression (bv 2)) <- eval (extract v_3 190 192);
      (v_19 : expression (bv 2)) <- eval (extract v_3 222 224);
      (v_20 : expression (bv 2)) <- eval (extract v_3 254 256);
