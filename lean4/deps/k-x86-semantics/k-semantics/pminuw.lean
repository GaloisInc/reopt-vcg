def pminuw : instruction :=
  definst "pminuw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (ult v_3 v_6) v_3 v_6) (concat (mux (ult v_7 v_8) v_7 v_8) (concat (mux (ult v_9 v_10) v_9 v_10) (concat (mux (ult v_11 v_12) v_11 v_12) (concat (mux (ult v_13 v_14) v_13 v_14) (concat (mux (ult v_15 v_16) v_15 v_16) (concat (mux (ult v_17 v_18) v_17 v_18) (mux (ult v_19 v_20) v_19 v_20))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (ult v_3 v_5) v_3 v_5) (concat (mux (ult v_6 v_7) v_6 v_7) (concat (mux (ult v_8 v_9) v_8 v_9) (concat (mux (ult v_10 v_11) v_10 v_11) (concat (mux (ult v_12 v_13) v_12 v_13) (concat (mux (ult v_14 v_15) v_14 v_15) (concat (mux (ult v_16 v_17) v_16 v_17) (mux (ult v_18 v_19) v_18 v_19))))))));
      pure ()
    pat_end
