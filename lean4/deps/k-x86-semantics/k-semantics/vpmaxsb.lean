def vpmaxsb : instruction :=
  definst "vpmaxsb" $ do
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (mux (sgt v_4 v_7) v_4 v_7) (concat (mux (sgt v_8 v_9) v_8 v_9) (concat (mux (sgt v_10 v_11) v_10 v_11) (concat (mux (sgt v_12 v_13) v_12 v_13) (concat (mux (sgt v_14 v_15) v_14 v_15) (concat (mux (sgt v_16 v_17) v_16 v_17) (concat (mux (sgt v_18 v_19) v_18 v_19) (concat (mux (sgt v_20 v_21) v_20 v_21) (concat (mux (sgt v_22 v_23) v_22 v_23) (concat (mux (sgt v_24 v_25) v_24 v_25) (concat (mux (sgt v_26 v_27) v_26 v_27) (concat (mux (sgt v_28 v_29) v_28 v_29) (concat (mux (sgt v_30 v_31) v_30 v_31) (concat (mux (sgt v_32 v_33) v_32 v_33) (concat (mux (sgt v_34 v_35) v_34 v_35) (concat (mux (sgt v_36 v_37) v_36 v_37) (concat (mux (sgt v_38 v_39) v_38 v_39) (concat (mux (sgt v_40 v_41) v_40 v_41) (concat (mux (sgt v_42 v_43) v_42 v_43) (concat (mux (sgt v_44 v_45) v_44 v_45) (concat (mux (sgt v_46 v_47) v_46 v_47) (concat (mux (sgt v_48 v_49) v_48 v_49) (concat (mux (sgt v_50 v_51) v_50 v_51) (concat (mux (sgt v_52 v_53) v_52 v_53) (concat (mux (sgt v_54 v_55) v_54 v_55) (concat (mux (sgt v_56 v_57) v_56 v_57) (concat (mux (sgt v_58 v_59) v_58 v_59) (concat (mux (sgt v_60 v_61) v_60 v_61) (concat (mux (sgt v_62 v_63) v_62 v_63) (concat (mux (sgt v_64 v_65) v_64 v_65) (concat (mux (sgt v_66 v_67) v_66 v_67) (mux (sgt v_68 v_69) v_68 v_69))))))))))))))))))))))))))))))));
      pure ()
    pat_end;
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (mux (sgt v_4 v_6) v_4 v_6) (concat (mux (sgt v_7 v_8) v_7 v_8) (concat (mux (sgt v_9 v_10) v_9 v_10) (concat (mux (sgt v_11 v_12) v_11 v_12) (concat (mux (sgt v_13 v_14) v_13 v_14) (concat (mux (sgt v_15 v_16) v_15 v_16) (concat (mux (sgt v_17 v_18) v_17 v_18) (concat (mux (sgt v_19 v_20) v_19 v_20) (concat (mux (sgt v_21 v_22) v_21 v_22) (concat (mux (sgt v_23 v_24) v_23 v_24) (concat (mux (sgt v_25 v_26) v_25 v_26) (concat (mux (sgt v_27 v_28) v_27 v_28) (concat (mux (sgt v_29 v_30) v_29 v_30) (concat (mux (sgt v_31 v_32) v_31 v_32) (concat (mux (sgt v_33 v_34) v_33 v_34) (concat (mux (sgt v_35 v_36) v_35 v_36) (concat (mux (sgt v_37 v_38) v_37 v_38) (concat (mux (sgt v_39 v_40) v_39 v_40) (concat (mux (sgt v_41 v_42) v_41 v_42) (concat (mux (sgt v_43 v_44) v_43 v_44) (concat (mux (sgt v_45 v_46) v_45 v_46) (concat (mux (sgt v_47 v_48) v_47 v_48) (concat (mux (sgt v_49 v_50) v_49 v_50) (concat (mux (sgt v_51 v_52) v_51 v_52) (concat (mux (sgt v_53 v_54) v_53 v_54) (concat (mux (sgt v_55 v_56) v_55 v_56) (concat (mux (sgt v_57 v_58) v_57 v_58) (concat (mux (sgt v_59 v_60) v_59 v_60) (concat (mux (sgt v_61 v_62) v_61 v_62) (concat (mux (sgt v_63 v_64) v_63 v_64) (concat (mux (sgt v_65 v_66) v_65 v_66) (mux (sgt v_67 v_68) v_67 v_68))))))))))))))))))))))))))))))));
      pure ()
    pat_end
