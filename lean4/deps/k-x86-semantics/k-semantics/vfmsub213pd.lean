def vfmsub213pd : instruction :=
  definst "vfmsub213pd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      v_13 <- eval (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 64);
      (v_14 : expression (bv 56)) <- eval (extract v_13 0 56);
      (v_15 : expression (bv 8)) <- eval (extract v_13 56 64);
      (v_16 : expression (bv 64)) <- eval (extract v_3 64 128);
      v_17 <- eval (bv_bitcast_to_fp float_class.fp64 v_16);
      (v_18 : expression (bv 64)) <- eval (extract v_6 64 128);
      v_19 <- eval (bv_bitcast_to_fp float_class.fp64 v_18);
      (v_20 : expression (bv 64)) <- eval (extract v_10 64 128);
      v_21 <- eval (bv_bitcast_to_fp float_class.fp64 v_20);
      setRegister (lhs.of_reg xmm_2) (concat (concat v_14 v_15) (fp_bitcast_to_bv (fp_sub (fp_mul v_17 v_19) v_21) 64));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_12) 64) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_14 v_16) v_18) 64) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_20 v_22) v_24) 64) (fp_bitcast_to_bv (fp_sub (fp_mul v_26 v_28) v_30) 64))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      v_12 <- eval (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_11) 64);
      (v_13 : expression (bv 56)) <- eval (extract v_12 0 56);
      (v_14 : expression (bv 8)) <- eval (extract v_12 56 64);
      (v_15 : expression (bv 64)) <- eval (extract v_3 64 128);
      v_16 <- eval (bv_bitcast_to_fp float_class.fp64 v_15);
      (v_17 : expression (bv 64)) <- eval (extract v_6 64 128);
      v_18 <- eval (bv_bitcast_to_fp float_class.fp64 v_17);
      (v_19 : expression (bv 64)) <- eval (extract v_9 64 128);
      v_20 <- eval (bv_bitcast_to_fp float_class.fp64 v_19);
      setRegister (lhs.of_reg xmm_2) (concat (concat v_13 v_14) (fp_bitcast_to_bv (fp_sub (fp_mul v_16 v_18) v_20) 64));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_5 v_8) v_11) 64) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_13 v_15) v_17) 64) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_19 v_21) v_23) 64) (fp_bitcast_to_bv (fp_sub (fp_mul v_25 v_27) v_29) 64))));
      pure ()
    pat_end
