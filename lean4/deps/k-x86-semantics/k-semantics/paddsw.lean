def paddsw : instruction :=
  definst "paddsw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      v_7 <- eval (add (sext v_3 32) (sext v_6 32));
    ...
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      v_6 <- eval (add (sext v_3 32) (sext v_5 32));
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_6 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_6 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_7)) (concat (mux (sgt v_10 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_10 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_11)) (concat (mux (sgt v_14 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_14 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_15)) (concat (mux (sgt v_18 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_18 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_19)) (concat (mux (sgt v_22 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_22 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_23)) (concat (mux (sgt v_26 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_26 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_27)) (concat (mux (sgt v_30 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_30 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_31)) (mux (sgt v_34 (expression.bv_nat 32 32767)) (expression.bv_nat 16 32767) (mux (slt v_34 (expression.bv_nat 32 4294934528)) (expression.bv_nat 16 32768) v_35)))))))));
      pure ()
    pat_end
