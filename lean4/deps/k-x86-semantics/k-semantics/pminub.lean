def pminub : instruction :=
  definst "pminub" $ do
    ...
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (ult v_3 v_5) v_3 v_5) (concat (mux (ult v_6 v_7) v_6 v_7) (concat (mux (ult v_8 v_9) v_8 v_9) (concat (mux (ult v_10 v_11) v_10 v_11) (concat (mux (ult v_12 v_13) v_12 v_13) (concat (mux (ult v_14 v_15) v_14 v_15) (concat (mux (ult v_16 v_17) v_16 v_17) (concat (mux (ult v_18 v_19) v_18 v_19) (concat (mux (ult v_20 v_21) v_20 v_21) (concat (mux (ult v_22 v_23) v_22 v_23) (concat (mux (ult v_24 v_25) v_24 v_25) (concat (mux (ult v_26 v_27) v_26 v_27) (concat (mux (ult v_28 v_29) v_28 v_29) (concat (mux (ult v_30 v_31) v_30 v_31) (concat (mux (ult v_32 v_33) v_32 v_33) (mux (ult v_34 v_35) v_34 v_35))))))))))))))));
      pure ()
    pat_end
