def rorl : instruction :=
  definst "rorl" $ do
    pattern fun (_ : clReg) (mem_0 : Mem) => do
      ...
      v_6 <- eval (ror v_2 (concat (expression.bv_nat 24 0) v_5));
      store v_1 v_6 4;
    ...
    pattern fun (_ : clReg) (r32_0 : reg (bv 32)) => do
      ...
      v_5 <- eval (ror v_4 (concat (expression.bv_nat 24 0) v_3));
    ...
    pattern fun (imm_0 : imm int) (mem_1 : Mem) => do
      ...
      v_5 <- eval (ror v_3 (concat (expression.bv_nat 24 0) v_4));
      store v_2 v_5 4;
    ...
    pattern fun (imm_0 : imm int) (r32_1 : reg (bv 32)) => do
      ...
      v_4 <- eval (ror v_3 (concat (expression.bv_nat 24 0) v_2));
