def divpd : instruction :=
  definst "divpd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_div v_3 v_6) 64) (fp_bitcast_to_bv (fp_div v_7 v_8) 64));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_div v_3 v_5) 64) (fp_bitcast_to_bv (fp_div v_6 v_7) 64));
      pure ()
    pat_end
