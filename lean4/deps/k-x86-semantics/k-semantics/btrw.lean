def btrw : instruction :=
  definst "btrw" $ do
    ...
    pattern fun (imm_0 : imm int) (r16_1 : reg (bv 16)) => do
      ...
      setRegister (lhs.of_reg r16_1) (bv_and v_2 (bv_xor v_4 (expression.bv_nat 16 65535)));
      setRegister af undef;
    ...
    pattern fun (r16_0 : reg (bv 16)) (r16_1 : reg (bv 16)) => do
      ...
      setRegister (lhs.of_reg r16_1) (bv_and v_2 (bv_xor v_5 (expression.bv_nat 16 65535)));
      setRegister af undef;
