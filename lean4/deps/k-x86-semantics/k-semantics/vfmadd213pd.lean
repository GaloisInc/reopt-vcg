def vfmadd213pd : instruction :=
  definst "vfmadd213pd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_4 v_6) v_10) 64) (fp_bitcast_to_bv (fp_sub (fp_mul v_11 v_12) v_14) 64));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (/- (_,_,_) -/ vfmadd132_double (extract v_3 0 64) (extract v_5 0 64) (extract v_6 0 64)) (concat (/- (_,_,_) -/ vfmadd132_double (extract v_3 64 128) (extract v_5 64 128) (extract v_6 64 128)) (concat (/- (_,_,_) -/ vfmadd132_double (extract v_3 128 192) (extract v_5 128 192) (extract v_6 128 192)) (/- (_,_,_) -/ vfmadd132_double (extract v_3 192 256) (extract v_5 192 256) (extract v_6 192 256)))));
      pure ()
    pat_end;
