def shrb : instruction :=
  definst "shrb" $ do
    pattern fun (_ : clReg) (mem_0 : Mem) => do
      ...
      v_6 <- eval (lshr (concat v_2 (expression.bv_nat 1 0)) (concat (expression.bv_nat 1 0) v_5));
      ...
      setRegister cf (mux (uge v_5 (expression.bv_nat 8 8)) undef (mux v_9 v_14 (isBitSet v_6 8)));
      setRegister of (mux (eq v_5 (expression.bv_nat 8 1)) (isBitSet v_2 0) (mux v_9 v_13 undef));
    ...
    pattern fun (_ : clReg) (rh_0 : reg (bv 8)) => do
      ...
      v_7 <- eval (lshr (concat v_6 (expression.bv_nat 1 0)) (concat (expression.bv_nat 1 0) v_3));
      ...
      setRegister cf (mux (uge v_3 (expression.bv_nat 8 8)) undef (mux v_4 v_12 (isBitSet v_7 8)));
      setRegister of (mux (eq v_3 (expression.bv_nat 8 1)) (isBitSet v_6 0) (mux v_4 v_11 undef));
