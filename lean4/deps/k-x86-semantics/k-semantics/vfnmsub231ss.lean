def vfnmsub231ss : instruction :=
  definst "vfnmsub231ss" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (extract v_3 0 96) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_8)) v_9) 32));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (extract v_3 0 96) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_5 v_7)) v_8) 32));
      pure ()
    pat_end
