def xaddw1 : instruction :=
  definst "xaddw" $ do
    pattern fun (v_2646 : reg (bv 16)) (v_2647 : reg (bv 16)) => do
      ...
      v_4204 <- eval (extract v_4198 12 13);
      v_4206 <- eval (extract v_4198 1 17);
      v_4241 <- eval (eq (extract v_4194 0 1) (expression.bv_nat 1 1));
      setRegister (lhs.of_reg v_2647) v_4206;
      ...
      setRegister pf (mux (notBool_ (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (eq (extract v_4198 16 17) (expression.bv_nat 1 1)) (eq (extract v_4198 15 16) (expression.bv_nat 1 1)))) (eq (extract v_4198 14 15) (expression.bv_nat 1 1)))) (eq (extract v_4198 13 14) (expression.bv_nat 1 1)))) (eq v_4204 (expression.bv_nat 1 1)))) (eq (extract v_4198 11 12) (expression.bv_nat 1 1)))) (eq (extract v_4198 10 11) (expression.bv_nat 1 1)))) (eq (extract v_4198 9 10) (expression.bv_nat 1 1))))) (expression.bv_nat 1 1) (expression.bv_nat 1 0));
      setRegister zf (mux (eq v_4206 (expression.bv_nat 16 0)) (expression.bv_nat 1 1) (expression.bv_nat 1 0));
      setRegister af (bv_xor (bv_xor (extract v_4194 11 12) (extract v_4196 11 12)) v_4204);
    ...
    pattern fun (v_2651 : reg (bv 16)) (v_2652 : reg (bv 16)) => do
      ...
      v_4268 <- eval (extract v_4265 12 13);
      v_4269 <- eval (extract v_4265 1 17);
      setRegister (lhs.of_reg v_2652) v_4269;
      ...
      setRegister pf (mux (notBool_ (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (eq (extract v_4265 16 17) (expression.bv_nat 1 1)) (eq (extract v_4265 15 16) (expression.bv_nat 1 1)))) (eq (extract v_4265 14 15) (expression.bv_nat 1 1)))) (eq (extract v_4265 13 14) (expression.bv_nat 1 1)))) (eq v_4268 (expression.bv_nat 1 1)))) (eq (extract v_4265 11 12) (expression.bv_nat 1 1)))) (eq (extract v_4265 10 11) (expression.bv_nat 1 1)))) (eq (extract v_4265 9 10) (expression.bv_nat 1 1))))) (expression.bv_nat 1 1) (expression.bv_nat 1 0));
      setRegister zf (mux (eq v_4269 (expression.bv_nat 16 0)) (expression.bv_nat 1 1) (expression.bv_nat 1 0));
      setRegister af v_4268;
    ...
    pattern fun (v_2643 : reg (bv 16)) (v_2642 : Mem) => do
      ...
      v_7533 <- eval (extract v_7523 12 13);
      ...
      setRegister pf (mux (notBool_ (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (eq (extract v_7523 16 17) (expression.bv_nat 1 1)) (eq (extract v_7523 15 16) (expression.bv_nat 1 1)))) (eq (extract v_7523 14 15) (expression.bv_nat 1 1)))) (eq (extract v_7523 13 14) (expression.bv_nat 1 1)))) (eq v_7533 (expression.bv_nat 1 1)))) (eq (extract v_7523 11 12) (expression.bv_nat 1 1)))) (eq (extract v_7523 10 11) (expression.bv_nat 1 1)))) (eq (extract v_7523 9 10) (expression.bv_nat 1 1))))) (expression.bv_nat 1 1) (expression.bv_nat 1 0));
      setRegister af (bv_xor (bv_xor (extract v_7519 11 12) (extract v_7521 11 12)) v_7533);
