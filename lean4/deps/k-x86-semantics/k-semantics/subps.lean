def subps : instruction :=
  definst "subps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_sub v_3 v_6) 32) (concat (fp_bitcast_to_bv (fp_sub v_7 v_8) 32) (concat (fp_bitcast_to_bv (fp_sub v_9 v_10) 32) (fp_bitcast_to_bv (fp_sub v_11 v_12) 32))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_sub v_3 v_5) 32) (concat (fp_bitcast_to_bv (fp_sub v_6 v_7) 32) (concat (fp_bitcast_to_bv (fp_sub v_8 v_9) 32) (fp_bitcast_to_bv (fp_sub v_10 v_11) 32))));
      pure ()
    pat_end
