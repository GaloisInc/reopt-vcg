def subss : instruction :=
  definst "subss" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (extract v_2 0 96) (fp_bitcast_to_bv (fp_sub v_3 v_6) 32));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (extract v_2 0 96) (fp_bitcast_to_bv (fp_sub v_3 v_5) 32));
      pure ()
    pat_end
