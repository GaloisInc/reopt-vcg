def vaddps : instruction :=
  definst "vaddps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_add v_4 v_7) 32) (concat (fp_bitcast_to_bv (fp_add v_8 v_9) 32) (concat (fp_bitcast_to_bv (fp_add v_10 v_11) 32) (fp_bitcast_to_bv (fp_add v_12 v_13) 32))));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_add v_4 v_7) 32) (concat (fp_bitcast_to_bv (fp_add v_8 v_9) 32) (concat (fp_bitcast_to_bv (fp_add v_10 v_11) 32) (concat (fp_bitcast_to_bv (fp_add v_12 v_13) 32) (concat (fp_bitcast_to_bv (fp_add v_14 v_15) 32) (concat (fp_bitcast_to_bv (fp_add v_16 v_17) 32) (concat (fp_bitcast_to_bv (fp_add v_18 v_19) 32) (fp_bitcast_to_bv (fp_add v_20 v_21) 32))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_add v_4 v_6) 32) (concat (fp_bitcast_to_bv (fp_add v_7 v_8) 32) (concat (fp_bitcast_to_bv (fp_add v_9 v_10) 32) (fp_bitcast_to_bv (fp_add v_11 v_12) 32))));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_add v_4 v_6) 32) (concat (fp_bitcast_to_bv (fp_add v_7 v_8) 32) (concat (fp_bitcast_to_bv (fp_add v_9 v_10) 32) (concat (fp_bitcast_to_bv (fp_add v_11 v_12) 32) (concat (fp_bitcast_to_bv (fp_add v_13 v_14) 32) (concat (fp_bitcast_to_bv (fp_add v_15 v_16) 32) (concat (fp_bitcast_to_bv (fp_add v_17 v_18) 32) (fp_bitcast_to_bv (fp_add v_19 v_20) 32))))))));
      pure ()
    pat_end
