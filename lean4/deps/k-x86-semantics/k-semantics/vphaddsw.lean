def vphaddsw : instruction :=
  definst "vphaddsw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      v_4 <- load v_3 16;
      v_5 <- eval (add (sext (extract v_4 0 16) 32) (sext (extract v_4 16 32) 32));
      v_6 <- eval (add (sext (extract v_4 32 48) 32) (sext (extract v_4 48 64) 32));
      v_7 <- eval (add (sext (extract v_4 64 80) 32) (sext (extract v_4 80 96) 32));
      v_8 <- eval (add (sext (extract v_4 96 112) 32) (sext (extract v_4 112 128) 32));
      v_9 <- getRegister (lhs.of_reg xmm_1);
      v_10 <- eval (add (sext (extract v_9 0 16) 32) (sext (extract v_9 16 32) 32));
      v_11 <- eval (add (sext (extract v_9 32 48) 32) (sext (extract v_9 48 64) 32));
      v_12 <- eval (add (sext (extract v_9 64 80) 32) (sext (extract v_9 80 96) 32));
      v_13 <- eval (add (sext (extract v_9 112 128) 32) (sext (extract v_9 96 112) 32));
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      v_11 <- eval (add (sext (extract v_9 32 48) 32) (sext (extract v_9 48 64) 32));
      v_12 <- eval (add (sext (extract v_9 64 80) 32) (sext (extract v_9 80 96) 32));
      v_13 <- eval (add (sext (extract v_9 96 112) 32) (sext (extract v_9 112 128) 32));
      v_14 <- eval (add (sext (extract v_4 128 144) 32) (sext (extract v_4 144 160) 32));
      v_15 <- eval (add (sext (extract v_4 160 176) 32) (sext (extract v_4 176 192) 32));
      v_16 <- eval (add (sext (extract v_4 192 208) 32) (sext (extract v_4 208 224) 32));
      v_17 <- eval (add (sext (extract v_4 224 240) 32) (sext (extract v_4 240 256) 32));
      v_18 <- eval (add (sext (extract v_9 128 144) 32) (sext (extract v_9 144 160) 32));
      v_19 <- eval (add (sext (extract v_9 160 176) 32) (sext (extract v_9 176 192) 32));
      v_20 <- eval (add (sext (extract v_9 192 208) 32) (sext (extract v_9 208 224) 32));
      v_21 <- eval (add (sext (extract v_9 240 256) 32) (sext (extract v_9 224 240) 32));
    ...
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      v_4 <- eval (add (sext (extract v_3 0 16) 32) (sext (extract v_3 16 32) 32));
      ...
      v_12 <- eval (add (sext (extract v_8 112 128) 32) (sext (extract v_8 96 112) 32));
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      v_10 <- eval (add (sext (extract v_8 32 48) 32) (sext (extract v_8 48 64) 32));
      v_11 <- eval (add (sext (extract v_8 64 80) 32) (sext (extract v_8 80 96) 32));
      v_12 <- eval (add (sext (extract v_8 96 112) 32) (sext (extract v_8 112 128) 32));
      v_13 <- eval (add (sext (extract v_3 128 144) 32) (sext (extract v_3 144 160) 32));
      v_14 <- eval (add (sext (extract v_3 160 176) 32) (sext (extract v_3 176 192) 32));
      v_15 <- eval (add (sext (extract v_3 192 208) 32) (sext (extract v_3 208 224) 32));
      v_16 <- eval (add (sext (extract v_3 224 240) 32) (sext (extract v_3 240 256) 32));
      v_17 <- eval (add (sext (extract v_8 128 144) 32) (sext (extract v_8 144 160) 32));
      v_18 <- eval (add (sext (extract v_8 160 176) 32) (sext (extract v_8 176 192) 32));
      v_19 <- eval (add (sext (extract v_8 192 208) 32) (sext (extract v_8 208 224) 32));
      v_20 <- eval (add (sext (extract v_8 240 256) 32) (sext (extract v_8 224 240) 32));
