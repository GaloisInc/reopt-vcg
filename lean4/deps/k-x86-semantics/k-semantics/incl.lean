def incl1 : instruction :=
  definst "incl" $ do
    pattern fun (mem_0 : Mem) => do
      ...
      store v_1 v_3 4;
      setRegister af (eq (extract v_2 28 32) (expression.bv_nat 4 15));
      setRegister of (bit_and (isBitClear v_2 0) (eq (extract v_2 1 32) (expression.bv_nat 31 2147483647)));
    ...
    pattern fun (r32_0 : reg (bv 32)) => do
      ...
      setRegister af (eq (extract v_1 28 32) (expression.bv_nat 4 15));
      setRegister of (bit_and (isBitClear v_1 0) (eq (extract v_1 1 32) (expression.bv_nat 31 2147483647)));
