def addsd : instruction :=
  definst "addsd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (extract v_2 0 64) (fp_bitcast_to_bv (fp_add v_3 v_6) 64));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (extract v_2 0 64) (fp_bitcast_to_bv (fp_add v_3 v_5) 64));
      pure ()
    pat_end
