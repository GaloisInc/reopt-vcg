def btsw : instruction :=
  definst "btsw" $ do
    pattern fun (imm_0 : imm int) (mem_1 : Mem) => do
      ...
      store v_4 (bv_or v_5 (extract (shl (expression.bv_nat 8 1) v_6) 0 8)) 1;
    ...
    pattern fun (imm_0 : imm int) (r16_1 : reg (bv 16)) => do
      ...
      setRegister (lhs.of_reg r16_1) (bv_or v_2 (extract (shl (expression.bv_nat 16 1) v_3) 0 16));
      setRegister af undef;
    ...
    pattern fun (r16_0 : reg (bv 16)) (r16_1 : reg (bv 16)) => do
      ...
      setRegister (lhs.of_reg r16_1) (bv_or v_2 (extract (shl (expression.bv_nat 16 1) v_4) 0 16));
      setRegister af undef;
