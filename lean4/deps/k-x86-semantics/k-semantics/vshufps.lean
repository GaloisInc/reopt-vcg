def vshufps : instruction :=
  definst "vshufps" $ do
    pattern fun (imm_0 : imm int) (mem_1 : Mem) (xmm_2 : reg (bv 128)) (xmm_3 : reg (bv 128)) => do
      ...
      v_9 <- eval (extract v_7 64 96);
      v_10 <- eval (extract v_7 32 64);
      v_11 <- eval (extract v_7 96 128);
      v_12 <- eval (isBitSet v_4 2);
      v_13 <- eval (isBitSet v_4 4);
      v_14 <- getRegister (lhs.of_reg xmm_2);
      v_15 <- eval (extract v_14 0 32);
      v_16 <- eval (extract v_14 64 96);
      v_17 <- eval (extract v_14 32 64);
      v_18 <- eval (extract v_14 96 128);
    ...
    pattern fun (imm_0 : imm int) (mem_1 : Mem) (ymm_2 : reg (bv 256)) (ymm_3 : reg (bv 256)) => do
      ...
      v_10 <- eval (extract v_8 64 96);
      v_11 <- eval (extract v_8 32 64);
      ...
      v_18 <- eval (extract v_17 0 32);
      v_19 <- eval (extract v_17 64 96);
      v_20 <- eval (extract v_17 32 64);
      v_21 <- eval (extract v_17 96 128);
      v_22 <- eval (isBitSet v_4 7);
      v_23 <- eval (isBitSet v_4 6);
      v_24 <- eval (extract v_8 128 160);
      v_25 <- eval (extract v_8 192 224);
      v_26 <- eval (extract v_8 160 192);
      v_27 <- eval (extract v_8 224 256);
      v_28 <- eval (extract v_17 128 160);
      v_29 <- eval (extract v_17 192 224);
      v_30 <- eval (extract v_17 160 192);
      v_31 <- eval (extract v_17 224 256);
    ...
    pattern fun (imm_0 : imm int) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) (ymm_3 : reg (bv 256)) => do
      ...
      v_17 <- eval (extract v_16 0 32);
      v_18 <- eval (extract v_16 64 96);
      v_19 <- eval (extract v_16 32 64);
      v_20 <- eval (extract v_16 96 128);
      v_21 <- eval (isBitSet v_4 7);
      v_22 <- eval (isBitSet v_4 6);
      v_23 <- eval (extract v_7 128 160);
      v_24 <- eval (extract v_7 192 224);
      v_25 <- eval (extract v_7 160 192);
      v_26 <- eval (extract v_7 224 256);
      v_27 <- eval (extract v_16 128 160);
      v_28 <- eval (extract v_16 192 224);
      v_29 <- eval (extract v_16 160 192);
      v_30 <- eval (extract v_16 224 256);
