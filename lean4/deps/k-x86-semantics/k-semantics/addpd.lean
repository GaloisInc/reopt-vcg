def addpd : instruction :=
  definst "addpd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_add v_4 v_8) 64) (fp_bitcast_to_bv (fp_add v_10 v_12) 64));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_add v_4 v_7) 64) (fp_bitcast_to_bv (fp_add v_9 v_11) 64));
      pure ()
    pat_end
