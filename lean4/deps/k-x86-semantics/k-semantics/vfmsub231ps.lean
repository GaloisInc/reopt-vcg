def vfmsub231ps : instruction :=
  definst "vfmsub231ps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_4 v_7) v_9) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_10 v_11) v_12) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_13 v_14) v_15) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_16 v_17) v_18) 32))));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_4 v_7) v_9) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_10 v_11) v_12) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_13 v_14) v_15) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_16 v_17) v_18) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_19 v_20) v_21) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_22 v_23) v_24) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_25 v_26) v_27) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_28 v_29) v_30) 32))))))));
      pure ()
    pat_end;
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_4 v_6) v_8) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_9 v_10) v_11) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_12 v_13) v_14) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_15 v_16) v_17) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_18 v_19) v_20) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_21 v_22) v_23) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_24 v_25) v_26) 32) (fp_bitcast_to_bv (fp_sub (fp_mul v_27 v_28) v_29) 32))))))));
      pure ()
    pat_end
