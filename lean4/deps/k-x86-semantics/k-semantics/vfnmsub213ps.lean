def vfnmsub213ps : instruction :=
  definst "vfnmsub213ps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_4 v_6)) v_9) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_10 v_11)) v_12) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_13 v_14)) v_15) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_16 v_17)) v_18) 32))));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_4 v_6)) v_9) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_10 v_11)) v_12) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_13 v_14)) v_15) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_16 v_17)) v_18) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_19 v_20)) v_21) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_22 v_23)) v_24) 32) (concat (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_25 v_26)) v_27) 32) (fp_bitcast_to_bv (fp_sub (fp_mul -1e+00 (fp_mul v_28 v_29)) v_30) 32))))))));
      pure ()
    pat_end;
