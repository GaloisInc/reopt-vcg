def xorq1 : instruction :=
  definst "xorq" $ do
    pattern fun (v_2818 : imm int) (v_2819 : reg (bv 64)) => do
      v_5058 <- getRegister v_2819;
      ...
      setRegister (lhs.of_reg v_2819) v_5065;
      ...
      pure ()
    pat_end;
    pattern fun (v_2827 : reg (bv 64)) (v_2828 : reg (bv 64)) => do
      v_5127 <- getRegister v_2828;
      v_5129 <- getRegister v_2827;
      v_5132 <- eval (bv_xor v_5127 v_5129);
      setRegister (lhs.of_reg v_2828) v_5132;
      setRegister of (expression.bv_nat 1 0);
      ...
      pure ()
    pat_end;
    pattern fun (v_2822 : Mem) (v_2823 : reg (bv 64)) => do
      v_7258 <- getRegister v_2823;
      v_7260 <- evaluateAddress v_2822;
      v_7261 <- load v_7260 8;
      v_7264 <- eval (bv_xor v_7258 v_7261);
      setRegister (lhs.of_reg v_2823) v_7264;
      setRegister of (expression.bv_nat 1 0);
    ...
    pattern fun (v_2810 : imm int) (v_2809 : Mem) => do
      ...
      pure ()
    pat_end;
    pattern fun (v_2814 : reg (bv 64)) (v_2813 : Mem) => do
      v_7980 <- evaluateAddress v_2813;
      v_7981 <- load v_7980 8;
      v_7982 <- getRegister v_2814;
