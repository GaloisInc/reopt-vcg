def sarl1 : instruction :=
  definst "sarl" $ do
    pattern fun (_ : clReg) (mem_0 : Mem) => do
      ...
      v_5 <- eval (ashr (concat v_2 (expression.bv_nat 1 0)) (concat (expression.bv_nat 25 0) v_4));
      ...
      setRegister cf (mux v_8 v_13 (isBitSet v_5 32));
    ...
    pattern fun (_ : clReg) (r32_0 : reg (bv 32)) => do
      ...
      setRegister cf (mux v_3 v_11 (isBitSet v_6 32));
