def vrcpps : instruction :=
  definst "vrcpps" $ do
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) => do
      ...
      v_6 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_3 64 96));
      v_7 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_3 96 128));
      v_8 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_3 128 160));
      v_9 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_3 160 192));
      v_10 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_3 192 224));
      v_11 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_3 224 256));
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) => do
      ...
      v_5 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_2 64 96));
      v_6 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_2 96 128));
      v_7 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_2 128 160));
      v_8 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_2 160 192));
      v_9 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_2 192 224));
      v_10 <- eval (bv_bitcast_to_fp float_class.fp32 (extract v_2 224 256));
