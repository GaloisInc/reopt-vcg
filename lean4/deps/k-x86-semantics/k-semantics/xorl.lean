def xorl1 : instruction :=
  definst "xorl" $ do
    pattern fun (v_2765 : imm int) eax => do
      v_4832 <- getRegister rax;
      v_4834 <- eval (handleImmediateWithSignExtend v_2765 32 32);
      ...
      pure ()
    pat_end;
    pattern fun (v_2777 : imm int) (v_2779 : reg (bv 32)) => do
      v_4904 <- getRegister v_2779;
      v_4906 <- eval (handleImmediateWithSignExtend v_2777 32 32);
      v_4909 <- eval (bv_xor v_4904 v_4906);
      setRegister (lhs.of_reg v_2779) v_4909;
      setRegister of (expression.bv_nat 1 0);
    ...
    pattern fun (v_2787 : reg (bv 32)) (v_2788 : reg (bv 32)) => do
      v_4971 <- getRegister v_2788;
      v_4973 <- getRegister v_2787;
      v_4976 <- eval (bv_xor v_4971 v_4973);
      setRegister (lhs.of_reg v_2788) v_4976;
      setRegister of (expression.bv_nat 1 0);
    ...
    pattern fun (v_2782 : Mem) (v_2783 : reg (bv 32)) => do
      v_7182 <- getRegister v_2783;
      v_7184 <- evaluateAddress v_2782;
      v_7185 <- load v_7184 4;
      v_7188 <- eval (bv_xor v_7182 v_7185);
      setRegister (lhs.of_reg v_2783) v_7188;
      setRegister of (expression.bv_nat 1 0);
    ...
    pattern fun (v_2774 : reg (bv 32)) (v_2773 : Mem) => do
      v_7850 <- evaluateAddress v_2773;
      v_7851 <- load v_7850 4;
      v_7852 <- getRegister v_2774;
