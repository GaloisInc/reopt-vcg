def vunpcklpd1 : instruction :=
  definst "vunpcklpd" $ do
    pattern fun (v_2525 : reg (bv 128)) (v_2526 : reg (bv 128)) (v_2527 : reg (bv 128)) => do
      v_3745 <- getRegister v_2525;
      v_3747 <- getRegister v_2526;
      setRegister (lhs.of_reg v_2527) (concat (extract v_3745 64 128) (extract v_3747 64 128));
      pure ()
    pat_end;
    pattern fun (v_2537 : reg (bv 256)) (v_2538 : reg (bv 256)) (v_2539 : reg (bv 256)) => do
      ...
      pure ()
    pat_end;
    pattern fun (v_2520 : Mem) (v_2521 : reg (bv 128)) (v_2522 : reg (bv 128)) => do
      v_6980 <- evaluateAddress v_2520;
      v_6981 <- load v_6980 16;
      v_6983 <- getRegister v_2521;
      setRegister (lhs.of_reg v_2522) (concat (extract v_6981 64 128) (extract v_6983 64 128));
      pure ()
    pat_end;
