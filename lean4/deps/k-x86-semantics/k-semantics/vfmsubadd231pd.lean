def vfmsubadd231pd : instruction :=
  definst "vfmsubadd231pd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_4 v_7) v_9) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_10 v_11) v_12) 64));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_4 v_7) v_9) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_10 v_11) v_12) 64)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_13 v_14) v_15) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_16 v_17) v_18) 64)));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_4 v_6) v_8) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_9 v_10) v_11) 64));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_4 v_6) v_8) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_9 v_10) v_11) 64)) (concat (fp_bitcast_to_bv (fp_sub (fp_mul v_12 v_13) v_14) 64) (fp_bitcast_to_bv (fp_add (fp_mul v_15 v_16) v_17) 64)));
      pure ()
    pat_end
