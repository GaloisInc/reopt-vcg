def vpaddd : instruction :=
  definst "vpaddd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (add v_4 v_7) (concat (add v_8 v_9) (concat (add v_10 v_11) (add v_12 v_13))));
      pure ()
    pat_end;
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (add v_4 v_7) (concat (add v_8 v_9) (concat (add v_10 v_11) (concat (add v_12 v_13) (concat (add v_14 v_15) (concat (add v_16 v_17) (concat (add v_18 v_19) (add v_20 v_21))))))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (add v_4 v_6) (concat (add v_7 v_8) (concat (add v_9 v_10) (add v_11 v_12))));
      pure ()
    pat_end;
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (add v_4 v_6) (concat (add v_7 v_8) (concat (add v_9 v_10) (concat (add v_11 v_12) (concat (add v_13 v_14) (concat (add v_15 v_16) (concat (add v_17 v_18) (add v_19 v_20))))))));
      pure ()
    pat_end
