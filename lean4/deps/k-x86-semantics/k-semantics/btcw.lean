def btcw1 : instruction :=
  definst "btcw" $ do
    ...
    pattern fun (imm_0 : imm int) (r16_1 : reg (bv 16)) => do
      ...
      setRegister (lhs.of_reg r16_1) (bv_xor v_2 (extract (shl (expression.bv_nat 16 1) v_3) 0 16));
      setRegister af undef;
    ...
    pattern fun (r16_0 : reg (bv 16)) (r16_1 : reg (bv 16)) => do
      ...
      setRegister (lhs.of_reg r16_1) (bv_xor v_2 (extract (shl (expression.bv_nat 16 1) v_4) 0 16));
      setRegister af undef;
