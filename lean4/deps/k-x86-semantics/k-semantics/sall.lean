def sall : instruction :=
  definst "sall" $ do
    pattern fun (_ : clReg) (mem_0 : Mem) => do
      ...
      v_5 <- eval (extract (shl (concat (expression.bv_nat 1 0) v_2) (concat (expression.bv_nat 25 0) v_4)) 0 33);
      ...
      v_12 <- getRegister pf;
      v_13 <- getRegister cf;
      v_14 <- eval (mux (uge v_4 (expression.bv_nat 8 32)) undef (mux v_8 v_13 (isBitSet v_5 0)));
      v_15 <- getRegister of;
      v_16 <- getRegister af;
      ...
      setRegister pf (mux v_8 v_12 (parityFlag (extract v_5 25 33)));
    ...
    pattern fun (_ : clReg) (r32_0 : reg (bv 32)) => do
      ...
      v_6 <- eval (extract (shl (concat (expression.bv_nat 1 0) v_5) (concat (expression.bv_nat 25 0) v_2)) 0 33);
      v_7 <- eval (extract v_6 1 33);
      v_8 <- getRegister sf;
      v_9 <- eval (isBitSet v_6 1);
      v_10 <- getRegister pf;
      v_11 <- getRegister cf;
      v_12 <- eval (mux (uge v_2 (expression.bv_nat 8 32)) undef (mux v_3 v_11 (isBitSet v_6 0)));
      v_13 <- getRegister of;
      v_14 <- getRegister af;
      setRegister (lhs.of_reg r32_0) v_7;
      setRegister af (mux v_3 v_14 undef);
      setRegister cf v_12;
      setRegister of (mux (eq v_2 (expression.bv_nat 8 1)) (notBool_ (eq v_12 v_9)) (mux v_3 v_13 undef));
      setRegister pf (mux v_3 v_10 (parityFlag (extract v_6 25 33)));
    ...
    pattern fun (imm_0 : imm int) (mem_1 : Mem) => do
      ...
      v_5 <- eval (extract (shl (concat (expression.bv_nat 1 0) v_3) (concat (expression.bv_nat 25 0) v_4)) 0 33);
      v_6 <- eval (extract v_5 1 33);
      store v_2 v_6 4;
      v_8 <- eval (eq v_4 (expression.bv_nat 8 0));
      v_9 <- getRegister zf;
    ...
    pattern fun (mem_0 : Mem) => do
      v_1 <- evaluateAddress mem_0;
      v_2 <- load v_1 4;
      v_3 <- eval (extract (shl (concat (expression.bv_nat 1 0) v_2) (expression.bv_nat 33 1)) 0 33);
      v_4 <- eval (extract v_3 1 33);
      store v_1 v_4 4;
      ...
      setRegister pf (parityFlag (extract v_3 25 33));
      setRegister sf v_6;
    ...
    pattern fun (r32_0 : reg (bv 32)) => do
      ...
      v_2 <- eval (extract (shl (concat (expression.bv_nat 1 0) v_1) (expression.bv_nat 33 1)) 0 33);
      v_3 <- eval (extract v_2 1 33);
      ...
      setRegister pf (parityFlag (extract v_2 25 33));
      setRegister sf v_4;
