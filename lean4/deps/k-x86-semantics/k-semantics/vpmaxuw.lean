def vpmaxuw : instruction :=
  definst "vpmaxuw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (mux (ugt v_4 v_7) v_4 v_7) (concat (mux (ugt v_8 v_9) v_8 v_9) (concat (mux (ugt v_10 v_11) v_10 v_11) (concat (mux (ugt v_12 v_13) v_12 v_13) (concat (mux (ugt v_14 v_15) v_14 v_15) (concat (mux (ugt v_16 v_17) v_16 v_17) (concat (mux (ugt v_18 v_19) v_18 v_19) (mux (ugt v_20 v_21) v_20 v_21))))))));
      pure ()
    pat_end;
    ...
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_2) (concat (mux (ugt v_4 v_6) v_4 v_6) (concat (mux (ugt v_7 v_8) v_7 v_8) (concat (mux (ugt v_9 v_10) v_9 v_10) (concat (mux (ugt v_11 v_12) v_11 v_12) (concat (mux (ugt v_13 v_14) v_13 v_14) (concat (mux (ugt v_15 v_16) v_15 v_16) (concat (mux (ugt v_17 v_18) v_17 v_18) (mux (ugt v_19 v_20) v_19 v_20))))))));
      pure ()
    pat_end;
