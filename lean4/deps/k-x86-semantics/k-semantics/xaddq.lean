def xaddq1 : instruction :=
  definst "xaddq" $ do
    pattern fun (v_2633 : reg (bv 64)) (v_2634 : reg (bv 64)) => do
      v_4061 <- eval (eq (eq (convToRegKeysHelper (convSubRegsToRegs v_2633)) (convToRegKeysHelper (convSubRegsToRegs v_2634))) bit_zero);
      v_4062 <- getRegister v_2633;
      v_4064 <- getRegister v_2634;
      ...
      v_4074 <- eval (extract v_4066 1 65);
      v_4109 <- eval (eq (extract v_4062 0 1) (expression.bv_nat 1 1));
      setRegister (lhs.of_reg v_2633) v_4064;
      setRegister (lhs.of_reg v_2634) v_4074;
      ...
      setRegister zf (mux (eq v_4074 (expression.bv_nat 64 0)) (expression.bv_nat 1 1) (expression.bv_nat 1 0));
      ...
      pure ()
    pat_end;
    pattern fun (v_2638 : reg (bv 64)) (v_2639 : reg (bv 64)) => do
      v_4130 <- eval (eq (convToRegKeysHelper (convSubRegsToRegs v_2638)) (convToRegKeysHelper (convSubRegsToRegs v_2639)));
      v_4131 <- getRegister v_2639;
      ...
      setRegister (lhs.of_reg v_2639) v_4137;
      ...
      pure ()
    pat_end;
    pattern fun (v_2629 : reg (bv 64)) (v_2628 : Mem) => do
      v_7453 <- evaluateAddress v_2628;
      v_7454 <- getRegister v_2629;
      ...
      v_7468 <- eval (extract v_7458 60 61);
      v_7502 <- eval (eq (extract v_7454 0 1) (expression.bv_nat 1 1));
      setRegister (lhs.of_reg v_2629) v_7456;
      ...
      setRegister pf (mux (notBool_ (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (notBool_ (eq (eq (extract v_7458 64 65) (expression.bv_nat 1 1)) (eq (extract v_7458 63 64) (expression.bv_nat 1 1)))) (eq (extract v_7458 62 63) (expression.bv_nat 1 1)))) (eq (extract v_7458 61 62) (expression.bv_nat 1 1)))) (eq v_7468 (expression.bv_nat 1 1)))) (eq (extract v_7458 59 60) (expression.bv_nat 1 1)))) (eq (extract v_7458 58 59) (expression.bv_nat 1 1)))) (eq (extract v_7458 57 58) (expression.bv_nat 1 1))))) (expression.bv_nat 1 1) (expression.bv_nat 1 0));
      setRegister af (bv_xor (bv_xor (extract v_7454 59 60) (extract v_7456 59 60)) v_7468);
