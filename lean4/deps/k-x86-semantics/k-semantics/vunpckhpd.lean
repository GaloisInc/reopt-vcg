def vunpckhpd1 : instruction :=
  definst "vunpckhpd" $ do
    pattern fun (v_2483 : reg (bv 128)) (v_2484 : reg (bv 128)) (v_2485 : reg (bv 128)) => do
      v_3681 <- getRegister v_2483;
      v_3683 <- getRegister v_2484;
      setRegister (lhs.of_reg v_2485) (concat (extract v_3681 0 64) (extract v_3683 0 64));
      pure ()
    pat_end;
    pattern fun (v_2493 : reg (bv 256)) (v_2494 : reg (bv 256)) (v_2495 : reg (bv 256)) => do
      ...
      pure ()
    pat_end;
    pattern fun (v_2476 : Mem) (v_2478 : reg (bv 128)) (v_2479 : reg (bv 128)) => do
      v_6932 <- evaluateAddress v_2476;
      v_6933 <- load v_6932 16;
      v_6935 <- getRegister v_2478;
      setRegister (lhs.of_reg v_2479) (concat (extract v_6933 0 64) (extract v_6935 0 64));
      pure ()
    pat_end;
