def pmaxsd : instruction :=
  definst "pmaxsd" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_3 v_6) v_3 v_6) (concat (mux (sgt v_7 v_8) v_7 v_8) (concat (mux (sgt v_9 v_10) v_9 v_10) (mux (sgt v_11 v_12) v_11 v_12))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (mux (sgt v_3 v_5) v_3 v_5) (concat (mux (sgt v_6 v_7) v_6 v_7) (concat (mux (sgt v_8 v_9) v_8 v_9) (mux (sgt v_10 v_11) v_10 v_11))));
      pure ()
    pat_end
