def vsubpd1 : instruction :=
  definst "vsubpd" $ do
    pattern fun (v_2361 : reg (bv 128)) (v_2362 : reg (bv 128)) (v_2363 : reg (bv 128)) => do
      v_3203 <- getRegister v_2362;
      v_3206 <- getRegister v_2361;
      setRegister (lhs.of_reg v_2363) (concat (Float2MInt (_-Float__FLOAT (MInt2Float (extract v_3203 0 64) 53 11) (MInt2Float (extract v_3206 0 64) 53 11)) 64) (Float2MInt (_-Float__FLOAT (MInt2Float (extract v_3203 64 128) 53 11) (MInt2Float (extract v_3206 64 128) 53 11)) 64));
      pure ()
    pat_end;
    pattern fun (v_2373 : reg (bv 256)) (v_2374 : reg (bv 256)) (v_2375 : reg (bv 256)) => do
      ...
      pure ()
    pat_end;
    pattern fun (v_2356 : Mem) (v_2357 : reg (bv 128)) (v_2358 : reg (bv 128)) => do
      v_6500 <- getRegister v_2357;
      v_6503 <- evaluateAddress v_2356;
      v_6504 <- load v_6503 16;
      setRegister (lhs.of_reg v_2358) (concat (Float2MInt (_-Float__FLOAT (MInt2Float (extract v_6500 0 64) 53 11) (MInt2Float (extract v_6504 0 64) 53 11)) 64) (Float2MInt (_-Float__FLOAT (MInt2Float (extract v_6500 64 128) 53 11) (MInt2Float (extract v_6504 64 128) 53 11)) 64));
      pure ()
    pat_end;
