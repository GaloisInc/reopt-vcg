def divps : instruction :=
  definst "divps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_div v_3 v_6) 32) (concat (fp_bitcast_to_bv (fp_div v_7 v_8) 32) (concat (fp_bitcast_to_bv (fp_div v_9 v_10) 32) (fp_bitcast_to_bv (fp_div v_11 v_12) 32))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_div v_3 v_5) 32) (concat (fp_bitcast_to_bv (fp_div v_6 v_7) 32) (concat (fp_bitcast_to_bv (fp_div v_8 v_9) 32) (fp_bitcast_to_bv (fp_div v_10 v_11) 32))));
      pure ()
    pat_end
