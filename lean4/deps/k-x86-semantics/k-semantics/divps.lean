def divps : instruction :=
  definst "divps" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_div v_4 v_8) 32) (concat (fp_bitcast_to_bv (fp_div v_10 v_12) 32) (concat (fp_bitcast_to_bv (fp_div v_14 v_16) 32) (fp_bitcast_to_bv (fp_div v_18 v_20) 32))));
      pure ()
    pat_end;
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (concat (fp_bitcast_to_bv (fp_div v_4 v_7) 32) (concat (fp_bitcast_to_bv (fp_div v_9 v_11) 32) (concat (fp_bitcast_to_bv (fp_div v_13 v_15) 32) (fp_bitcast_to_bv (fp_div v_17 v_19) 32))));
      pure ()
    pat_end
