def phsubsw : instruction :=
  definst "phsubsw" $ do
    pattern fun (mem_0 : Mem) (xmm_1 : reg (bv 128)) => do
      ...
      v_6 <- eval (sub (sext v_4 32) (sext v_5 32));
      ...
      v_10 <- eval (sub (sext v_8 32) (sext v_9 32));
      (v_11 : expression (bv 16)) <- eval (extract v_10 16 32);
      (v_12 : expression (bv 16)) <- eval (extract v_3 80 96);
      (v_13 : expression (bv 16)) <- eval (extract v_3 64 80);
      v_14 <- eval (sub (sext v_12 32) (sext v_13 32));
      ...
      v_18 <- eval (sub (sext v_16 32) (sext v_17 32));
      ...
      (v_22 : expression (bv 16)) <- eval (extract v_20 0 16);
      v_23 <- eval (sub (sext v_21 32) (sext v_22 32));
      (v_24 : expression (bv 16)) <- eval (extract v_23 16 32);
      (v_25 : expression (bv 16)) <- eval (extract v_20 48 64);
      (v_26 : expression (bv 16)) <- eval (extract v_20 32 48);
      v_27 <- eval (sub (sext v_25 32) (sext v_26 32));
      (v_28 : expression (bv 16)) <- eval (extract v_27 16 32);
      (v_29 : expression (bv 16)) <- eval (extract v_20 80 96);
      (v_30 : expression (bv 16)) <- eval (extract v_20 64 80);
      v_31 <- eval (sub (sext v_29 32) (sext v_30 32));
      ...
      v_35 <- eval (sub (sext v_33 32) (sext v_34 32));
    ...
    pattern fun (xmm_0 : reg (bv 128)) (xmm_1 : reg (bv 128)) => do
      ...
      v_5 <- eval (sub (sext v_3 32) (sext v_4 32));
      (v_6 : expression (bv 16)) <- eval (extract v_5 16 32);
      (v_7 : expression (bv 16)) <- eval (extract v_2 48 64);
      (v_8 : expression (bv 16)) <- eval (extract v_2 32 48);
      v_9 <- eval (sub (sext v_7 32) (sext v_8 32));
      (v_10 : expression (bv 16)) <- eval (extract v_9 16 32);
      (v_11 : expression (bv 16)) <- eval (extract v_2 80 96);
      (v_12 : expression (bv 16)) <- eval (extract v_2 64 80);
      v_13 <- eval (sub (sext v_11 32) (sext v_12 32));
      ...
      v_17 <- eval (sub (sext v_15 32) (sext v_16 32));
      ...
      (v_21 : expression (bv 16)) <- eval (extract v_19 0 16);
      v_22 <- eval (sub (sext v_20 32) (sext v_21 32));
      (v_23 : expression (bv 16)) <- eval (extract v_22 16 32);
      (v_24 : expression (bv 16)) <- eval (extract v_19 48 64);
      (v_25 : expression (bv 16)) <- eval (extract v_19 32 48);
      v_26 <- eval (sub (sext v_24 32) (sext v_25 32));
      (v_27 : expression (bv 16)) <- eval (extract v_26 16 32);
      (v_28 : expression (bv 16)) <- eval (extract v_19 80 96);
      (v_29 : expression (bv 16)) <- eval (extract v_19 64 80);
      v_30 <- eval (sub (sext v_28 32) (sext v_29 32));
      ...
      v_34 <- eval (sub (sext v_32 32) (sext v_33 32));
