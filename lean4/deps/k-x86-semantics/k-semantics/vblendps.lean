def vblendps : instruction :=
  definst "vblendps" $ do
    pattern fun (imm_0 : imm int) (mem_1 : Mem) (xmm_2 : reg (bv 128)) (xmm_3 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_3) (concat (mux (isBitClear v_4 4) v_6 v_9) (concat (mux (isBitClear v_4 5) v_10 v_11) (concat (mux (isBitClear v_4 6) v_12 v_13) (mux (isBitClear v_4 7) v_14 v_15))));
      pure ()
    pat_end;
    pattern fun (imm_0 : imm int) (mem_1 : Mem) (ymm_2 : reg (bv 256)) (ymm_3 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_3) (concat (mux (isBitClear v_4 0) v_6 v_9) (concat (mux (isBitClear v_4 1) v_10 v_11) (concat (mux (isBitClear v_4 2) v_12 v_13) (concat (mux (isBitClear v_4 3) v_14 v_15) (concat (mux (isBitClear v_4 4) v_16 v_17) (concat (mux (isBitClear v_4 5) v_18 v_19) (concat (mux (isBitClear v_4 6) v_20 v_21) (mux (isBitClear v_4 7) v_22 v_23))))))));
      pure ()
    pat_end;
    pattern fun (imm_0 : imm int) (xmm_1 : reg (bv 128)) (xmm_2 : reg (bv 128)) (xmm_3 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_3) (concat (mux (isBitClear v_4 4) v_6 v_8) (concat (mux (isBitClear v_4 5) v_9 v_10) (concat (mux (isBitClear v_4 6) v_11 v_12) (mux (isBitClear v_4 7) v_13 v_14))));
      pure ()
    pat_end;
