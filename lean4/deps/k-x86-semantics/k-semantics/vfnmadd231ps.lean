def vfnmadd231ps : instruction :=
  definst "vfnmadd231ps" $ do
    ...
    pattern fun (mem_0 : Mem) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (/- (_,_,_) -/ vfnmadd132_single v_4 v_6 v_9) (concat (/- (_,_,_) -/ vfnmadd132_single v_10 v_11 v_12) (concat (/- (_,_,_) -/ vfnmadd132_single v_13 v_14 v_15) (/- (_,_,_) -/ vfnmadd132_single v_16 v_17 v_18)))) (concat (/- (_,_,_) -/ vfnmadd132_single v_19 v_20 v_21) (concat (/- (_,_,_) -/ vfnmadd132_single v_22 v_23 v_24) (concat (/- (_,_,_) -/ vfnmadd132_single v_25 v_26 v_27) (/- (_,_,_) -/ vfnmadd132_single v_28 v_29 v_30)))));
      pure ()
    pat_end;
    ...
    pattern fun (ymm_0 : reg (bv 256)) (ymm_1 : reg (bv 256)) (ymm_2 : reg (bv 256)) => do
      ...
      setRegister (lhs.of_reg ymm_2) (concat (concat (/- (_,_,_) -/ vfnmadd132_single v_4 v_6 v_8) (concat (/- (_,_,_) -/ vfnmadd132_single v_9 v_10 v_11) (concat (/- (_,_,_) -/ vfnmadd132_single v_12 v_13 v_14) (/- (_,_,_) -/ vfnmadd132_single v_15 v_16 v_17)))) (concat (/- (_,_,_) -/ vfnmadd132_single v_18 v_19 v_20) (concat (/- (_,_,_) -/ vfnmadd132_single v_21 v_22 v_23) (concat (/- (_,_,_) -/ vfnmadd132_single v_24 v_25 v_26) (/- (_,_,_) -/ vfnmadd132_single v_27 v_28 v_29)))));
      pure ()
    pat_end
