def psrlw : instruction :=
  definst "psrlw" $ do
    pattern fun (imm_0 : imm int) (xmm_1 : reg (bv 128)) => do
      ...
      setRegister (lhs.of_reg xmm_1) (mux (ugt (concat (expression.bv_nat 56 0) v_2) (expression.bv_nat 64 15)) (expression.bv_nat 128 0) (concat (lshr (extract v_3 0 16) v_4) (concat (lshr (extract v_3 16 32) v_4) (concat (lshr (extract v_3 32 48) v_4) (concat (lshr (extract v_3 48 64) v_4) (concat (lshr (extract v_3 64 80) v_4) (concat (lshr (extract v_3 80 96) v_4) (concat (lshr (extract v_3 96 112) v_4) (lshr (extract v_3 112 128) v_4)))))))));
      pure ()
    pat_end;
