def btrl : instruction :=
  definst "btrl" $ do
    ...
    pattern fun (imm_0 : imm int) (r32_1 : reg (bv 32)) => do
      ...
      setRegister (lhs.of_reg r32_1) (bv_and v_2 (bv_xor (extract (shl (expression.bv_nat 32 1) v_3) 0 32) (expression.bv_nat 32 4294967295)));
      setRegister af undef;
    ...
    pattern fun (r32_0 : reg (bv 32)) (r32_1 : reg (bv 32)) => do
      ...
      setRegister (lhs.of_reg r32_1) (bv_and v_2 (bv_xor (extract (shl (expression.bv_nat 32 1) v_4) 0 32) (expression.bv_nat 32 4294967295)));
      setRegister af undef;
